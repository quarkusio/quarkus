...
This example, using xref:reactive-messaging-http.adoc[Reactive Messaging HTTP] shows how to stream
text data:
...
See xref:rest-client-reactive.adoc[REST Client Reactive Guide] for more information about the reactive client.
