...
public interface ReactiveDataQuery<Entity>
        extends
        DataQuery<ReactiveDataQuery<Entity>, Uni<Entity>, Entity, Uni<List<Entity>>, Uni<ReactiveDataQuery<Entity>>, Uni<Boolean>, Uni<Long>> {

    @Override
    ReactiveDataQuery<Entity> sort(Order<? super Entity> order);

    @Override
    default ReactiveDataQuery<Entity> sort(Sort<? super Entity> sort) {
     ...
     */
    public <T> ReactiveDataQuery<T> project(Class<T> type);
}
