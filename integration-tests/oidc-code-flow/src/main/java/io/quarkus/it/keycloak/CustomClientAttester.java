...
import io.quarkus.oidc.runtime.AttestationKeyRegistry.AttestationSigningKey;
...
public class CustomClientAttester implements ClientAttester {
    ...
    public Uni<String> attest(ClientAttestationContext context) {
        ...
        AttestationSigningKey signingKey = registry.getAttestationSigningKey(tenantId);
