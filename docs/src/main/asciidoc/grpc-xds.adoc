...
include::{generated-dir}/quarkus-grpc-config-group-config-xds.adoc[opts=optional, leveloffset=+1]
...
include::{generated-dir}/quarkus-grpc-config-group-config-client-xds.adoc[opts=optional, leveloffset=+1]
