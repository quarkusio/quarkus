...
public final class RepositorySupport {
    ...
    /**
     * Add call to the Panache method implementing the actual retrieving of a reference to an entity with the given
     * class and identifier.
     *
     * @param operations
     *        an instance of {@code AbstractJpaOperations} used to perform JPA operations
     * @param entityClass
     *        the {@code Class} object of the entity type to be retrieved
     * @param id
    ...
    public static Object getReferenceById(AbstractJpaOperations<PanacheQuery<?>> operations, Class<?> entityClass,
            Object id) {
