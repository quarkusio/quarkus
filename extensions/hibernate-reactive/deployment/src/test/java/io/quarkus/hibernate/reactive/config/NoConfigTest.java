...
public class NoConfigTest {
    ...
    public void testBootSucceedsButHibernateReactiveDeactivated() {
        // ... but any attempt to access Hibernate Reactive's beans should fail.
        assertThatThrownBy(() -> Arc.container().instance(Mutiny.SessionFactory.class).get().getCriteriaBuilder())
