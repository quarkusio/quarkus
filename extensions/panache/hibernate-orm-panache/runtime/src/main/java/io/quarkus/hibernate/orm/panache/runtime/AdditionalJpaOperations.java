...
public class AdditionalJpaOperations {
    ...
    public static PanacheQuery<?> find(AbstractJpaOperations<?, Session> jpaOperations, Class<?> entityClass, String query,
    ...
    public static long deleteAllWithCascade(AbstractJpaOperations<?, Session> jpaOperations, Class<?> entityClass) {
        Session session = jpaOperations.getSession(entityClass);
     ...
     */
    private static boolean deleteOnCascadeDetected(AbstractJpaOperations<?, Session> jpaOperations, Class<?> entityClass) {
        Session session = jpaOperations.getSession(entityClass);
    ...
    public static <PanacheQueryType> long deleteWithCascade(AbstractJpaOperations<PanacheQueryType, Session> jpaOperations,
    ...
    public static long deleteWithCascade(AbstractJpaOperations<?, Session> jpaOperations, Class<?> entityClass, String query,
            Parameters params) {
