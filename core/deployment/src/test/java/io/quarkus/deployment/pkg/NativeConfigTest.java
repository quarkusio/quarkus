...
class NativeConfigTest {
    ...
    public void testBuilderImageProperlyDetected() {
        assertThat(createConfig("graalvm").builderImage().getEffectiveImage())
                .contains("ubi9-quarkus-graalvmce-builder-image").contains("jdk-21");
        assertThat(createConfig("GraalVM").builderImage().getEffectiveImage())
                .contains("ubi9-quarkus-graalvmce-builder-image").contains("jdk-21");
        assertThat(createConfig("GraalVM").builderImage().getEffectiveImage())
                .contains("ubi9-quarkus-graalvmce-builder-image").contains("jdk-21");
        ...
        assertThat(createConfig("mandrel").builderImage().getEffectiveImage())
                .contains("ubi9-quarkus-mandrel-builder-image").contains("jdk-21");
        assertThat(createConfig("Mandrel").builderImage().getEffectiveImage())
                .contains("ubi9-quarkus-mandrel-builder-image").contains("jdk-21");
        assertThat(createConfig("MANDREL").builderImage().getEffectiveImage())
                .contains("ubi9-quarkus-mandrel-builder-image").contains("jdk-21");
