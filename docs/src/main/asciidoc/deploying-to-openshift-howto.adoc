...
As an application developer, you build and deploy your {project-name} applications to {openshift} in a single step, by running with one command:

:build-additional-parameters: quarkus deploy openshift
include::{includes}/devtools/build.adoc[]
:!build-additional-parameters:

By running this command, you build your application locally, trigger a container image build, and apply the generated {openshift} resources automatically.
