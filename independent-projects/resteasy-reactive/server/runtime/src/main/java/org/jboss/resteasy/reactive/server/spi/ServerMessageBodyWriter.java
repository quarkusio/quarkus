...
public interface ServerMessageBodyWriter<T> extends MessageBodyWriter<T> {
    ...
    /**
     * A special super-class of MessageBodyWriters that accepts all types of input. The main purpose of this class is to
     * allow runtime code to optimize for the case when there are multiple providers determined at build time but the
