...
public class HibernateSearchElasticsearchDevRecorder {
    ...
    public void initController(HibernateSearchElasticsearchRuntimeConfig runtimeConfig,
        ...
        Map<String, HibernateSearchElasticsearchRuntimeConfigPersistenceUnit> puConfigs = runtimeConfig
                .persistenceUnits();
        Set<String> activePersistenceUnitNames = persistenceUnitNames.stream().filter(name -> {
