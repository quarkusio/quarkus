...
/**
 * This item allows to enhance properties of security events produced by SecurityConstrainer. The SecurityConstrainer is
 * usually invoked when CDI request context is already fully setup, and the additional properties can be added based on
 * the active context.
 */
public final class AdditionalSecurityConstrainerEventPropsBuildItem extends SimpleBuildItem {
    ...
    public AdditionalSecurityConstrainerEventPropsBuildItem(
