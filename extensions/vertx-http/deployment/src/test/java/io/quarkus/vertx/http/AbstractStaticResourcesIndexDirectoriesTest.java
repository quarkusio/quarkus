...
/**
 * {@code quarkus.http.static-resources.index-directories} decides what a request for a directory with an
    ...
    static QuarkusExtensionTest test(String mode) {
        return new QuarkusExtensionTest()
                .withApplicationRoot((jar) -> jar
                        ...
                        .add(new StringAsset("quarkus.http.static-resources.index-directories=" + mode),
