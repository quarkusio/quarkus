...
/**
 * Instructs Panache to perform the work represented by the {@link io.smallrye.mutiny.Uni} returned from the intercepted
 * method within a scope of a reactive {@link org.hibernate.reactive.mutiny.Mutiny.Session}.
 * <p>
