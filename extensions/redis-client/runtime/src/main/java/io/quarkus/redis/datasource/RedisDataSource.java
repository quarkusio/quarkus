...
public interface RedisDataSource {
    ...
    /**
     * Retrieves a {@link RedisDataSource} using a single connection with the Redis server. The connection is acquired
     * from the pool, and released then the consumer completes.
     *
     * @param consumer
     ...
     * only executed when the passed block completes.
     * <p>
     ...
     * </pre>
     * <p>
     * The {@code preTxBlock} returns a {@link I}. The produced value is received by the {@code tx} block, which can use
     * that value to execute the appropriate operation in the transaction. The produced value can also be retrieved from
     * the produced {@link OptimisticLockingTransactionResult}. Commands issued in the {@code preTxBlock } must used the
     * passed (single-connection) {@link RedisDataSource} instance.
     * <p>
