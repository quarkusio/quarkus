...
The profile set with `quarkus.test.integration-test-profile` is passed to the local Azure Functions environment as the `QUARKUS_PROFILE` environment variable.
