...
public class OpenshiftWithRoutePathTest {

    private static final String APP_NAME = "openshift-with-route-path";
    ...
    public void assertGeneratedResources() throws IOException {
        ...
        assertThat(openshiftList).filteredOn(i -> "Route".equals(i.getKind())).singleElement().satisfies(i -> {
            assertThat(i).isInstanceOfSatisfying(Route.class, r -> {
                assertThat(r.getSpec().getHost()).isEqualTo("example.com");
                assertThat(r.getSpec().getPath()).isEqualTo("/api");
