...
final class MessageBodyWriterTransformerUtils {
        ...
        public MethodVisitor visitMethod(int access, String name, String descriptor, String signature, String[] exceptions) {
            ...
            if (name.equals("isWriteable")) {
                ...
                if ("(Ljava/lang/Class;Ljava/lang/reflect/Type;Lorg/jboss/resteasy/reactive/server/spi/ResteasyReactiveResourceInfo;Ljavax/ws/rs/core/MediaType;)Z"
                    ...
                    return new MessageBodyWriterIsWriteableMethodVisitor(superMethodVisitor, rrResult);
                }
                // JAX-RS isWriteable
                    ...
                    return new MessageBodyWriterIsWriteableMethodVisitor(superMethodVisitor, standardResult);
                }
            }
    ...
    private static class MessageBodyWriterIsWriteableMethodVisitor extends MethodVisitor {
        ...
        private MessageBodyWriterIsWriteableMethodVisitor(MethodVisitor superMethodVisitor, AtomicBoolean result) {
        ...
        @Override
        public void visitEnd() {
            result.set((insnCount == 2) && returnsTrue);
            super.visitEnd();
        }
    }
}
