...
[source,bash]
----
java -jar ./target/using-keycloak-1.0-SNAPSHOT-runner.jar
----
...
the produced binary, and ptimized to run with minimal resource overhead.
...
[source,bash]
----
./target/using-keycloak-1.0-SNAPSHOT-runner
----
