...
public class MultipartTest {
    ...
    private void testValid(String url) throws IOException {
        ...
        RestAssured.given()
                ...
                .multiPart(new MultiPartSpecBuilder(("{\n" + "  \"foo2\": \"bar\",\n" + "  \"sub2\": {\n"
                        + "    \"foo2\": \"bar2\"\n" + "  }\n" + "}").getBytes()).controlName("map2")
                        .fileName("something.js").build())
                ...
                .multiPart("htmlFile", HTML_FILE, "text/html").multiPart("names", "name1").multiPart("names", "name2")
                .multiPart("numbers", 1).multiPart("numbers", 2).multiPart("numbers2", 1).multiPart("numbers2", 2)
                ...
                .multiPart(new MultiPartSpecBuilder("{\"first\": \"First2\", \"last\": \"Last2\"}".getBytes())
                        .controlName("persons4").fileName("something.js").mimeType("application/json").build())
                .accept("application/json").when().post(url).then().statusCode(200).body("foo", equalTo("bar"))
                .body("sub.foo2", equalTo("bar2")).body("foo2", equalTo("bar")).body("sub2.foo2", equalTo("bar2"))
                .body("person.first", equalTo("Bob")).body("person.last", equalTo("Builder"))
                .body("person2.first", equalTo("Bob")).body("person2.last", equalTo("Builder"))
                ...
                .body("htmlFileContentType", equalTo("text/html")).body("names[0]", equalTo("name1"))
                .body("names[1]", equalTo("name2")).body("numbers[0]", equalTo(1)).body("numbers[1]", equalTo(2))
                .body("numbers2[0]", equalTo(1)).body("numbers2[1]", equalTo(2))
                .body("persons[0].first", equalTo("First1")).body("persons[0].last", equalTo("Last1"))
                .body("persons[1].first", equalTo("First2")).body("persons[1].last", equalTo("Last2"))
                .body("persons2[0].first", equalTo("First1")).body("persons2[0].last", equalTo("Last1"))
                .body("persons2[1].first", equalTo("First2")).body("persons2[1].last", equalTo("Last2"))
                .body("persons3[0].first", equalTo("First1")).body("persons3[0].last", equalTo("Last1"))
                .body("persons3[1].first", equalTo("First2")).body("persons3[1].last", equalTo("Last2"))
                .body("persons4[0].first", equalTo("First1")).body("persons4[0].last", equalTo("Last1"))
                .body("persons4[1].first", equalTo("First2")).body("persons4[1].last", equalTo("Last2"));
    }
    ...
    public void testInvalid() {
        RestAssured.given()
                ...
                .multiPart("htmlFile", HTML_FILE, "text/html").multiPart("names", "name1").multiPart("names", "name2")
                .multiPart("numbers", 1).multiPart("numbers", 2).accept("application/json").when()
                .post("/multipart/json").then().statusCode(400);
    }
    ...
    public void testInvalidParam() {
        RestAssured.given()
                ...
                .multiPart("htmlFile", HTML_FILE, "text/html").multiPart("names", "name1").multiPart("names", "name2")
                .multiPart("numbers", 1).multiPart("numbers", 2).accept("application/json").when()
                .post("/multipart/param/json").then().statusCode(400);
    }
}
