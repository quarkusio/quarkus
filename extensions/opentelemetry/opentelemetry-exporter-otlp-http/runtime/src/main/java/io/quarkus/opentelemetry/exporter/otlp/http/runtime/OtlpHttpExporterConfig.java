...
public class OtlpHttpExporterConfig {
    @ConfigRoot(name = "opentelemetry.tracer.exporter.otlp-http", phase = ConfigPhase.BUILD_AND_RUN_TIME_FIXED)
    public static class OtlpHttpExporterBuildConfig {
        /**
         * OTLP/HTTP SpanExporter support.
         * <p>
         * OTLP/HTTP SpanExporter support is enabled by default.
         */
        @ConfigItem(defaultValue = "true")
        public Boolean enabled;
    }

    @ConfigRoot(name = "opentelemetry.tracer.exporter.otlp-http", phase = ConfigPhase.RUN_TIME)
    public static class OtlpHttpExporterRuntimeConfig {
        /**
         * The OTLP/HTTP endpoint to connect to. The endpoint must start with either http:// or https://.
         */
        @ConfigItem()
