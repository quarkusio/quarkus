...
public interface MessageCodec<T, MESSAGE> {
    ...
    /**
     * @param type
     *        the type to handle, must not be {@code null}
     *
    ...
    /**
     * @param value
     *        the value to encode, must not be {@code null}
     *
    ...
    /**
     * @param type
     *        the type of the object to decode, must not be {@code null}
     * @param value
     *        the value to decode, must not be {@code null}
     *
