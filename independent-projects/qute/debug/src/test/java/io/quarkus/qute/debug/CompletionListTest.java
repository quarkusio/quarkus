...
public class CompletionListTest {
    ...
    public void debuggingTemplate() throws Exception {
        ...
        assertCompletion(new CompletionItem[] { //
                c("name", CompletionItemType.FIELD), //
                c("items", CompletionItemType.FIELD), //
                c("item", CompletionItemType.FIELD), //
                c("item_count", CompletionItemType.FIELD), //
                c("item_index", CompletionItemType.FIELD) }, items);
