...
/**
 * Result of the "is active?" question asked against synthetic beans.
 * Can say whether the bean {@linkplain #result() is active} and if it is not,
 * what is the {@linkplain #inactiveReason() reason}.
 */
public final class ActiveResult {
    ...
    private ActiveResult(boolean result, String inactiveReason, ActiveResult inactiveCause) {
        this.result = result;
