...
The support for Apache Camel on top of {product-name-first} is provided by the
https://github.com/apache/camel-quarkus[Apache Camel {product-name} project]. Please refer to
