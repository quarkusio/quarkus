...
[NOTE]
====
The fields of `Extension` were made `public` in order to make Jackson able to serialize them using its default settings. For more information about configuring Jackson, see xref:rest-json.adoc#jackson[this guide].
====
