...
/**
 * If placed on a method, then all {@link SecureField} annotations of the response type will be taken into account, even
 * if the class is annotated with {@link DisableSecureSerialization}.
 */
