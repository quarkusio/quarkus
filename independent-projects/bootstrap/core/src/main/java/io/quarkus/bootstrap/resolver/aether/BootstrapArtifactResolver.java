...
import io.quarkus.bootstrap.resolver.AppArtifactKey;
 ...
 */
public class BootstrapArtifactResolver extends AppArtifactResolverBase {
    ...
    public static class Builder {
        ...
        public BootstrapArtifactResolver build() throws AppArtifactResolverException {
            return new BootstrapArtifactResolver(this);
        }
    }
    ...
    private BootstrapArtifactResolver(Builder builder) throws AppArtifactResolverException {
    ...
    private AppDependencies injectDeploymentDependencies(DependencyNode root) throws AppArtifactResolverException {
        ...
        final Map<AppArtifactKey, AppDependency> appDeps = new LinkedHashMap<>();
        TreeDependencyVisitor visitor = new TreeDependencyVisitor(new DependencyVisitor() {
            ...
            public boolean visitLeave(DependencyNode node) {
                ...
                if(dep != null) {
                    final AppArtifact appArtifact = BootstrapArtifactResolver.toAppArtifact(dep.getArtifact());
                    appDeps.put(appArtifact.getKey(), new AppDependency(appArtifact, dep.getScope(), dep.isOptional()));
                }
                return true;
            }});
            ...
            visitor = new TreeDependencyVisitor(new DependencyVisitor() {
                ...
                public boolean visitEnter(DependencyNode node) {
                    ...
                    if(dep != null) {
                        if(deploymentNode == null) {
                            runtimeArtifact = (Artifact) node.getData().get(DeploymentInjectingDependencyVisitor.INJECTED_DEPENDENCY);
                ...
                public boolean visitLeave(DependencyNode node) {
                    ...
                    if (dep != null) {
                        ...
                        if (deploymentNode != null) {
                            if (runtimeNode == null && !appDeps.containsKey(new AppArtifactKey(artifact.getGroupId(),
                                    artifact.getArtifactId(), artifact.getClassifier(), artifact.getExtension()))) {
                                deploymentDeps.add(new AppDependency(BootstrapArtifactResolver.toAppArtifact(artifact),
        ...
        return new BootstrapAppDependencies(new ArrayList<>(appDeps.values()), deploymentDeps);
    }
