 ...
 */
@Deprecated
public class JsonRegistriesConfigLocator {
    ...
    public static RegistriesConfig resolveConfig() {
        ...
        if (configYaml == null) {
            return completeRequiredConfig(new JsonRegistriesConfig().setSource(ConfigSource.DEFAULT));
        }
    ...
    public static RegistriesConfig load(Path configYaml) {
        try {
            return completeRequiredConfig(RegistriesConfigMapperHelper.deserialize(configYaml, JsonRegistriesConfig.class)
                    .setSource(new ConfigSource.FileConfigSource(configYaml)));
        } catch (IOException e) {
