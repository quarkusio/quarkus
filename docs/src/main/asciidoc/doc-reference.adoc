...
Guide categories are defined in `docs/src/main/resources/categories.yaml`.
Add your guide to the appropriate category in that file.
The build will check that all guides are categorized and inject the category metadata into the generated sources.
