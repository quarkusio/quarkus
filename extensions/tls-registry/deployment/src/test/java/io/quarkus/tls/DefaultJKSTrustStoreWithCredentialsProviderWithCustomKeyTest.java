...
public class DefaultJKSTrustStoreWithCredentialsProviderWithCustomKeyTest {
    ...
    private static final String configuration = """
            ...
            quarkus.tls.trust-store.credentials-provider.password-key=secret
            """;
    ...
    public static class MyCredentialProvider implements CredentialsProvider {
        ...
        private final Map<String, Map<String, String>> credentials = Map.of("tls", Map.of("secret", "secret123!"));
