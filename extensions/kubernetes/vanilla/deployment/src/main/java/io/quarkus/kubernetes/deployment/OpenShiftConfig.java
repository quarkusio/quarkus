...
public interface OpenShiftConfig extends PlatformConfiguration {
    ...
    /**
     * The OpenShift flavor / version to use. Older versions of OpenShift have minor differences in the labels and
     * fields they support. This option allows users to have their manifests automatically aligned to the OpenShift
     * 'flavor' they use.
     */
    @WithDefault("v4")
    ...
    /**
     * The kind of the deployment resource to use. Supported values are 'Deployment', 'StatefulSet', 'Job', 'CronJob'
     * and 'DeploymentConfig'. Defaults to 'DeploymentConfig' if {@code flavor == v3}, or 'Deployment' otherwise.
    ...
    /**
     * Flag to enable init task externalization. When enabled (default), all initialization tasks created by extensions,
     * will be externalized as Jobs. In addition, the deployment will wait for these jobs.
     *
     ...
     * <p>
     * The init tasks are automatically generated by extensions like Flyway to perform the database migration before
    ...
    default DeploymentResourceKind getDeploymentResourceKind(Capabilities capabilities) {
        ...
        return (flavor() == OpenshiftFlavor.v3) ? DeploymentResourceKind.DeploymentConfig
