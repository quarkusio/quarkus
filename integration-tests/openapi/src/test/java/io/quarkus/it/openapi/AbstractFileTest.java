...
public abstract class AbstractFileTest extends AbstractTest {
    ...
    protected void testServiceFileRequest(String path, String expectedContentType) throws IOException {
    ...
    protected void testServiceFileResponse(String path, String expectedResponseType)
