...
. To use the {product-name-first} CLI in the next step, xref:cli-tooling.adoc#installing-the-cli[install the latest ve{product-name}f the Quarkus CLI].
