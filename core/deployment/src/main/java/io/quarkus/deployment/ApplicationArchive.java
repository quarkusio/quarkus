 ...
 * <p>
 * An application archive is an archive that provides components to the application. As a result it will be indexed via
 * jandex, and any deployment descriptors will be made available to the application.
 */
public interface ApplicationArchive {
    ...
    /**
     * @deprecated in favor of {@link #getRootDirectories()} Returns paths representing the archive root directories.
     *             Note that every path in this collection is guaranteed to be a directory. If the actual application
     *             archive appears to be a JAR, this collection will include a path to the root of the mounted
     *             {@link java.nio.file.FileSystem} created from the JAR.
     *
    ...
    /**
     * Returns paths representing the archive root directories. Note that every path in this collection is guaranteed to
     * be a directory. If the actual application archive appears to be a JAR, this collection will include a path to the
     * root of the mounted {@link java.nio.file.FileSystem} created from the JAR.
     *
     * @return The archive root directories.
     */
