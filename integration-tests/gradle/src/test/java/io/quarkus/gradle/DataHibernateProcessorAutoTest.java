...
public class DataHibernateProcessorAutoTest extends QuarkusGradleWrapperTestBase {

    @Test
    public void shouldAutoConfigureDataProcessor() throws Exception {
        final File projectDir = getProjectDir("data-hibernate-processor-auto");
        ...
        // Verify that the quarkus-data-processor was auto-configured and ran
