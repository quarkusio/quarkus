...
public class WebAuthnAutomaticNonBlockingTest extends WebAuthnAutomaticTest {
    ...
    static final QuarkusUnitTest config = new QuarkusUnitTest()
            .withApplicationRoot((jar) -> jar.addAsResource(new StringAsset("""
                    ...
                    """), "application.properties").addClasses(WebAuthnNonBlockingTestUserProvider.class,
                    WebAuthnTestUserProvider.class, WebAuthnHardware.class, TestResource.class, TestUtil.class));
}
