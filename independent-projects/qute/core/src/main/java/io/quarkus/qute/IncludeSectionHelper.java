...
public class IncludeSectionHelper implements SectionHelper {
    ...
    public static class Factory extends AbstractIncludeFactory<IncludeSectionHelper> {
        ...
        static final String DYNAMIC = "_dynamic";
        ...
        public ParametersInfo getParameters() {
            ParametersInfo.Builder builder = ParametersInfo.builder()
                    ...
                    .addParameter(Parameter.builder(DYNAMIC)
                            .defaultValue(Boolean.FALSE.toString())
                            .optional()
                            .valuePredicate(DYNAMIC::equals)
                            .build());
        ...
        protected boolean ignoreParameterInit(Map<String, String> params, Supplier<String> firstParamValue, String key,
                String value) {
            // We want to ignore the "template" param unless _dynamic=true
            return (key.equals(TEMPLATE) && !isDynamicTemplate(params))
                    || key.equals(DYNAMIC)
        ...
        protected String getTemplateId(SectionInitContext context) {
            if (isDynamicTemplate(context.getParameters())) {
                return null;
            }
        ...
        private boolean isDynamicTemplate(Map<String, String> params) {
            Object val = params.get(DYNAMIC);
            if (val != null) {
                return val.toString().equals("true")
                        || val.toString().equals(DYNAMIC);
            }
            return params.containsValue(DYNAMIC);
        }
    ...
    static class DynamicTemplateSupplier extends TemplateSupplier {
        ...
        @Override
        Template get(Map<String, Object> params) {
            Object templateIdVal = params.get(TEMPLATE);
