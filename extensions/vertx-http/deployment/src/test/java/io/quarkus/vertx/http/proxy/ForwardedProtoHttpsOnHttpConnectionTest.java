 ...
 */
@Certificates(baseDir = "target/certs", replaceIfExists = true, certificates = @Certificate(name = ForwardedProtoHttpsOnHttpConnectionTest.CERT_NAME, password = "secret", formats = {
...
class ForwardedProtoHttpsOnHttpConnectionTest {
    ...
    private static final String configuration = """
            ...
            """.formatted(CERTS_DIR + CERT_NAME, "secret");
