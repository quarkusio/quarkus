...
public class ResolverSetupCleanup {
    ...
    protected BootstrapArtifactResolver resolver;
    ...
    protected BootstrapArtifactResolver initResolver() throws AppArtifactResolverException {
        return BootstrapArtifactResolver.builder().setRepoHome(repoHome).setOffline(true).build();
    }
