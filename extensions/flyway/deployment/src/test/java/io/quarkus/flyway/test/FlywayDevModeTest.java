...
/**
 * Flyway needs a datasource to work. This tests assures, that an error occurs, as soon as the default flyway
 * configuration points to a missing default datasource.
 */
public class FlywayDevModeTest {

    @RegisterExtension
    static final QuarkusDevModeTest config = new QuarkusDevModeTest().withApplicationRoot(
            (jar) -> jar.addClasses(DevModeTestEndpoint.class).addAsResource("db/migration/V1.0.0__Quarkus.sql")
