...
public class KotlinJacocoTest extends QuarkusGradleWrapperTestBase {
    ...
    /**
     * This test should probably do more than simply verify a successful command execution. It was originally added to
     * make sure the process doesn't fail (which it used to).
     */
    @Test
