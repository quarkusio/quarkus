...
public interface ReactiveMongoCollection<T> {
     ...
     * @return a publisher emitting the sequence of distinct values
     */
    <D> DistinctPublisher<D> distinctAsPublisher(ClientSession clientSession, String fieldName, Bson filter,
            Class<D> clazz);
     ...
     * @return a stream containing the result of the aggregation operation
     */
    <D> AggregatePublisher<D> aggregateAsPublisher(ClientSession clientSession, List<? extends Bson> pipeline,
            Class<D> clazz);
     ...
     * @return the stream of changes
     */
    <D> ChangeStreamPublisher<D> watchAsPublisher(ClientSession clientSession, List<? extends Bson> pipeline,
            Class<D> clazz);
    ...
    MapReducePublisher<Document> mapReduceAsPublisher(ClientSession clientSession, String mapFunction,
            String reduceFunction);

    <D> MapReducePublisher<D> mapReduceAsPublisher(ClientSession clientSession, String mapFunction,
            String reduceFunction,
            Class<D> clazz);
    ...
    <D> PublisherBuilder<D> mapReduce(ClientSession clientSession, String mapFunction, String reduceFunction,
            Class<D> clazz);
     ...
     * @return a completion stage receiving the {@link BulkWriteResult}
     */
    CompletionStage<BulkWriteResult> bulkWrite(ClientSession clientSession,
