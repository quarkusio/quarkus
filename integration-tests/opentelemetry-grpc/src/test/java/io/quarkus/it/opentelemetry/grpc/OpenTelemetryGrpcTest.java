...
public class OpenTelemetryGrpcTest {
    ...
    void grpc() {
        ...
        assertEquals("grpc", getAttributes(client).get(RPC_SYSTEM_NAME.getKey()));
        assertEquals("helloworld.Greeter/SayHello", getAttributes(client).get(RPC_METHOD.getKey()));
        assertEquals(String.valueOf(Status.Code.OK.value()), getAttributes(client).get(RPC_RESPONSE_STATUS_CODE.getKey()));
        ...
        assertEquals("grpc", getAttributes(server).get(RPC_SYSTEM_NAME.getKey()));
        assertEquals("helloworld.Greeter/SayHello", getAttributes(server).get(RPC_METHOD.getKey()));
        assertEquals(String.valueOf(Status.Code.OK.value()), getAttributes(server).get(RPC_RESPONSE_STATUS_CODE.getKey()));
