 ...
 * package `one`. To address this failure, we are excluding the model classes using the property
 * `quarkus.jaxb.exclude-classes` in the `application.properties` file.
 */
@XmlRootElement
public class Model {
