...
package io.quarkus.keycloak.admin.client.reactive.token;
...
import io.quarkus.keycloak.admin.client.reactive.Config;
import io.quarkus.keycloak.admin.client.reactive.resource.BasicAuthFilter;
...
public class TokenManager {
    ...
    public TokenManager(Config config, Client client) {
        this.config = config;
        WebTargetImpl target = (WebTargetImpl) client.target(config.getServerUrl());
