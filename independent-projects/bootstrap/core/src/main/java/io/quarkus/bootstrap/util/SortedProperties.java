...
/*
 * Please keep in sync with io.quarkus.annotation.processor.SortedProperties
 */
 ...
 * <li>Always using {@code \n} as a line delimiter instead of {@code System.getProperty("line.separator")} used by {@code java.util.Properties}</li>
