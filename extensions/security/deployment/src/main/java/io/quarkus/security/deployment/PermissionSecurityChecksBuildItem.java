...
/**
 * Carries instance of the {@link PermissionSecurityChecksBuilder} that needs to be used by different build steps inside
 * Quarkus Security deployment module. This is internal build item only required within the security module.
 */
