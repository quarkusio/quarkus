...
This document describes how to test {product-name-first} Security.
...
{product-name} provides explicit support for testing with different users, and with the security subsystem disabled. To use
