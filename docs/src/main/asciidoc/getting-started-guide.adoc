...
You will find the import of the Shamrock BOM, allowing to omit the version on the different {project-name} dependencies.
...
`shamrock:dev` runs Shamrock in development mode. This enables hot deployment with background compilation, which means
...
Shamrock supports https://junit.org/junit4/[Junit 4] and https://junit.org/junit5/[Junit 5] tests.
