...
{product-name-first} already knows how to create a native executable using GraalVM Native Image. The default setup will create a
...
----
            <configuration>
              <jreleaser>
                <project>
                 <description>app - Sample {product-name} CLI application</description>
                 <links>
...
class App < Formula
  desc "app -- Sample {product-name} CLI application"
