package io.quarkus.vertx.web.common.deployment.devmode;
...
public class VertxHotReplacementSetup implements HotReplacementSetup {
    ...
    public void setupHotDeployment(HotReplacementContext context) {
        ...
        VertxWebCommonRecorder.setHotReplacement(this::handleHotReplacementRequest);
    }

    @Override
    public void handleFailedInitialStart() {
        VertxWebCommonRecorder.startServerAfterFailedStart();
    }
            ...
            public void handle(AsyncResult<Boolean> event) {
                ...
                if (event.failed()) {
                    ...
                    if (restart) {
                        ...
                        VertxWebCommonRecorder.getRouter().handle(routingContext.request());
                    } else {
                        routingContext.next();
                    }
                }
    ...
    @Override
    public void close() {
        VertxWebCommonRecorder.shutDownDevMode();
    }
}
