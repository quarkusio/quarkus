...
@Entity
public class HibernateAnnotationFindEntity extends ManagedEntity.AutoLong {
    ...
    public interface InnerPanacheRepository extends ManagedRepository.AutoLong<HibernateAnnotationFindEntity> {
    }
}
