...
public final class KotlinPanacheHibernateResourceProcessor {
    ...
    @BuildStep
    void collectEntityClasses(CombinedIndexBuildItem index, BuildProducer<KotlinPanacheEntityClassBuildItem> entityClasses) {
        ...
        for (ClassInfo panacheEntityBaseSubclass : index.getIndex().getAllKnownSubclasses(DOTNAME_PANACHE_ENTITY_BASE)) {
            ...
            if (!panacheEntityBaseSubclass.name().equals(DOTNAME_PANACHE_ENTITY)) {
                entityClasses.produce(new KotlinPanacheEntityClassBuildItem(panacheEntityBaseSubclass));
            }
        }
    }
    ...
    void build(CombinedIndexBuildItem index,
            ...
            List<KotlinPanacheEntityClassBuildItem> entityClasses,
        ...
        KotlinPanacheJpaRepositoryEnhancer daoEnhancer = new KotlinPanacheJpaRepositoryEnhancer(index.getIndex());
        ...
        for (KotlinPanacheEntityClassBuildItem entityClass : entityClasses) {
