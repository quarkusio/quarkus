...
:categories: security
:summary: This guide demonstrates how your {product-name-first} application can use a .properties file to store your user identities.

{product-name} provides support for properties file-based authentication intended for development and testing purposes.
...
The embedded realm also supports the mapping of users to passwords and users to roles. It uses the main `application.properties` {product-name} configuration file to embed this information.
