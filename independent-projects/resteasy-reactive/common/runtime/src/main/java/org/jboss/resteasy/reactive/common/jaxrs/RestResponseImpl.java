...
/**
 * This is the Response class for user-created responses. The client response object has more deserialising powers
 * in @{link {@link io.quarkus.rest.server.runtime.client.QuarkusRestClientResponse}.
 */
