...
link:https://www.graalvm.org/22.2/reference-manual/native-image/optimizations-and-performance/MemoryManagement[here].
...
https://www.graalvm.org/22.2/reference-manual/native-image/optimizations-and-performance/MemoryManagement[the GraalVM memory management guide].
...
For more details on using JFR, see https://www.graalvm.org/{graalvm-major-minor-version}/reference-manual/native-image/debugging-and-diagnostics/JFR/[here].
