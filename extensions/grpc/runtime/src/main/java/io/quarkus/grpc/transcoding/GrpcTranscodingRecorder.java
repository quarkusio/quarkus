...
public class GrpcTranscodingRecorder {
    ...
    private List<GrpcServerRecorder.GrpcServiceDefinition> collectServiceDefinitions(
    ...
    private List<GrpcTranscoding> collectTranscodingServices(Instance<GrpcTranscoding> services) {
