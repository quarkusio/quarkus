...
public interface RestClientsBuildTimeConfig {
     ...
     * If an interface is not annotated with {@link RegisterRestClient} and this property is set, then Quarkus will
     * make the interface a bean of the configured scope.
     */
