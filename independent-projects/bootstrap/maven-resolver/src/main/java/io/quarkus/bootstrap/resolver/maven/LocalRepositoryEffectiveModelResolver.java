...
public class LocalRepositoryEffectiveModelResolver implements EffectiveModelResolver {

    private final LocalRepoModelResolver modelResolver;

    LocalRepositoryEffectiveModelResolver(File localRepoDir) {
        this(new MavenLocalPomResolver(localRepoDir));
    }

    LocalRepositoryEffectiveModelResolver(LocalPomResolver... pomResolvers) {
        modelResolver = LocalRepoModelResolver.of(pomResolvers);
    }
