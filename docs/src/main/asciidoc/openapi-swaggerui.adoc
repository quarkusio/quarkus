...
(feel free to take a look to the link:rest-json.html[Writing JSON REST services guide] if your want more details on how to build a REST API with Quarkus).
