...
String baseImage = "${System.getProperty("user.name")}/container-build-jib-aot:0.1-SNAPSHOT"
String image = "$baseImage-aot"
assert ExecUtil.execWithSystemLogging("docker", "images", image)

String containerName = "container-build-jib-aot-" + ThreadLocalRandom.current().nextInt(10000)
