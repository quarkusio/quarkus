...
Aiming to guarantee concurrency control, panache now supports Optimistic lock control, for this you just need to use the `@Version`, and panache does the rest.
