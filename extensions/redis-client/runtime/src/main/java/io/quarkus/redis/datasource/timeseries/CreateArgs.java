...
public class CreateArgs implements RedisCommandExtraArguments {
     ...
     * performance due to a lower number of memory accesses. It can result in about 90% memory reduction. The exception
     * are highly irregular timestamps or values, which occur rarely.
     * <p>
