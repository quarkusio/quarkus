...
include::{generated-config-doc-dir}/quarkus-core_quarkus.live-reload.adoc[opts=optional, leveloffset=+1]
...
include::{generated-config-doc-dir}/quarkus-core_quarkus.package.adoc[opts=optional]
