...
public class PemKeyStoreNaturalOrderTest {
    ...
    void test() throws KeyStoreException, CertificateParsingException {
        ...
        assertThat(new ArrayList<>(list.get(0).getSubjectAlternativeNames()).get(0).toString()).contains("acme.org");
        assertThat(new ArrayList<>(list.get(1).getSubjectAlternativeNames()).get(0).toString()).contains("example.com");
        assertThat(new ArrayList<>(list.get(2).getSubjectAlternativeNames()).get(0).toString()).contains("quarkus.io");
    }
}
