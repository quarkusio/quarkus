 ...
 */
public class QuarkusRestLink extends Link {
    ...
    QuarkusRestLink(final URI uri, final Map<String, String> map) {
        this.uri = uri;
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof QuarkusRestLink) {
            final QuarkusRestLink otherLink = (QuarkusRestLink) other;
