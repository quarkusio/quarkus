 ...
 * PanacheMongoRepositoryBase is manually implemented to give us a compiler generated metric against
...
class StudentRepository : PanacheMongoRepositoryBase<Student, Long> {
    ...
    fun target_findById(id: Long): Student? = INSTANCE.findById(Student::class.java, id) as Student?
