...
public class FlywayRecorder {
    ...
    public Function<SyntheticCreationalContext<FlywayContainer>, FlywayContainer> flywayContainerFunction(
            Class<? extends FlywayContainerProducer> producerClass, String dataSourceName, String name,
        ...
        return new Function<>() {
            ...
            public FlywayContainer apply(SyntheticCreationalContext<FlywayContainer> context) {
                ...
                return flywayProducer.createFlyway(dataSource, dataSourceName, name, hasMigrations, createPossible);
            }
        };
    }
