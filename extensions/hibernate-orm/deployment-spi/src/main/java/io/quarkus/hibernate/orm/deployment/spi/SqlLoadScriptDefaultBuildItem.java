...
/**
 * Additional default for quarkus.hibernate-orm.data-management.init-script for tests/dev,
 ...
 *             in dev and test modes, for all persistence units, so this build item is no longer necessary.
 */
