...
<1> Having this configuration means that all requests performed using `org.acme.restclient.multipart.MultipartService` will use `http://localhost:8080/ ` as the base URL.
