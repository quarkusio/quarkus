...
public final class PanacheConstants {
    ...
    public static final String JAKARTA_ANNOTATION_PREFIX = "Ljakarta/xml/bind/annotation/";
    public static final String META_INF_PANACHE_ARCHIVE_MARKER = "META-INF/panache-archive.marker";
    private static final String JAKARTA_TRANSIENT_BINARY_NAME = "jakarta/xml/bind/annotation/XmlTransient";
    public static final String JAKARTA_TRANSIENT_SIGNATURE = "L" + JAKARTA_TRANSIENT_BINARY_NAME + ";";
    ...
    public static final DotName JSON_PROPERTY_ACCESS_DOT_NAME = DotName
            .createSimple("com.fasterxml.jackson.annotation.JsonProperty.Access");
