...
public interface KubernetesConfig extends PlatformConfiguration {
    ...
    /**
     * The kind of the deployment resource to use. Supported values are 'StatefulSet', 'Job', 'CronJob' and 'Deployment'
     * defaulting to the latter.
     */
    Optional<DeploymentResourceKind> deploymentKind();

    /**
     * The target deployment platform. Defaults to kubernetes. Can be kubernetes, openshift, knative, minikube etc., or
     * any combination of the above as comma separated list.
     */
