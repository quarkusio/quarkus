...
export class PuiApp extends LitElement {
    ...
    firstUpdated() {
        ...
        this._router.setRoutes([
            ...
            { path: this._basePath + '/configuration', component: 'pui-configuration' },
            { path: this._basePath + '/endpoints', component: 'pui-endpoints' },
            { path: this._basePath + '/dependencies', component: 'pui-dependencies' },
    ...
    _updatePageInfo() {
        ...
        const builtIn = { '/configuration': 'Configuration', '/endpoints': 'Endpoints', '/dependencies': 'Dependencies' };
        if (builtIn[relative]) {
            this._pageTitle = builtIn[relative];
            this._subPages = [];
            this._activeSubPage = null;
            return;
        }
        ...
        return html`
            ...
            <div class="pui-main">
                <nav class="pui-nav">
                    ...
                    <a class="nav-link ${this._isActive('configuration')}" @click=${() => this._navigate('configuration')}>
                        Configuration
                    </a>
                    <a class="nav-link ${this._isActive('endpoints')}" @click=${() => this._navigate('endpoints')}>
                        Endpoints
                    </a>
                    <a class="nav-link ${this._isActive('dependencies')}" @click=${() => this._navigate('dependencies')}>
                        Dependencies
                    </a>
