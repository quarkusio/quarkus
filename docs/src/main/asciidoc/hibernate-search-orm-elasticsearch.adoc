...
%test.quarkus.hibernate-search-orm.automatic-indexing.synchronization.strategy=sync <8>
...
%test.quarkus.hibernate-search-orm."users".automatic-indexing.synchronization.strategy=sync
...
%test.quarkus.hibernate-search-orm."inventory".automatic-indexing.synchronization.strategy=sync
----
