...
/**
 * An encoder for DNS messages. The primary usage of the DnsMessageEncoder is to call the
 * <code>encode(ByteBuffer, DnsMessage)</code> method which will write the message to the outgoing ByteBuffer according
 * to the DnsMessage encoding in RFC-1035.
 *
...
public class DnsMessageEncoder {
    ...
    public void encode(IoBuffer byteBuffer, DnsMessage message) {
        ...
        byteBuffer
                .putShort((short) (message.getAdditionalRecords() != null ? message.getAdditionalRecords().size() : 0));
