...
NOTE: The `vector` PostgreSQL extension must be installed in your database. When using Dev Services, configure the pgvector image: `quarkus.datasource.devservices.image-name=docker.io/pgvector/pgvector:pg18`.
