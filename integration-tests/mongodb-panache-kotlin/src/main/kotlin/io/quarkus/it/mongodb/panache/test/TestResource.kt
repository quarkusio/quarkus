...
@Path("/test")
class TestResource {
    @Inject lateinit var testImperativeRepository: TestImperativeRepository

    @Inject lateinit var testReactiveRepository: TestReactiveRepository
    ...
    fun testImperativeEntity(): Response {
        ...
        var results: List<TestImperativeEntity> =
            TestImperativeEntity.listAll(Sort.ascending("title"))
        ...
        val collation: Collation =
            Collation.builder()
                ...
                .build()
        results =
            TestImperativeEntity.findAll(Sort.ascending("title")).withCollation(collation).list()
        Assertions.assertEquals("aaa", results[0].title)
        ...
        // update
        val list: List<TestImperativeEntity> =
            TestImperativeEntity.list("category = ?1", "category0")
        ...
        var updated: Long =
            TestImperativeEntity.update("category", "newCategory2").where("category", "newCategory")
        Assertions.assertEquals(5, updated)
        updated =
            TestImperativeEntity.update("category = ?1", "newCategory")
                .where("category = ?1", "newCategory2")
        Assertions.assertEquals(5, updated)
        updated =
            TestImperativeEntity.update("{'category' : ?1}", "newCategory2")
                .where("{'category' : ?1}", "newCategory")
        Assertions.assertEquals(5, updated)
        updated =
        ...
        Assertions.assertEquals(10, updated)
        updated =
            TestImperativeEntity.update(Document("\$inc", Document("cpt", 1)))
                .where(Document("category", "newCategory2"))
        Assertions.assertEquals(5, updated)
    ...
    fun testImperativeRepository(): Response {
        ...
        var result: TestImperativeEntity =
            testImperativeRepository.listAll(Sort.ascending("title"))[0]
        Assertions.assertEquals("aaa", result.title)
        ...
        var results: List<TestImperativeEntity> =
            testImperativeRepository.listAll(Sort.ascending("title"))
        Assertions.assertEquals("AAA", results[0].title)
        Assertions.assertEquals("BBB", results[1].title)
        Assertions.assertEquals("aaa", results[2].title)
        val collation: Collation =
        ...
        // update
        val list: List<TestImperativeEntity> =
            testImperativeRepository.list("category = ?1", "category0")
        Assertions.assertEquals(5, list.size)
        for (entity in list) {
            entity.category = "newCategory"
        }
        ...
        var updated: Long =
            testImperativeRepository
                .update("category", "newCategory2")
                .where("category", "newCategory")
        Assertions.assertEquals(5, updated)
        updated =
            testImperativeRepository
                .update("category = ?1", "newCategory")
                .where("category = ?1", "newCategory2")
        Assertions.assertEquals(5, updated)
        updated =
            testImperativeRepository
                .update("{'category' : ?1}", "newCategory2")
                .where("{'category' : ?1}", "newCategory")
        Assertions.assertEquals(5, updated)
        updated =
            testImperativeRepository
                .update("category = :category", Parameters.with("category", "newCategory"))
                .where("category = :category", Parameters.with("category", "newCategory2"))
        Assertions.assertEquals(5, updated)
        updated =
            testImperativeRepository
                .update("{'category' : :category}", Parameters.with("category", "newCategory2"))
                .where("{'category' : :category}", Parameters.with("category", "newCategory"))
        Assertions.assertEquals(5, updated)
        ...
        updated =
            testImperativeRepository
                .update(Document("\$inc", Document("cpt", 1)))
                .where(Document("category", "newCategory2"))
        Assertions.assertEquals(5, updated)
    ...
    fun testReactiveEntity(): Response {
        ...
        var result: TestReactiveEntity =
            TestReactiveEntity.listAll(Sort.ascending("title")).await().indefinitely()[0]
        Assertions.assertEquals("aaa", result.title)
        ...
        var results: List<TestReactiveEntity> =
            TestReactiveEntity.listAll(Sort.ascending("title")).await().indefinitely()
        Assertions.assertEquals("AAA", results[0].title)
        Assertions.assertEquals("BBB", results[1].title)
        Assertions.assertEquals("aaa", results[2].title)
        val collation: Collation =
            Collation.builder()
                ...
                .build()
        results =
            TestReactiveEntity.findAll(Sort.ascending("title"))
                .withCollation(collation)
                .list()
                .await()
                .indefinitely()
        ...
        // update
        val list: List<TestReactiveEntity> =
            TestReactiveEntity.list("category = ?1", "category0").await().indefinitely()
        Assertions.assertEquals(5, list.size)
        for (entity in list) {
            entity.category = "newCategory"
        }
        ...
        var updated: Long =
            TestReactiveEntity.update("category", "newCategory2")
                .where("category", "newCategory")
                .await()
                .indefinitely()
        Assertions.assertEquals(5, updated)
        updated =
            TestReactiveEntity.update("category = ?1", "newCategory")
                .where("category = ?1", "newCategory2")
                .await()
                .indefinitely()
        Assertions.assertEquals(5, updated)
        updated =
            TestReactiveEntity.update("{'category' : ?1}", "newCategory2")
                .where("{'category' : ?1}", "newCategory")
                .await()
                .indefinitely()
        Assertions.assertEquals(5, updated)
        ...
        Assertions.assertEquals(10, updated)
        updated =
            TestReactiveEntity.update(Document("\$inc", Document("cpt", 1)))
                .where(Document("category", "newCategory2"))
                .await()
                .indefinitely()
        Assertions.assertEquals(5, updated)
        ...
        TestReactiveEntity.delete("category = :category", Parameters.with("category", "category0"))
            .await()
            .indefinitely()
    ...
    fun testReactiveRepository(): Response {
        ...
        var result: TestReactiveEntity =
            testReactiveRepository.listAll(Sort.ascending("title")).await().indefinitely()[0]
        Assertions.assertEquals("aaa", result.title)
        ...
        var results: List<TestReactiveEntity> =
            testReactiveRepository.listAll(Sort.ascending("title")).await().indefinitely()
        Assertions.assertEquals("AAA", results[0].title)
        Assertions.assertEquals("BBB", results[1].title)
        Assertions.assertEquals("aaa", results[2].title)
        val collation: Collation =
        ...
        // update
        val list: List<TestReactiveEntity> =
            testReactiveRepository.list("category = ?1", "category0").await().indefinitely()
        Assertions.assertEquals(5, list.size)
        for (entity in list) {
            entity.category = "newCategory"
        }
        ...
        Assertions.assertEquals(10, updated)
        updated =
            testReactiveRepository.update("{'\$inc': {'cpt': 1}}").all().await().indefinitely()
        Assertions.assertEquals(10, updated)
        updated =
            testReactiveRepository
                .update(Document("\$inc", Document("cpt", 1)))
        ...
        testReactiveRepository
            .delete("category = :category", Parameters.with("category", "category0"))
            .await()
            .indefinitely()
        testReactiveRepository
            .delete("{'category' : :category}", Parameters.with("category", "category1"))
            .await()
            .indefinitely()
        Assertions.assertEquals(0, testReactiveRepository.count().await().indefinitely())
    ...
    private val testReactiveEntities: List<TestReactiveEntity>
        get() {
            return (0..9).map {
                TestReactiveEntity("title$it", "category" + it % 2, "description$it")
            }
        }
