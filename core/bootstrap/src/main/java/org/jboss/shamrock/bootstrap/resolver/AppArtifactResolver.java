...
public interface AppArtifactResolver {
     ...
     * @throws AppArtifactResolverException  in case of a failure
     */
    List<AppDependency> collectDependencies(AppArtifact artifact) throws AppArtifactResolverException;

    /**
     * Collect dependencies that are required by application at runtime, excluding test and optional depependencies.
     *
     * @param artifact
     * @return
     * @throws AppArtifactResolverException
     */
    List<AppDependency> collectRuntimeDependencies(AppArtifact artifact) throws AppArtifactResolverException;
     ...
     * @throws AppArtifactResolverException  in case of a failure
     */
    List<AppDependency> collectDependencies(AppArtifact root, List<AppDependency> deps) throws AppArtifactResolverException;
