...
public class BuildTreeMojoTest {
    ...
    public void testMain() throws Exception {
        ...
        assertEquals(readInLowCase(Paths.get("").toAbsolutePath().resolve("target").resolve("test-classes").resolve(app.getArtifactFileName() + ".build.tree")), readInLowCase(mojoLog));
    }
