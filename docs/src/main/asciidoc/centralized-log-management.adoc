...
See the following documentation for Graylog (but the same issue exists for the other central logging stacks): link::https://g
o2docs.graylog.org/current/setting_up_graylog/opensearch.htm#C
ustomIndexMappings[Custom Index Mapping].
...
you can access its documentation here: https://github.com/mp911de/logstash-gelf.
