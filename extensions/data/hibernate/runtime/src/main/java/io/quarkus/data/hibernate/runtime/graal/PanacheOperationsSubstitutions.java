package io.quarkus.data.hibernate.runtime.graal;
...
public class PanacheOperationsSubstitutions {
    ...
    @TargetClass(className = "io.quarkus.data.hibernate.runtime.spi.PanacheOperations", onlyWith = NoHibernateReactive.class)
