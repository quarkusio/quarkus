...
import io.quarkus.qrs.runtime.TypeSignatureParser;
...
public class TypeSignatureParserTest {
    ...
    public void testSignatures() throws NoSuchMethodException, SecurityException {
        ...
        assertType("[Ljava/lang/Class;", Class[].class);
        assertType("[[Ljava/lang/Class;", Class[][].class);
        assertType("Lio/quarkus/qrs/runtime/mapping/TypeSignatureParserTest;", TypeSignatureParserTest.class);
        assertType("Lio/quarkus/qrs/runtime/mapping/TypeSignatureParserTest.StaticInner;", StaticInner.class);
        assertType("Lio/quarkus/qrs/runtime/mapping/TypeSignatureParserTest.Inner;", Inner.class);
        ...
        assertType("Lio/quarkus/qrs/runtime/mapping/TypeSignatureParserTest.InnerGeneric<Ljava/lang/String;>;",
                new TypeLiteral<InnerGeneric<String>>() {
                });
        assertType(
                "Lio/quarkus/qrs/runtime/mapping/TypeSignatureParserTest.InnerGeneric<Ljava/lang/String;>.Inner<Ljava/lang/Integer;>;",
