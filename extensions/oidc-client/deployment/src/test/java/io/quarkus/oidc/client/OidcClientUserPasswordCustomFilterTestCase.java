...
public class OidcClientUserPasswordCustomFilterTestCase {
    ...
    private static Class<?>[] testClasses = { FrontendResource.class, ProtectedResource.class,
            ProtectedResourceService.class, OidcClientRequestCustomFilter.class };
    ...
    public void testGetUserName() {
        RestAssured.when().get("/frontend/user").then().statusCode(200).body(equalTo("bob"));
    ...
    public void testGetUserOidcClientNameAndRefreshTokens() {
        ...
        await().atMost(10, TimeUnit.SECONDS).pollInterval(Duration.ofSeconds(3)).until(new Callable<Boolean>() {
            @Override
