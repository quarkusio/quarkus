...
public class GenericKeyStoreWithSniTest {

    private static final String configuration = """
            quarkus.tls.key-store.pkcs12.path=target/certs/test-sni-p12-keystore.p12
            quarkus.tls.key-store.pkcs12.password=sni
            quarkus.tls.key-store.pkcs12.alias-password=sni
