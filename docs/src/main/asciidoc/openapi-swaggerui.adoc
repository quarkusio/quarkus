...
include::{generated-config-doc-dir}/quarkus-smallrye-openapi.adoc[opts=optional, leveloffset=+1]

=== Swagger UI

include::{generated-config-doc-dir}/quarkus-swagger-ui.adoc[opts=optional, leveloffset=+1]
