...
public interface CertificateConfig {
    /**
     * The {@linkplain CredentialsProvider}. If this property is configured, then a matching 'CredentialsProvider' will
     * be used to get the keystore, keystore key, and truststore passwords unless these passwords have already been
     * configured.
     * <p>
     * Please note that using MicroProfile {@linkplain ConfigSource} which is directly supported by Quarkus
     * Configuration should be preferred unless using `CredentialsProvider` provides for some additional security and
     * dynamism.
     */
    ...
    /**
     * The list of path to server certificates using the PEM format. Specifying multiple files requires SNI to be
     * enabled.
     */
    Optional<List<Path>> files();

    /**
     * The list of path to server certificates private key files using the PEM format. Specifying multiple files
     * requires SNI to be enabled.
     * <p>
     ...
     * detected based on the keystore file type.
     */
    Optional<String> keyStoreProvider();

    /**
     * A parameter to specify the password of the keystore file. If not given, and if it can not be retrieved from
    ...
    /**
     * A parameter to specify a {@linkplain CredentialsProvider} property key, which can be used to get the password of
     * the key store file from {@linkplain CredentialsProvider}.
     *
     * @see CertificateConfig#credentialsProvider()
     */
    ...
    /**
     * An optional parameter to select a specific key in the keystore. When SNI is disabled, and the keystore contains
     * multiple keys and no alias is specified; the behavior is undefined.
     *
    ...
    /**
     * An optional parameter to define the password for the key, in case it is different from {@link #keyStorePassword}
    ...
    /**
     * A parameter to specify a {@linkplain CredentialsProvider} property key, which can be used to get the password for
     * the alias from {@linkplain CredentialsProvider}.
     *
     * @see CertificateConfig#credentialsProvider()
     *
    ...
    /**
     * An optional list of trusted certificates using the PEM format. If you pass multiple files, you must use the PEM
     * format.
     */
    Optional<List<Path>> trustStoreFiles();

    /**
     * An optional parameter to specify the type of the trust store file. If not given, the type is automatically
     ...
     * detected based on the trust store file type.
     */
    Optional<String> trustStoreProvider();

    /**
     * A parameter to specify the password of the trust store file. If not given, it might be retrieved from
     * {@linkplain CredentialsProvider}.
     *
     * @see CertificateConfig#credentialsProvider()
     */
    ...
    /**
     * A parameter to specify a {@linkplain CredentialsProvider} property key, which can be used to get the password of
     * the trust store file from {@linkplain CredentialsProvider}.
     *
     * @see CertificateConfig#credentialsProvider()
     */
    ...
    /**
     * An optional parameter to trust a single certificate from the trust store rather than trusting all certificates in
     * the store.
     */
    Optional<String> trustStoreCertAlias();

    /**
     * When set, the configured certificate will be reloaded after the given period. Note that the certificate will be
     * reloaded only if the file has been modified.
     * <p>
