...
public final class FormAuthenticationEvent extends AbstractSecurityEvent {
    ...
    public static final String USERNAME_PASSWORD_CREDENTIALS_TYPE = "USERNAME_AND_PASSWORD";
    public static final String ONE_TIME_AUTH_TOKEN_CREDENTIALS_TYPE = "ONE_TIME_AUTHENTICATION_TOKEN";
    ...
    static FormAuthenticationEvent createEmptyLoginEvent() {
        return createLoginEvent(null, USERNAME_PASSWORD_CREDENTIALS_TYPE);
    }
    ...
    static FormAuthenticationEvent createLoginEvent(SecurityIdentity identity, AuthenticationRequest authenticationRequest) {
        ...
        if (authenticationRequest instanceof UsernamePasswordAuthenticationRequest) {
            credentialsType = USERNAME_PASSWORD_CREDENTIALS_TYPE;
        } else if (authenticationRequest instanceof OneTimeTokenAuthenticationRequest) {
            credentialsType = ONE_TIME_AUTH_TOKEN_CREDENTIALS_TYPE;
        } else {
