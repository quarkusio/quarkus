...
public interface ReactiveMongoDatabase {
     ...
     * @return a completion stage containing the command result once completed
     */
    <T> CompletionStage<T> runCommand(ClientSession clientSession, Bson command, ReadPreference readPreference,
            Class<T> clazz);
     ...
     * @return a stream of the result of the aggregation operation
     */
    <T> AggregatePublisher<T> aggregateAsPublisher(ClientSession clientSession, List<? extends Bson> pipeline,
            Class<T> clazz);
