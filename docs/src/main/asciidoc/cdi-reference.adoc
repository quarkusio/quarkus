...
In CDI, if you declare a field injection point you need to use `@Inject` and optionally required qualifiers:
...
Nevertheless, most of the functionality can be achieved using Quarkus link:writing-extensions.html[extensions].
