...
class VertxRedisClientFactoryTest {
    ...
    void shouldApplyQuery() {
        ...
        String applied = VertxRedisClientFactory.applyClientQueryParam("quarkus-app",
    ...
    void shouldNotApplyQuery() {
        String applied = VertxRedisClientFactory.applyClientQueryParam("quarkus-app",
                URI.create("redis://localhost:6379?client=quarkiverse-app"));
    ...
    void shouldApplyWithQueryParams() {
        String applied = VertxRedisClientFactory.applyClientQueryParam("quarkus-app",
                URI.create("redis://localhost:6379?someQueryParam=123456789"));
