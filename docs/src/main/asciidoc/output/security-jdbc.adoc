...
:categories: security
:summary: This guide demonstrates how your {product-name-first} application can use a database to store your user identities.

This guide demonstrates how your {product-name} application can use a database to store your user identities.
...
which is an https://docs.wildfly.org/17/WildFly_Elytron_Security.html#jdbc-security-realm[`wildfly-elytron-realm-jdbc`] adapter for {product-name} applications.

If you already have your {product-name} project configured, you can add the `elytron-security-jdbc` extension
