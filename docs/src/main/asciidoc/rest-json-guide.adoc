...
Quarkus provides the option of using https://github.com/FasterXML/jackson[Jackson] instead of JSON-B. To do so, the `quarkus-resteasy-jsonb` dependency needs to be replaced with:
