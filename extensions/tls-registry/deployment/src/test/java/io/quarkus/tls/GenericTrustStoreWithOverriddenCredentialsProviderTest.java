...
public class GenericTrustStoreWithOverriddenCredentialsProviderTest {

    private static final String configuration = """
            quarkus.tls.trust-store.pkcs12.path=target/certs/test-credentials-provider-truststore.p12
            quarkus.tls.trust-store.pkcs12.password=secret123!
