...
import io.quarkus.grpc.server.services.BlockingOnClassExtendingTestService;
import io.quarkus.test.QuarkusUnitTest;

public class BlockingOnClassExtendingMethodsTest extends BlockingMethodsBase {
    ...
    static final QuarkusUnitTest config = new QuarkusUnitTest()
            ...
            .setArchiveProducer(
                    () -> ShrinkWrap.create(JavaArchive.class)
                            ...
                            .addClasses(BlockingBaseTestService.class, BlockingOnClassExtendingTestService.class,
                                    AssertHelper.class))
