package io.quarkus.redis.datasource.api.geo;
...
public interface ReactiveTransactionalGeoCommands<K, V> {
     ...
     */
    @Deprecated
    Uni<Void> georadius(K key, double longitude, double latitude, double radius, GeoUnit unit, GeoRadiusStoreArgs<K> geoArgs);
