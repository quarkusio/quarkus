...
public class ORMReactiveCompatbilityDifferentNamedDataSourceNamedPersistenceUnitBothUnitTest extends CompatibilityUnitTestBase {
    ...
    static final QuarkusUnitTest config = new QuarkusUnitTest()
            ...
            .overrideConfigKey("quarkus.datasource.\"named-datasource-reactive\".reactive.url", "${postgres.reactive.url}")
            .overrideConfigKey("quarkus.datasource.\"named-datasource-blocking\".jdbc.url", "${postgres.blocking.url}")
