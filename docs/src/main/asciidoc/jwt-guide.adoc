...
https://bitbucket.org/b_c/jose4j/wiki/Home[Jose4J] library and the TokenUtils class shown in the following listing. Take this source and place it into using-jwt-rbac/src/test/java/org/acme/jwt/TokenUtils.java.
...
[INFO] Scanning for projects...
...
[INFO] [io.quarkus.creator.phase.runnerjar.RunnerJarPhase] Building jar: /Users/starksm/Dev/JBoss/Protean/starksm64-quarkus-quickstarts/using-jwt-rbac/target/security-jwt-quickstart-runner.jar

Scotts-iMacPro:using-jwt-rbac starksm$ java -jar target/security-jwt-quickstart-runner.jar
...
Scotts-iMacPro:using-jwt-rbac starksm$ ./target/security-jwt-quickstart-runner
