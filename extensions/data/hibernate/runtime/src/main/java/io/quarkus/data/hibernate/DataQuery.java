 ...
 */
public interface DataQuery<Query extends DataQuery<Query, Entity, SortEntity, EntityList, QueryAfterCount, Confirmation, Count>, Entity, SortEntity, EntityList, QueryAfterCount, Confirmation, Count> {
