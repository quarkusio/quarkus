...
import io.quarkus.rest.test.resource.basic.resource.SubResourceLocatorBaseCrudService;
import io.quarkus.rest.test.resource.basic.resource.SubResourceLocatorBaseService;
import io.quarkus.rest.test.resource.basic.resource.SubResourceLocatorFoo;
import io.quarkus.rest.test.resource.basic.resource.SubResourceLocatorImpFoo;
import io.quarkus.rest.test.resource.basic.resource.SubResourceLocatorOhaUserModel;
import io.quarkus.rest.test.resource.basic.resource.SubResourceLocatorPlatformServiceImpl;
import io.quarkus.rest.test.resource.basic.resource.SubResourceLocatorPlatformServiceResource;
import io.quarkus.rest.test.resource.basic.resource.SubResourceLocatorUserResource;
