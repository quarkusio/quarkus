...
public class GenericTrustStoreFromClassPathTest {

    private static final String configuration = """
            quarkus.tls.trust-store.pkcs12.path=/certs/truststore.p12
    ...
    static final QuarkusUnitTest config = new QuarkusUnitTest().setArchiveProducer(
            () -> ShrinkWrap.create(JavaArchive.class)
                    .addAsResource(new File("target/certs/test-formats-truststore.p12"), "/certs/truststore.p12")
