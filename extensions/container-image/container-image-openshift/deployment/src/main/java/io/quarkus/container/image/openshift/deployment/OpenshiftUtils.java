...
/**
 * This class is copied from Dekorate, with the difference that the {@code waitForImageStreamTags} method take a client
 * as the argument TODO: Update dekorate to take the client as an argument and then remove this class
 */
public class OpenshiftUtils {
     ...
     *
     * @param client
     *        The openshift client used to check the status of the ImageStream
     * @param items
     *        A list of items, possibly referencing image stream tags.
     * @param amount
     *        The max amount of time to wait.
     * @param timeUnit
     *        The time unit of the time to wait.
     *
    ...
    public static boolean waitForImageStreamTags(OpenShiftClient client, Collection<HasMetadata> items, long amount,
        ...
        new KubernetesListBuilder().withItems(new ArrayList<>(items))
