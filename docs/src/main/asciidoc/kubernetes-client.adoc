...
You will most likely need access to the kubernetes API using a ServiceAccount, Role and RoleBinding to run the new application.
...
Replae <applicationName> and <namespace> with your values.
