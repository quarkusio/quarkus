...
public class ConfigBuildStep {
    ...
    private static final DotName MP_CONFIG_VALUE_API_NAME = DotName
            .createSimple(org.eclipse.microprofile.config.ConfigValue.class.getName());
        ...
        for (InjectionPointInfo injectionPoint : beanRegistrationPhase.getContext().get(INJECTION_POINTS)) {
            ...
            if (configProperty != null) {
                ...
                if (DotNames.OPTIONAL.equals(requiredType.name())
                        ...
                        || MP_CONFIG_VALUE_API_NAME.equals(requiredType.name())) {
    ...
    private boolean isHandledByProducers(Type type) {
        ...
        return DotNames.STRING.equals(type.name()) ||
                ...
                MP_CONFIG_VALUE_API_NAME.equals(type.name());
    }
}
