...
/**
 * Registers security check against {@link io.quarkus.security.spi.ClassSecurityCheckStorageBuildItem} for security
 * annotation instances passed in this build item. This class is exposed for limited Quarkus core-specific use cases and
 * can be changed or be removed if necessary. If other extensions require this build item, please open Quarkus issue so
 * that we document and test the use case.
 */
