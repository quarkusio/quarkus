...
public abstract class AbstractDataSourceProducer {
    ...
    protected AgroalDataSource createDataSource(String dataSourceName,
        ...
        if (dataSourceRuntimeConfig.username.isPresent()) {
            poolConfiguration.connectionFactoryConfiguration().principal(new NamePrincipal(dataSourceRuntimeConfig.username.get()));
        }
        if (dataSourceRuntimeConfig.password.isPresent()) {
            poolConfiguration.connectionFactoryConfiguration().credential(new SimplePassword(dataSourceRuntimeConfig.password.get()));
        }
