...
the xref:kafka-schema-registry-json-schema.adoc[Using Apache Kafka with Schema Registry and JSON Schema] guide for JSON Schema,
or the xref:kafka-schema-registry-protobuf.adoc[Using Apache Kafka with Schema Registry and Protobuf] guide for Protobuf.
====
