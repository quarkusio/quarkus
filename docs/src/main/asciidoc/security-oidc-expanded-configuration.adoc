...
|quarkus.oidc.allowed-routes |`backchannel-logout,resource-metadata,cimd`|OIDC routes that tenants can use
|====
...
* `cimd` - enables an HTTP route for OIDC tenants to handle requests for <<client-id-metadata-document,Client ID Metadata Document>>
