...
As we are going to invoke a `https` service, also configure the quarkus-maven-plugin from the _native_ profile with:
...
<executions>
    <execution>
        ...
        <configuration>
            ...
            <enableHttpsUrlHandler>true</enableHttpsUrlHandler> <!-- Add this line -->
        </configuration>
    </execution>
</executions>
----
...
This application can be compiled and run as a native executable with:
