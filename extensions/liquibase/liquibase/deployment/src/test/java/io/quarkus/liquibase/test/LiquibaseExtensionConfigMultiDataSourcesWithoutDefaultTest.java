...
public class LiquibaseExtensionConfigMultiDataSourcesWithoutDefaultTest {
    ...
    static final QuarkusUnitTest config = new QuarkusUnitTest().withApplicationRoot(
            (jar) -> jar.addClass(LiquibaseExtensionConfigFixture.class).addAsResource("db/changeLog.xml")
                    .addAsResource("db/inventory/changeLog.xml").addAsResource("db/users/changeLog.xml").addAsResource(
