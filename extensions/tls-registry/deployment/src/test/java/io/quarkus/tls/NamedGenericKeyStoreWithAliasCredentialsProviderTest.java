...
public class NamedGenericKeyStoreWithAliasCredentialsProviderTest {

    private static final String configuration = """
            quarkus.tls.foo.key-store.pkcs12.path=target/certs/test-credentials-provider-alias-keystore.p12
            quarkus.tls.foo.key-store.pkcs12.alias=my-alias
