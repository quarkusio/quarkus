...
public class AmazonLambdaContextTest {
    ...
    public void testGetRemainingTimeInMillis() throws Exception {
        ...
        // We add 5 seconds to the current date and set this as lambda deadline, so we know there is still some
        // remaining time left
        ...
        assertTrue(amazonLambdaContext.getRemainingTimeInMillis() > 0,
                "The remaining time in millis should not be negative");
    }
}
