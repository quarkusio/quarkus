...
public final class HibernateLogFilterBuildStep {
    ...
    void setupLogFilters(BuildProducer<LogCleanupFilterBuildItem> filters) {
        ...
        filters.produce(new LogCleanupFilterBuildItem("org.hibernate.orm.incubating", "HHH90006001"));
        ...
        filters.produce(new LogCleanupFilterBuildItem("org.hibernate.orm.connections.pooling", "HHH10001005"));

        // This "deprecation" warning isn't practical for the specific Quarkus needs, as it reminds users they don't
        // need
