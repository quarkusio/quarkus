...
public class OpenApiHttpRootPathCorsTestCase {
    ...
    static QuarkusUnitTest runner = new QuarkusUnitTest()
            .withApplicationRoot((jar) -> jar.addClasses(OpenApiRoute.class)
    ...
    public void testCorsFilterProperties() {
        ...
        RestAssured.given().header("Origin", "https://quarkus.io").log().all().filter(new ResponseLoggingFilter())
                .get("/q/openapi").then().statusCode(200).header("access-control-allow-origin", "https://quarkus.io")
