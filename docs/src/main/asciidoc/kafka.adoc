...
This is described in a dedicated guide: xref:kafka-schema-registry-protobuf.adoc[Using Apache Kafka with Schema Registry and Protobuf].
...
for JSON Schema: xref:kafka-schema-registry-json-schema.adoc[Using Apache Kafka with Schema Registry and JSON Schema],
and for Protobuf: xref:kafka-schema-registry-protobuf.adoc[Using Apache Kafka with Schema Registry and Protobuf].
