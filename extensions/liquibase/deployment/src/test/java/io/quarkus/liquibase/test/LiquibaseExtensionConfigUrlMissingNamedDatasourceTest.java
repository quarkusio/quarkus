...
public class LiquibaseExtensionConfigUrlMissingNamedDatasourceTest {
    ...
    @Test
    @DisplayName("If the URL is missing for a named datasource, the application should fail to boot")
