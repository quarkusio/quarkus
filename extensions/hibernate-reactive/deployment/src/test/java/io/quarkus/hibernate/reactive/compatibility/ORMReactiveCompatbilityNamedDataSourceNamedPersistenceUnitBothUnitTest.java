...
public class ORMReactiveCompatbilityNamedDataSourceNamedPersistenceUnitBothUnitTest extends CompatibilityUnitTestBase {
    ...
    static final QuarkusUnitTest config = new QuarkusUnitTest()
            ...
            .overrideConfigKey("quarkus.datasource.\"named-datasource\".jdbc.url", "${postgres.blocking.url}")
            .overrideConfigKey("quarkus.datasource.\"named-datasource\".reactive.url", "${postgres.reactive.url}")
