...
You can still access the Dev UI v1 using http://localhost/q/devui-v1/
====
...
quarkus with `mvn quarkus:dev`) at http://localhost:8080/q/devui-v1[/q/devui-v1] by default. It will show you something like
this:
