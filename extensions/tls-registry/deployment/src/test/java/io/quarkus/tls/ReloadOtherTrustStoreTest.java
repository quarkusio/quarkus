...
public class ReloadOtherTrustStoreTest {
    ...
    static final QuarkusExtensionTest config = new QuarkusExtensionTest().setArchiveProducer(
            ...
            .overrideRuntimeConfigKey("quarkus.tls.trust-store.other.type", "PKCS12")
            .overrideRuntimeConfigKey("quarkus.tls.trust-store.other.path", temp.getAbsolutePath() + "/tls.p12")
            .overrideRuntimeConfigKey("quarkus.tls.trust-store.other.password", "password")
