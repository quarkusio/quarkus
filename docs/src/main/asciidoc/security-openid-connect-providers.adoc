...
image::oidc-github-generic-1.png[role="thumb"]

Make sure to fill in the appropriate details, but more importantly the Authorization Callback URL, set to `http://localhost:8080/github/userinfo`
...
image::oidc-github-generic-2.png[role="thumb"]
