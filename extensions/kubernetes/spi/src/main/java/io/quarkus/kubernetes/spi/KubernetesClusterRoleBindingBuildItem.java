...
/**
 * Produce this build item to request the Kubernetes extension to generate a Kubernetes {@code ClusterRoleBinding}
 * resource. The configuration here is limited; in particular, you can't specify subjects of the role binding. The role
 * will always be bound to the application's service account.
 */
public final class KubernetesClusterRoleBindingBuildItem extends BaseTargetable {
    /**
     * Name of the generated {@code RoleBinding} resource. Can be {@code null}, in which case the resource name is
     * autogenerated.
     */
    ...
    public KubernetesClusterRoleBindingBuildItem(String name, String role, boolean clusterWide, String target) {
        this(name, target, Collections.emptyMap(), new RoleRef(role, clusterWide),
                new Subject("", "ServiceAccount", name, null));
    }

    public KubernetesClusterRoleBindingBuildItem(String name, String target, Map<String, String> labels,
