...
{/include}
----
<1> `include` section is used to specify the extended template. If this template resides within `src/main/resources/templates/tags` you can reference it by name, otherwise you will need to specify its extension and relative path from `src/main/resources/templates`.
