...
/**
 * REST data Panache resource that uses {@link PanacheMongoRepositoryBase} instance for data access and exposes it as a
 * JAX-RS resource.
 * <p>
 ...
 *
 * @param <Repository>
 *        {@link PanacheMongoRepositoryBase} instance that should be used for data access.
 * @param <Entity>
 *        Entity type that is handled by this resource and the linked {@link PanacheMongoRepositoryBase} instance.
 * @param <ID>
