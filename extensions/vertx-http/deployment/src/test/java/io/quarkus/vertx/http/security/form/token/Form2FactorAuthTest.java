...
public class Form2FactorAuthTest {
    ...
    public void testFormBasedAuthSuccess() {
        ...
        assertNotNull(response.cookie("quarkus-token-request"));
        ...
        assertNull(response.cookie("quarkus-token-request"));
    ...
    public void testFormBasedAuthSuccessLandingPage() {
        ...
        response = RestAssured
                ...
                .extract();
        assertEquals(0, response.detailedCookie("quarkus-token-request").getMaxAge());
        assertEquals("", response.detailedCookie("quarkus-token-request").getValue());
    }
