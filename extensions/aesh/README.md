...
Create commands with `@CommandDefinition`:
...
@CommandDefinition(name = "module", description = "Module management",
...
|-------------------|------|
| Single `@CommandDefinition` | Runtime (execute and exit) |
| Single `@CommandDefinition` with `groupCommands` encompassing all commands | Runtime |
| Multiple independent `@CommandDefinition` classes | Console (interactive shell) |
