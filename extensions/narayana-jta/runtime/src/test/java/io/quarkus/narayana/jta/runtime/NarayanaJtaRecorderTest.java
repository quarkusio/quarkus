...
public class NarayanaJtaRecorderTest {
    ...
    // this string has been chosen as when hashed and Base64 encoded the resulted byte array will have a length > 28, so
    // it will be trimmed too.
    ...
    void testByteLengthWithLongerString() throws NoSuchAlgorithmException {
        ...
        assertEquals(28, numberOfBytes, "node name bytes was not 28 bytes limit, number of bytes is " + numberOfBytes);
    }
