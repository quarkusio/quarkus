...
This command generates the project and imports the `local` and `rest-jackson` extensions.

If you already have your Quarkus project configured, you can add the `local` extension
