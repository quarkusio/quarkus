 ...
 */
public class DefaultPersistentLoginManager implements PersistentLoginManager {
    ...
    public DefaultPersistentLoginManager(String encryptionKey, String cookieName, long timeoutMillis, long newCookieIntervalMillis) {
        try {
