...
public class ImportMapTest extends WebDependencyLocatorTestSupport {
    ...
    static QuarkusUnitTest runner = new QuarkusUnitTest()
            ...
            .setForcedDependencies(List.of(Dependency.of("org.mvnpm", "bootstrap", BOOTSTRAP_VERSION)));

    @Test
    public void test() {
        // Test normal files
        RestAssured.get("/_importmap/generated_importmap.js").then().statusCode(200)
