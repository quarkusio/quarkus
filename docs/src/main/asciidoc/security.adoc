...
|link:security-properties.html[quarkus-elytron-security-properties-file]
...
|link:security-jdbc.html[quarkus-elytron-security-jdbc]
|Provides support for authenticating via JDBC.

|link:security-oauth2.html[quarkus-elytron-security-oauth2]
...
|link:security-jwt.html[quarkus-smallrye-jwt]
...
|link:security-openid-connect.html[quarkus-oidc]
|Provides support for authenticating via an OpenID Connect provider such as Keycloak.

|link:security-keycloak-authorization.html[quarkus-keycloak-authorization]
...
that provides a username/password based `IdentityProvider`, such as link:security-jdbc.html[Elytron JDBC].
