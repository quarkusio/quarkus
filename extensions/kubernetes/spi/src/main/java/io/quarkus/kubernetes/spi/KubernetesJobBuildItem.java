...
/**
 * A Built item for generating init containers. The generated container will have the specified fields and may
...
public final class KubernetesJobBuildItem extends MultiBuildItem implements Targetable {
    ...
    public KubernetesJobBuildItem(String name, String target, String image, List<String> command,
