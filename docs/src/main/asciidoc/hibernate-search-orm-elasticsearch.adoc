...
include::{generated-dir}/quarkus-hibernate-search-orm-elasticsearch.adoc[leveloffset=+1, opts=optional]
...
include::{generated-dir}/quarkus-hibernate-search-orm-outboxpolling.adoc[leveloffset=+1, opts=optional]
