...
In this guide, we will learn how to configure a {product-name-first} application.
...
A {product-name} application uses the https://github.com/smallrye/smallrye-config[SmallRye Config] API to provide all
mechanisms related with configuration.

By default, {product-name} reads configuration properties from <<config-reference.adoc#configuration-sources,several sources>>.
