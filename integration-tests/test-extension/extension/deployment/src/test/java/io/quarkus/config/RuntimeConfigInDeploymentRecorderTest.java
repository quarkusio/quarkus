...
public class RuntimeConfigInDeploymentRecorderTest {
    @RegisterExtension
    ...
    static class TestConfigBuildStep {
        ...
        void step(TestConfigRecorder recorder, ConfigurationBuildItem configItem, TestMappingRunTime runtimeConfig) {
