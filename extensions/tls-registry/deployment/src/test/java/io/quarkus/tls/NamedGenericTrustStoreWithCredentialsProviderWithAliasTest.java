...
public class NamedGenericTrustStoreWithCredentialsProviderWithAliasTest {

    private static final String configuration = """
            quarkus.tls.foo.trust-store.pkcs12.path=target/certs/test-credentials-provider-alias-truststore.p12
            quarkus.tls.foo.trust-store.pkcs12.alias=my-alias
