...
@QuarkusTest
@TestProfile(SimpleGrpcWithTLSWithTrustAllWithCompressionTest.Profile.class)
public class SimpleGrpcWithTLSWithTrustAllWithCompressionTest extends AbstractExporterTest {

    public static class Profile implements QuarkusTestProfile {
        @Override
        public Map<String, String> getConfigOverrides() {
            return Map.of("quarkus.tls.trust-all", "true", "quarkus.otel.ssp.enabled", "true");
        }
