...
public interface AuthConfig {
    /**
     * If basic auth should be enabled. If both basic and form auth is enabled then basic auth will be enabled in silent
     * mode.
     * <p>
    ...
    /**
     * Propagate security identity to support its injection in Vert.x route handlers registered directly with the
     * router.
     */
    @WithDefault("false")
