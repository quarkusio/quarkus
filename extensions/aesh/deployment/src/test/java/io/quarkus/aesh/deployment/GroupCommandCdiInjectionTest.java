...
/**
 * Tests that CDI injection works in sub-commands of a {@code @CommandDefinition(groupCommands=...)}.
 * <p>
...
public class GroupCommandCdiInjectionTest {
    ...
    @CommandDefinition(name = "app", description = "App group", groupCommands = { GreetSub.class })
