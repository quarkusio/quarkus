...
class Methods {
    ...
    static final MethodDescriptor GET_HEADERS = MethodDescriptor.ofMethod(HttpServerResponse.class, "headers",
            MultiMap.class);
    static final MethodDescriptor MULTIMAP_GET = MethodDescriptor.ofMethod(MultiMap.class, "get", String.class,
            String.class);
    static final MethodDescriptor MULTIMAP_SET = MethodDescriptor.ofMethod(MultiMap.class, "set", MultiMap.class,
            String.class, String.class);
    static final MethodDescriptor MULTIMAP_GET_ALL = MethodDescriptor.ofMethod(MultiMap.class, "getAll", List.class,
            String.class);

    static final MethodDescriptor REQUEST = MethodDescriptor.ofMethod(RoutingContext.class, "request",
            HttpServerRequest.class);
    static final MethodDescriptor REQUEST_GET_PARAM = MethodDescriptor.ofMethod(HttpServerRequest.class, "getParam",
            String.class, String.class);
    static final MethodDescriptor REQUEST_GET_HEADER = MethodDescriptor.ofMethod(HttpServerRequest.class, "getHeader",
            String.class, String.class);
    static final MethodDescriptor GET_BODY = MethodDescriptor.ofMethod(RoutingContext.class, "getBody", Buffer.class);
    static final MethodDescriptor GET_BODY_AS_STRING = MethodDescriptor.ofMethod(RoutingContext.class,
            "getBodyAsString", String.class);
    static final MethodDescriptor GET_BODY_AS_JSON = MethodDescriptor.ofMethod(RoutingContext.class, "getBodyAsJson",
            JsonObject.class);
    static final MethodDescriptor GET_BODY_AS_JSON_ARRAY = MethodDescriptor.ofMethod(RoutingContext.class,
            "getBodyAsJsonArray", JsonArray.class);
    static final MethodDescriptor JSON_OBJECT_MAP_TO = MethodDescriptor.ofMethod(JsonObject.class, "mapTo",
            Object.class, Class.class);
    static final MethodDescriptor REQUEST_PARAMS = MethodDescriptor.ofMethod(HttpServerRequest.class, "params",
            MultiMap.class);
    static final MethodDescriptor REQUEST_HEADERS = MethodDescriptor.ofMethod(HttpServerRequest.class, "headers",
            MultiMap.class);
    static final MethodDescriptor RESPONSE = MethodDescriptor.ofMethod(RoutingContext.class, "response",
            HttpServerResponse.class);
    static final MethodDescriptor FAIL = MethodDescriptor.ofMethod(RoutingContext.class, "fail", Void.TYPE,
            Throwable.class);
    static final MethodDescriptor FAILURE = MethodDescriptor.ofMethod(RoutingContext.class, "failure", Throwable.class);
    static final MethodDescriptor NEXT = MethodDescriptor.ofMethod(RoutingContext.class, "next", void.class);

    static final MethodDescriptor UNI_SUBSCRIBE = MethodDescriptor.ofMethod(Uni.class, "subscribe", UniSubscribe.class);
    static final MethodDescriptor UNI_SUBSCRIBE_WITH = MethodDescriptor.ofMethod(UniSubscribe.class, "with",
    ...
    static final MethodDescriptor MULTI_SUBSCRIBE_STRING = MethodDescriptor.ofMethod(MultiSupport.class,
            "subscribeString", Void.TYPE, Multi.class, RoutingContext.class);
    static final MethodDescriptor MULTI_SUBSCRIBE_BUFFER = MethodDescriptor.ofMethod(MultiSupport.class,
    ...
    static final MethodDescriptor MULTI_SUBSCRIBE_OBJECT = MethodDescriptor.ofMethod(MultiSupport.class,
            "subscribeObject", Void.TYPE, Multi.class, RoutingContext.class);

    static final MethodDescriptor IS_SSE = MethodDescriptor.ofMethod(MultiSseSupport.class, "isSSE", Boolean.TYPE,
            Multi.class);
    ...
    static final MethodDescriptor IS_NDJSON = MethodDescriptor.ofMethod(MultiNdjsonSupport.class, "isNdjson",
    ...
    static final MethodDescriptor MULTI_JSON_SUBSCRIBE_BUFFER = MethodDescriptor.ofMethod(MultiJsonArraySupport.class,
            "subscribeBuffer", Void.TYPE, Multi.class, RoutingContext.class);
    static final MethodDescriptor MULTI_JSON_SUBSCRIBE_MUTINY_BUFFER = MethodDescriptor.ofMethod(
            MultiJsonArraySupport.class, "subscribeMutinyBuffer", Void.TYPE, Multi.class, RoutingContext.class);
    static final MethodDescriptor MULTI_JSON_SUBSCRIBE_OBJECT = MethodDescriptor.ofMethod(MultiJsonArraySupport.class,
            "subscribeObject", Void.TYPE, Multi.class, RoutingContext.class);
    static final MethodDescriptor MULTI_JSON_FAIL = MethodDescriptor.ofMethod(MultiJsonArraySupport.class, "fail",
            Void.TYPE, RoutingContext.class);

    static final MethodDescriptor END = MethodDescriptor.ofMethod(HttpServerResponse.class, "end", Future.class);
    static final MethodDescriptor END_WITH_STRING = MethodDescriptor.ofMethod(HttpServerResponse.class, "end",
            Future.class, String.class);
    static final MethodDescriptor END_WITH_BUFFER = MethodDescriptor.ofMethod(HttpServerResponse.class, "end",
            Future.class, Buffer.class);
    static final MethodDescriptor SET_STATUS = MethodDescriptor.ofMethod(HttpServerResponse.class, "setStatusCode",
    ...
    static final MethodDescriptor JSON_ENCODE = MethodDescriptor.ofMethod(Json.class, "encode", String.class,
            Object.class);
    ...
    static final MethodDescriptor CONTEXT_GET = MethodDescriptor.ofMethod(Context.class, "get", Object.class,
            Contextual.class, CreationalContext.class);
    static final MethodDescriptor CONTEXT_GET_IF_PRESENT = MethodDescriptor.ofMethod(Context.class, "get", Object.class,
            Contextual.class);
    static final MethodDescriptor INJECTABLE_REF_PROVIDER_GET = MethodDescriptor
            .ofMethod(InjectableReferenceProvider.class, "get", Object.class, CreationalContext.class);
    ...
    static final MethodDescriptor ROUTE_HANDLERS_SET_CONTENT_TYPE = MethodDescriptor.ofMethod(RouteHandlers.class,
            "setContentType", void.class, RoutingContext.class, String.class);

    static final MethodDescriptor OPTIONAL_OF_NULLABLE = MethodDescriptor.ofMethod(Optional.class, "ofNullable",
    ...
    static final MethodDescriptor VALIDATION_GET_VALIDATOR = MethodDescriptor.ofMethod(ValidationSupport.class,
            "getValidator", "jakarta.validation.Validator", ArcContainer.class);
    static final MethodDescriptor VALIDATION_MAP_VIOLATIONS_TO_JSON = MethodDescriptor.ofMethod(ValidationSupport.class,
            "mapViolationsToJson", String.class, Set.class, HttpServerResponse.class);
    static final MethodDescriptor VALIDATION_HANDLE_VIOLATION_EXCEPTION = MethodDescriptor.ofMethod(
            ValidationSupport.class.getName(), "handleViolationException", Void.TYPE.getName(),
            Methods.VALIDATION_CONSTRAINT_VIOLATION_EXCEPTION, RoutingContext.class.getName(), Boolean.TYPE.getName());

    static final MethodDescriptor VALIDATOR_VALIDATE = MethodDescriptor.ofMethod("jakarta.validation.Validator",
            "validate", "java.util.Set", Object.class, Class[].class);
    ...
    static final MethodDescriptor INTEGER_VALUE_OF = MethodDescriptor.ofMethod(Integer.class, "valueOf", Integer.class,
            String.class);
    static final MethodDescriptor LONG_VALUE_OF = MethodDescriptor.ofMethod(Long.class, "valueOf", Long.class,
            String.class);
    static final MethodDescriptor BOOLEAN_VALUE_OF = MethodDescriptor.ofMethod(Boolean.class, "valueOf", Boolean.class,
            String.class);
    static final MethodDescriptor CHARACTER_VALUE_OF = MethodDescriptor.ofMethod(Character.class, "valueOf",
            Character.class, char.class);
    static final MethodDescriptor FLOAT_VALUE_OF = MethodDescriptor.ofMethod(Float.class, "valueOf", Float.class,
            String.class);
    static final MethodDescriptor DOUBLE_VALUE_OF = MethodDescriptor.ofMethod(Double.class, "valueOf", Double.class,
            String.class);
    static final MethodDescriptor SHORT_VALUE_OF = MethodDescriptor.ofMethod(Short.class, "valueOf", Short.class,
            String.class);
    static final MethodDescriptor BYTE_VALUE_OF = MethodDescriptor.ofMethod(Byte.class, "valueOf", Byte.class,
            String.class);

    static final MethodDescriptor COLLECTION_SIZE = MethodDescriptor.ofMethod(Collection.class, "size", int.class);
    static final MethodDescriptor COLLECTION_ITERATOR = MethodDescriptor.ofMethod(Collection.class, "iterator",
            Iterator.class);
    ...
    static final MethodDescriptor ITERATOR_HAS_NEXT = MethodDescriptor.ofMethod(Iterator.class, "hasNext",
            boolean.class);
    ...
    static boolean isNoContent(HandlerDescriptor descriptor) {
        return descriptor.getPayloadType().name().equals(DotName.createSimple(Void.class.getName()));
    }

    static ResultHandle createNpeBecauseItemIfNull(BytecodeCreator writer) {
        return writer.newInstance(MethodDescriptor.ofConstructor(NullPointerException.class, String.class),
    ...
    public static ResultHandle validateProducedItem(ResultHandle response, BytecodeCreator writer, ResultHandle res,
        ...
        ResultHandle violations = writer.invokeInterfaceMethod(VALIDATOR_VALIDATE, validator, res,
                writer.newArray(Class.class, 0));
        ...
        ResultHandle json = ifNoViolations.falseBranch().invokeStaticMethod(VALIDATION_MAP_VIOLATIONS_TO_JSON,
                violations, response);
