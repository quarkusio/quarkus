...
public class KeycloakRealmClientCredentialsJwtPrivateKeyManager implements QuarkusTestResourceLifecycleManager {
    private static final String KEYCLOAK_SERVER_URL = System.getProperty("keycloak.url", "http://localhost:8180/auth");
    private static final String KEYCLOAK_REALM = "quarkus5";
    ...
    private static ClientRepresentation createClient(String clientId) throws Exception {
        ...
        String privateKey = KeyUtils.removePemKeyBeginEnd(ResourceUtils.readResource("/privateKey.pem"));
        String publicKey = KeyUtils.removePemKeyBeginEnd(ResourceUtils.readResource("/publicKey.pem"));
        Map<String, String> attributes = new HashMap<String, String>();
        attributes.put("jwt.credential.public.key", publicKey);
