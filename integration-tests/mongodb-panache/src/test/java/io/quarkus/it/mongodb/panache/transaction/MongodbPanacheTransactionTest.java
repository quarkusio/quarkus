...
public class MongodbPanacheTransactionTest {
    ...
    public void testImperativeTransaction() {
        callTheEndpoint("/transaction/imperative");
    }

    @Test
    public void testReactiveTransaction() {
        callTheEndpoint("/transaction/reactive");
    }
    ...
    private void callTheEndpoint(String endpoint) {
        ...
        // This will try to inside twi time Charles Baudelaire and failed.
        // As we are in a transaction none will be saved.
