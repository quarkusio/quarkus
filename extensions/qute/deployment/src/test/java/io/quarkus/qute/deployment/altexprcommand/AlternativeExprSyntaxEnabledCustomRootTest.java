...
public class AlternativeExprSyntaxEnabledCustomRootTest {

    @RegisterExtension
    static final QuarkusUnitTest config = new QuarkusUnitTest()
            .withApplicationRoot(root -> root
                    .addAsResource(new StringAsset("{foo.toLowerCase}{=ignored}"), "templates/testik.html")
                    // This config file is completely ignored
                    .addAsResource(new StringAsset("alt-expr-syntax=true"), "web/public/.qute")
                    .addAsResource(new StringAsset("{foo.toLowerCase}{=ignored}"), "web/public/testik2.html"))
            .overrideConfigKey("quarkus.qute.alt-expr-syntax", "false")
