...
import io.quarkus.agroal.deployment.DataSourceDefinitionBuildItem;
...
public class JDBCMySQLProcessor {
    ...
    void disableBuiltInOpenTelemetry(BuildProducer<JdbcPropertyBuildItem> properties,
            List<DataSourceDefinitionBuildItem> datasources,
            Capabilities capabilities) {
        ...
        for (DataSourceDefinitionBuildItem ds : datasources) {
