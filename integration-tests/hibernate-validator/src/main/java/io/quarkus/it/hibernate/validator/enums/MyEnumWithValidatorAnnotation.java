...
/**
 * Simply adding this class to the code, without even referencing it from anywhere, used to make Quarkus startup fail
 * because of an error in Hibernate Validator. See https://github.com/quarkusio/quarkus/issues/3284
 */
