...
include::{generated-dir}/quarkus-smallrye-openapi.adoc[opts=optional, leveloffset=+1]

=== Swagger UI

include::{generated-dir}/quarkus-swaggerui.adoc[opts=optional, leveloffset=+1]
