...
include::{generated-config-doc-dir}/quarkus-logging-json.adoc[opts=optional, leveloffset=+1]
...
include::{generated-config-doc-dir}/quarkus-core_quarkus.log.adoc[opts=optional, leveloffset=+1]
