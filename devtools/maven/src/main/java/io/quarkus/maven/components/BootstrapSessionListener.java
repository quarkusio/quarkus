...
public class BootstrapSessionListener extends AbstractMavenLifecycleParticipant {
    ...
    private static final String INJECTED_JVM_PROPERTIES = "--add-opens=java.base/java.lang.invoke=ALL-UNNAMED --add-opens=java.base/java.lang=ALL-UNNAMED --add-exports=java.base/jdk.internal.module=ALL-UNNAMED ";
    ...
    private void injectArgsForPlugin(MavenProject project, String pluginArtifactId) {
        ...
        final String newValue = (INJECTED_JVM_PROPERTIES + userDefinedArgLine).trim();
