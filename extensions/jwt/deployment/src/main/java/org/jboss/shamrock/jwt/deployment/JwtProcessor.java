...
class JwtProcessor {
    ...
    AuthConfigBuildItem configureFileRealmAuthConfig(JwtTemplate template,
    ...
    @BuildStep
    @Record(ExecutionTime.STATIC_INIT)
    ServletExtensionBuildItem registerJwtAuthExtension(JwtTemplate template, BeanContainerBuildItem container) {
