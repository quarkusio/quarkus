...
if you stray off this path. In particular, the guide assumes the invocation of `mvn plugin:version:goal` without having `pom.xml`
in directory in advance, become stable https://maven.apache.org/docs/3.9.0/release-notes.html[only in Maven 3.9].
====
