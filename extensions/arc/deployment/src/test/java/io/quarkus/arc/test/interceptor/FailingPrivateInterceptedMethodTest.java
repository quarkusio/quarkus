...
public class FailingPrivateInterceptedMethodTest {
    ...
    static final QuarkusUnitTest config = new QuarkusUnitTest()
            ...
            .assertException(e -> assertThat(e).isInstanceOf(DeploymentException.class).hasMessageContainingAll(
                    "@Simple will have no effect on method " + SimpleBean.class.getName() + ".foo",
