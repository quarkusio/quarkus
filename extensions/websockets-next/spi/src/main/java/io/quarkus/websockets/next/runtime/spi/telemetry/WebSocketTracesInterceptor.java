...
public interface WebSocketTracesInterceptor {
     ...
     */
    Map<String, Object> onConnectionOpened(String path, EndpointKind endpointKind);
     ...
     */
    void onConnectionOpeningFailed(Throwable cause, String path, EndpointKind endpointKind,
