...
assert execWithSystemLogging("docker", "images", group + "/container-native-main")
assert execWithSystemLogging("docker", "rmi", group + "/container-native-main:0.1-SNAPSHOT")
