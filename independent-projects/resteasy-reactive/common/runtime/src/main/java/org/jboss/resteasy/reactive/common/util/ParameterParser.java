...
/**
 * A simple parser intended to parse sequences of name/value pairs. Parameter values are exptected to be enclosed in
...
public class ParameterParser {
     ...
     *
     * @return <code>true</code> if the character is present in the array of characters, <code>false</code> otherwise.
     */
     ...
     *
     * @param terminators
     *        the array of terminating characters. Any of these characters when encountered signify the end of the
     *        token
     *
     * @return the token
     */
     ...
     *
     * @param terminators
     *        the array of terminating characters. Any of these characters when encountered outside the quotation
     *        marks signify the end of the token
     *
     * @return the token
     */
    ...
    /**
     * Returns <code>true</code> if parameter names are to be converted to lower case when name/value pairs are parsed.
     *
     * @return <code>true</code> if parameter names are to be converted to lower case when name/value pairs are parsed.
     ...
     *
     * @param b
     *        <code>true</code> if parameter names are to be converted to lower case when name/value pairs are
