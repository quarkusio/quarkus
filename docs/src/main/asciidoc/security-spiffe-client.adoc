...
Next, adjust your application configuration to enable the SPIFFE feature in Keycloak Dev Services and align the communication ports:

[source,properties]
----
quarkus.spiffe-client.devservices.http-port=18443
quarkus.keycloak.devservices.host-accessible-ports=18443
