...
/**
 * This build item is used to exclude template files found in template roots. Excluded templates are neither parsed nor
 * validated during build and are not available at runtime.
 * <p>
