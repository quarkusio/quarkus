...
Additionally, setting  the `quarkus.kubernetes-config.secrets-role-config.prefix-name` property to `true` will instruct the extension to prefix the role name with the application name (e.g. `my-app-view-secrets`).
