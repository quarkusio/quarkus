...
public class ReloadOtherKeyStoreWithFactoryTest {
    ...
    private static final String configuration = """
            quarkus.tls.key-store.other.type=test-reload
            """;

    @RegisterExtension
    static final QuarkusExtensionTest config = new QuarkusExtensionTest().setArchiveProducer(
            () -> ShrinkWrap.create(JavaArchive.class)
                    .addClass(ReloadableKeyStoreFactory.class)
    ...
    void testReloading() throws CertificateParsingException, KeyStoreException {
        ...
        assertThat(ReloadableKeyStoreFactory.invocationCount.get()).isEqualTo(1);
        X509Certificate certificate = (X509Certificate) def.getKeyStore().getCertificate("test-reload-A");
        ...
        ReloadableKeyStoreFactory.useCertB = true;
        assertThat(def.reload()).isTrue();
        assertThat(ReloadableKeyStoreFactory.invocationCount.get()).isEqualTo(2);
    ...
    public static class ReloadableKeyStoreFactory implements KeyStoreFactory {
        ...
        public KeyStoreAndKeyCertOptions createKeyStore(OtherKeyStoreConfiguration config, Vertx vertx, String name) {
            ...
            String path = "target/certs/test-reload-" + suffix + "-keystore.p12";
            try {
