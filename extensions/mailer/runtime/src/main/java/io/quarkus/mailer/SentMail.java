...
/**
 * Represents a sent mail. Instances of this class are sent using CDI events.
 *
 * @param from
 *        the sender address
 * @param to
 ...
 *        the attachments
 */
public record SentMail(String from, List<String> to, List<String> cc, List<String> bcc, String replyTo,
        String bounceAddress, String subject, String textBody, String htmlBody, Map<String, List<String>> headers,
