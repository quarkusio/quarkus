...
class DevServicesConfigBuildStep {
    ...
    DevServicesLauncherConfigResultBuildItem setup(BuildProducer<RunTimeConfigurationDefaultBuildItem> runtimeConfig,
        ...
        PreviousDevServicesConfig previousConfig = liveReloadBuildItem.getContextObject(PreviousDevServicesConfig.class);
        ...
        liveReloadBuildItem.setContextObject(PreviousDevServicesConfig.class, new PreviousDevServicesConfig(newProperties));
