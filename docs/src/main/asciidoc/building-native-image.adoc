...
[TIP]
====
To load the sources in `gdb`, run:

[source,shell]
----
directory target/{project.name}-{project.version}-native-image-source-jar
----
...
[source,shell]
----
gdb -ex 'directory target/{project.name}-{project.version}-native-image-source-jar' target/{project.name}-{project.version}-runner
----

e.g.,
[source,shell]
----
gdb -ex 'directory target/getting-started-1.0-SNAPSHOT-native-image-source-jar' target/getting-started-1.0-SNAPSHOT-runner
----
====
