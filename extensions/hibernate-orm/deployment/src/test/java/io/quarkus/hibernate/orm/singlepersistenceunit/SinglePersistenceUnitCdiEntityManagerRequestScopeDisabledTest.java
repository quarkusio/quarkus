...
public class SinglePersistenceUnitCdiEntityManagerRequestScopeDisabledTest {
    ...
    public void inRequestNoTransaction() {
        ...
        assertThatThrownBy(() -> entityManager.createQuery("select count(*) from DefaultEntity"))
