...
public interface BlockingDataQuery<Entity>
        extends DataQuery<BlockingDataQuery<Entity>, Entity, Entity, List<Entity>, BlockingDataQuery<Entity>, Boolean, Long> {

    @Override
    BlockingDataQuery<Entity> sort(Order<? super Entity> order);

    @Override
    default BlockingDataQuery<Entity> sort(Sort<? super Entity> sort) {
     ...
     */
    public <T> BlockingDataQuery<T> project(Class<T> type);
