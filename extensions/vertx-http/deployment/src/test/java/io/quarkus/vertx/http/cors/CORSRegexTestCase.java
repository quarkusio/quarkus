...
public class CORSRegexTestCase {
    ...
    public void corsRegexValidOrigin2Test() {
        given().header("Origin", "https://abc-123.app.mydomain.com").when().get("/test").then().statusCode(200)
    ...
    public void corsRegexInvalidOriginTest() {
        given().header("Origin", "https://asdfdomain.com").when().get("/test").then().statusCode(403)
    ...
    public void corsRegexInvalidOrigin2Test() {
        given().header("Origin", "https://abc-123app.mydomain.com").when().get("/test").then().statusCode(403)
                .header("Access-Control-Allow-Origin", nullValue())
                .header("Access-Control-Allow-Credentials", nullValue());
    }
}
