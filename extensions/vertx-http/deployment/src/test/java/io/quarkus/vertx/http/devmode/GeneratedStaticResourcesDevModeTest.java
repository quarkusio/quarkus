...
public class GeneratedStaticResourcesDevModeTest {
    ...
    @RegisterExtension
    final static QuarkusDevModeTest devMode = new QuarkusDevModeTest().withApplicationRoot(
    ...
    void shouldUpdateResourceIndexHtmlOnUserChange() {
        RestAssured.given().get("/bytes/").then().statusCode(200)
    ...
    void shouldUpdateHiddenResourceOnUserChange() {
        RestAssured.given().get("/bytes/.hidden-file.html").then().statusCode(200)
                .body(Matchers.containsString("This is the title of the webpage!"));
    ...
    void shouldUpdateFileResourceIndexHtmlOnUserChange() {
        ...
        devMode.modifyResourceFile("META-INF/generated-resources-test/index.html",
                s -> s.replace("webpage", "Matheus"));
    ...
    void shouldUpdateHiddenFileResourceOnUserChange() {
        RestAssured.given().get("/.hidden-file.html").then().statusCode(200)
                .body(Matchers.containsString("This is the title of the webpage!"));
