...
import io.quarkus.qrs.test.resource.basic.resource.ResourceLocatorAbstractAnnotationFreeResouce;
import io.quarkus.qrs.test.resource.basic.resource.ResourceLocatorAnnotationFreeSubResource;
import io.quarkus.qrs.test.resource.basic.resource.ResourceLocatorBaseResource;
import io.quarkus.qrs.test.resource.basic.resource.ResourceLocatorCollectionResource;
import io.quarkus.qrs.test.resource.basic.resource.ResourceLocatorDirectory;
import io.quarkus.qrs.test.resource.basic.resource.ResourceLocatorQueueReceiver;
import io.quarkus.qrs.test.resource.basic.resource.ResourceLocatorReceiver;
import io.quarkus.qrs.test.resource.basic.resource.ResourceLocatorRootInterface;
import io.quarkus.qrs.test.resource.basic.resource.ResourceLocatorSubInterface;
import io.quarkus.qrs.test.resource.basic.resource.ResourceLocatorSubresource;
import io.quarkus.qrs.test.resource.basic.resource.ResourceLocatorSubresource2;
import io.quarkus.qrs.test.resource.basic.resource.ResourceLocatorSubresource3;
import io.quarkus.qrs.test.resource.basic.resource.ResourceLocatorSubresource3Interface;
