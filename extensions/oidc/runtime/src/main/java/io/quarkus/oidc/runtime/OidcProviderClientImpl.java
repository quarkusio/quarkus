...
public class OidcProviderClientImpl implements OidcProviderClient, Closeable {
    ...
    static Uni<OidcProviderClientImpl> of(OidcWebClient client, Vertx vertx,
        ...
        AttestationKeyRegistry attestationKeyRegistry = OidcUtils.initAttestationJwtContext(oidcConfig);
        if (attestationKeyRegistry != null) {
            ...
            if (attesters.size() == 1) {
                ...
                clientAttester = new DefaultClientAttester(attestationKeyRegistry, oidcConfig.tenantId().get());
            }
