...
public final class OutputTargetBuildItem extends SimpleBuildItem {
     ...
     * @param buildSystemProperties
     *        build system properties
     * @param includedOptionalDependencies
     *        included optional dependencies
     */
    @Deprecated(forRemoval = true)
    public OutputTargetBuildItem(Path outputDirectory, String baseName, boolean rebuild,
            Properties buildSystemProperties, Optional<Set<ArtifactKey>> includedOptionalDependencies) {
    ...
    /**
     * The base name (not including the extension) of the original JAR generated by the build system. This name could be
     * different from the value of {@link #getBaseName()}, which will be used for the Quarkus runner file.
     *
