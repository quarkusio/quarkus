...
/**
 * Verifies the aesh SSH extension builds correctly when CLI commands are present.
 * <p>
...
public class AeshSshBuildTest {
    ...
    static final QuarkusUnitTest config = new QuarkusUnitTest()
            ...
            .overrideConfigKey("quarkus.aesh.ssh.port", "12224");

    @Test
    public void testSshExtensionBuilds() {
        // If we get here, augmentation succeeded: the SSH extension registered
        // SshServerLifecycle and the core AeshProcessor set up console mode.
