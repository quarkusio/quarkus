 ...
 * unless the {@code quarkus-junit-mockito} is present.
 */
public class VerifyMockitoMocksCallback implements QuarkusTestAfterConstructCallback {
    ...
    public void afterConstruct(Object testInstance) {
        ...
        if (mockitoConfig == null) { // this means that the quarkus-junit-mockito dependency was not added
            ...
            if (!injectMockFields.isEmpty()) {
                throw new IllegalStateException(
                        "@io.quarkus.test.InjectMock declared on one or more fields of a @QuarkusTest but the quarkus-junit-mockito dependency is not present: "
