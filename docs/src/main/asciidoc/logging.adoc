...
=== None of the configuration properties seems to have any effect

You will most likely see two separate log lines in your output:
----
Mar 14, 2020 12:47:37 PM com.mongodb.diagnostics.logging.SLF4JLogger info
INFO: Opened connection [connectionId{localValue:4, serverValue:236}] to 127.0.0.1:27017
----

This is usually because you have some agent or something which has initialized logging too early. If that's the case, the workaround is to use the following settings.

For unit tests in your IDE:
[source]
----
-Djava.util.logging.manager=org.jboss.logmanager.LogManager
----

For your Maven configuration:
[source,xml]
----
<plugin>
...
----
(The same applies for the Maven failsafe plugin)
