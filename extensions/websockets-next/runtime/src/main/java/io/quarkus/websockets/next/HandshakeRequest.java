...
public interface HandshakeRequest {
    ...
    /**
     *
     * @return the local IP address for this connection, or {@code null} if not available
     */
    String localAddress();

    /**
     * @return the remote IP address for this connection, or {@code null} if not available
     */
