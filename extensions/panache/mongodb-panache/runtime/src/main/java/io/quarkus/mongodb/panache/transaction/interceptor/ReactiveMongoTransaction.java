...
public class ReactiveMongoTransaction implements Transaction {
    ...
    public void commit() throws RollbackException, HeuristicMixedException, HeuristicRollbackException, SecurityException,
        ...
        try {
            Uni.createFrom().publisher(this.clientSession.commitTransaction()).await().indefinitely();//FIXME we block here
        } finally {
    ...
    public void rollback() throws IllegalStateException, SystemException {
        ...
        try {
            Uni.createFrom().publisher(this.clientSession.abortTransaction()).await().indefinitely();//FIXME we block here
        } finally {
            this.clientSession.close();
        }
