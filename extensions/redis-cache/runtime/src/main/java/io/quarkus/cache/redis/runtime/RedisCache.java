...
public interface RedisCache extends Cache {
    ...
    /**
     * When configured, gets the default type of the value stored in the cache. The configured type is used in methods
     * {@link #get(Object, Function)}, {@link #getAsync(Object, Function)}, {@link #getOrDefault(Object, Object)} and
     * {@link #getOrNull(Object)}.
     *
     ...
     * @param valueLoader
     *        the value loader called when there is no value stored in the cache
     * @param <K>
     *        the type of key
     * @param <V>
     *        the type of value
    ...
    /**
     * Returns {@link Uni} that completes with a value present in the cache under the given {@code key}. If there is no
     * value in the cache under the key, the {@code Uni} completes with the given {@code defaultValue}.
     *
     * @param key
     *        the key
     * @param defaultValue
    ...
    /**
     * Returns {@link Uni} that completes with a value present in the cache under the given {@code key}. If there is no
     * value in the cache under the key, the {@code Uni} completes with {@code null}.
     *
     * @param key
     *        the key
     * @param <K>
