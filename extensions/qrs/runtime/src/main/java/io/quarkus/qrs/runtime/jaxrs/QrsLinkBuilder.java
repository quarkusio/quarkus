 ...
 */
public class QrsLinkBuilder implements Link.Builder {
    /**
    ...
    public Link build(Object... values) throws UriBuilderException {
        ...
        return new QrsLink(built, this.map);
    }
    ...
    public Link buildRelativized(URI uri, Object... values) {
        ...
        return new QrsLink(uri.relativize(with), this.map);
    }
