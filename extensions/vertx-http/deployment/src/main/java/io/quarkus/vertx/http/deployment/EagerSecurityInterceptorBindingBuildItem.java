 ...
 * For example, the Vert.x HTTP extension registers {@link io.quarkus.vertx.http.runtime.security.HttpAuthMechanism}
 * and an interceptor that sets annotation value ('@HttpAuthMechanism("basic") => 'basic') as routing context attribute.
