...
public class ExceptionHandlerGenerator implements Generator {
    ...
    public ExceptionHandlerGenerator(String template, FileGenerator fileGenerator, MavenProject mavenProject) {
    ...
    private Model convertToModel() {
        return new Model("ExceptionHandler", mavenProject.getGroupId());
    }
}
