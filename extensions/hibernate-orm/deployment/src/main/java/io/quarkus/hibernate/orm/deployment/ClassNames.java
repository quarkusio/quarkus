...
public final class ClassNames {
    ...
    public static final DotName TENANT_RESOLVER = createConstant(
    ...
    public static final DotName STATEMENT_INSPECTOR = createConstant(
    ...
    public static final List<DotName> GENERATORS = List.of(createConstant("org.hibernate.generator.Assigned"),
            ...
            createConstant("org.hibernate.id.ForeignGenerator"), createConstant("org.hibernate.id.GUIDGenerator"),
            createConstant("org.hibernate.id.IdentityGenerator"), createConstant("org.hibernate.id.IncrementGenerator"),
            createConstant("org.hibernate.id.NativeGenerator"), createConstant("org.hibernate.id.SelectGenerator"),
            createConstant("org.hibernate.id.UUIDGenerator"), createConstant("org.hibernate.id.UUIDHexGenerator"),
    ...
    public static final List<DotName> OPTIMIZERS = List.of(createConstant("org.hibernate.id.enhanced.HiLoOptimizer"),
    ...
    public static final List<DotName> PACKAGE_ANNOTATIONS = List.of(
            ...
            createConstant("jakarta.persistence.TableGenerator"), createConstant("jakarta.persistence.TableGenerators"),
    ...
    public static final List<DotName> JPA_MAPPING_ANNOTATIONS = List.of(createConstant("jakarta.persistence.Access"),
            ...
            createConstant("jakarta.persistence.AttributeOverrides"), createConstant("jakarta.persistence.Basic"),
            createConstant("jakarta.persistence.Cacheable"), createConstant("jakarta.persistence.CheckConstraint"),
            createConstant("jakarta.persistence.CollectionTable"), createConstant("jakarta.persistence.Column"),
            createConstant("jakarta.persistence.ColumnResult"), createConstant("jakarta.persistence.ConstructorResult"),
            createConstant("jakarta.persistence.Convert"), createConstant("jakarta.persistence.Converter"),
            createConstant("jakarta.persistence.Converts"), createConstant("jakarta.persistence.DiscriminatorColumn"),
            createConstant("jakarta.persistence.DiscriminatorValue"),
            createConstant("jakarta.persistence.ElementCollection"), createConstant("jakarta.persistence.Embeddable"),
            createConstant("jakarta.persistence.Embedded"), createConstant("jakarta.persistence.EmbeddedId"),
            createConstant("jakarta.persistence.EnumeratedValue"), createConstant("jakarta.persistence.Entity"),
            createConstant("jakarta.persistence.EntityListeners"), createConstant("jakarta.persistence.EntityResult"),
            ...
            createConstant("jakarta.persistence.FieldResult"), createConstant("jakarta.persistence.ForeignKey"),
            createConstant("jakarta.persistence.GeneratedValue"), createConstant("jakarta.persistence.Id"),
            createConstant("jakarta.persistence.IdClass"), createConstant("jakarta.persistence.Index"),
            createConstant("jakarta.persistence.Inheritance"), createConstant("jakarta.persistence.JoinColumn"),
            createConstant("jakarta.persistence.JoinColumns"), createConstant("jakarta.persistence.JoinTable"),
            createConstant("jakarta.persistence.Lob"), createConstant("jakarta.persistence.ManyToMany"),
            createConstant("jakarta.persistence.ManyToOne"), createConstant("jakarta.persistence.MapKey"),
            createConstant("jakarta.persistence.MapKeyClass"), createConstant("jakarta.persistence.MapKeyColumn"),
            ...
            createConstant("jakarta.persistence.MappedSuperclass"), createConstant("jakarta.persistence.MapsId"),
            ...
            createConstant("jakarta.persistence.NamedNativeQuery"), createConstant("jakarta.persistence.NamedQueries"),
            ...
            createConstant("jakarta.persistence.NamedSubgraph"), createConstant("jakarta.persistence.OneToMany"),
            createConstant("jakarta.persistence.OneToOne"), createConstant("jakarta.persistence.OrderBy"),
            createConstant("jakarta.persistence.OrderColumn"), createConstant("jakarta.persistence.PersistenceContext"),
            ...
            createConstant("jakarta.persistence.PersistenceUnits"), createConstant("jakarta.persistence.PostLoad"),
            createConstant("jakarta.persistence.PostPersist"), createConstant("jakarta.persistence.PostRemove"),
            createConstant("jakarta.persistence.PostUpdate"), createConstant("jakarta.persistence.PrePersist"),
            createConstant("jakarta.persistence.PreRemove"), createConstant("jakarta.persistence.PreUpdate"),
            createConstant("jakarta.persistence.PrimaryKeyJoinColumn"),
            createConstant("jakarta.persistence.PrimaryKeyJoinColumns"),
            createConstant("jakarta.persistence.QueryHint"), createConstant("jakarta.persistence.SecondaryTable"),
            ...
            createConstant("jakarta.persistence.StoredProcedureParameter"), createConstant("jakarta.persistence.Table"),
            createConstant("jakarta.persistence.TableGenerator"), createConstant("jakarta.persistence.TableGenerators"),
            createConstant("jakarta.persistence.Temporal"), createConstant("jakarta.persistence.Transient"),
            createConstant("jakarta.persistence.UniqueConstraint"), createConstant("jakarta.persistence.Version"));
    ...
    public static final List<DotName> HIBERNATE_MAPPING_ANNOTATIONS = List.of(
            ...
            createConstant("org.hibernate.annotations.Bag"), createConstant("org.hibernate.annotations.BatchSize"),
            createConstant("org.hibernate.annotations.Cache"), createConstant("org.hibernate.annotations.Cascade"),
            createConstant("org.hibernate.annotations.Check"), createConstant("org.hibernate.annotations.Checks"),
            ...
            createConstant("org.hibernate.annotations.Columns"), createConstant("org.hibernate.annotations.Comment"),
            ...
            createConstant("org.hibernate.annotations.EmbeddableInstantiatorRegistration"),
            createConstant("org.hibernate.annotations.EmbeddableInstantiatorRegistrations"),
            createConstant("org.hibernate.annotations.Fetch"), createConstant("org.hibernate.annotations.FetchProfile"),
            createConstant("org.hibernate.annotations.FetchProfile$FetchOverride"),
            ...
            createConstant("org.hibernate.annotations.FetchProfiles"),
            createConstant("org.hibernate.annotations.Filter"), createConstant("org.hibernate.annotations.FilterDef"),
            createConstant("org.hibernate.annotations.FilterDefs"),
            createConstant("org.hibernate.annotations.FilterJoinTable"),
            createConstant("org.hibernate.annotations.FilterJoinTables"),
            createConstant("org.hibernate.annotations.Filters"), createConstant("org.hibernate.annotations.Formula"),
            ...
            createConstant("org.hibernate.annotations.Immutable"), createConstant("org.hibernate.annotations.Imported"),
            ...
            createConstant("org.hibernate.annotations.NotFound"), createConstant("org.hibernate.annotations.OnDelete"),
            createConstant("org.hibernate.annotations.OptimisticLock"),
            createConstant("org.hibernate.annotations.OptimisticLocking"),
            createConstant("org.hibernate.annotations.ParamDef"), createConstant("org.hibernate.annotations.Parameter"),
            ...
            createConstant("org.hibernate.annotations.RowId"), createConstant("org.hibernate.annotations.SQLDelete"),
            ...
            createConstant("org.hibernate.annotations.SortNatural"), createConstant("org.hibernate.annotations.Source"),
            createConstant("org.hibernate.annotations.SqlFragmentAlias"),
            createConstant("org.hibernate.annotations.Struct"), createConstant("org.hibernate.annotations.Subselect"),
    ...
    public static final List<DotName> ANNOTATED_WITH_INJECT_SERVICE = List
            .of(createConstant("org.hibernate.engine.jdbc.connections.internal.DatasourceConnectionProviderImpl"));

    public static final List<DotName> JPA_LISTENER_ANNOTATIONS = List.of(createConstant("jakarta.persistence.PostLoad"),
            createConstant("jakarta.persistence.PostPersist"), createConstant("jakarta.persistence.PostRemove"),
            createConstant("jakarta.persistence.PostUpdate"), createConstant("jakarta.persistence.PrePersist"),
            createConstant("jakarta.persistence.PreRemove"), createConstant("jakarta.persistence.PreUpdate"));

    public static final List<DotName> JDBC_JAVA_TYPES = List.of(createConstant("java.lang.Boolean"),
            createConstant("java.lang.Byte"), createConstant("java.lang.Character"), createConstant("java.lang.Class"),
            createConstant("java.lang.Double"), createConstant("java.lang.Float"), createConstant("java.lang.Integer"),
            createConstant("java.lang.Long"), createConstant("java.lang.Object"), createConstant("java.lang.Short"),
            createConstant("java.lang.String"), createConstant("java.math.BigDecimal"),
            createConstant("java.math.BigInteger"), createConstant("java.net.InetAddress"),
            createConstant("java.net.URL"), createConstant("java.sql.Blob"), createConstant("java.sql.Clob"),
            createConstant("java.sql.NClob"), createConstant("java.time.Duration"), createConstant("java.time.Instant"),
            createConstant("java.time.LocalDate"), createConstant("java.time.LocalDateTime"),
            createConstant("java.time.LocalTime"), createConstant("java.time.OffsetDateTime"),
            createConstant("java.time.OffsetTime"), createConstant("java.time.Year"),
            createConstant("java.time.ZoneId"), createConstant("java.time.ZoneOffset"),
            createConstant("java.time.ZonedDateTime"), createConstant("java.util.Calendar"),
            createConstant("java.util.Currency"), createConstant("java.util.Date"), createConstant("java.util.Locale"),
            createConstant("java.util.Map$Entry"), createConstant("java.util.TimeZone"),
            createConstant("java.util.UUID"), createConstant("java.lang.Void"));
    ...
    public static final DotName GRAAL_VM_FEATURES = createConstant(
            "io.quarkus.hibernate.orm.deployment.GraalVMFeatures");
