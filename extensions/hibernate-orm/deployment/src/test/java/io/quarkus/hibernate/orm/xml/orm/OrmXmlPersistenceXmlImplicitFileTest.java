...
/**
 * Test that the implicit mapping file META-INF/orm.xml is taken into account for persistence units configured through
 * persistence.xml, even if it is not mentioned in the persistence.xml.
 */
