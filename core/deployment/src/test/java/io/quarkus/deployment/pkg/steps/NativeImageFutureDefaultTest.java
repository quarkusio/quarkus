...
class NativeImageFutureDefaultTest {
    ...
    void runtimeInitFSandSecurityProvidersWithFutureDefaultsAll(String param) {
        List<String> futureDefaultsAll = List.of("--future-defaults=" + param);
        TestNativeConfig testNativeConfig = new TestNativeConfig(futureDefaultsAll, null);
        ...
        testNativeConfig = new TestNativeConfig(null, futureDefaultsAll);
        assertThat(RUN_TIME_INITIALIZE_SECURITY_PROVIDERS.isEnabled(testNativeConfig)).isTrue();
        assertThat(RUN_TIME_INITIALIZE_FILE_SYSTEM_PROVIDERS.isEnabled(testNativeConfig)).isTrue();
        testNativeConfig = new TestNativeConfig(futureDefaultsAll, futureDefaultsAll);
        assertThat(RUN_TIME_INITIALIZE_SECURITY_PROVIDERS.isEnabled(testNativeConfig)).isTrue();
        assertThat(RUN_TIME_INITIALIZE_FILE_SYSTEM_PROVIDERS.isEnabled(testNativeConfig)).isTrue();
    }
    ...
    void runtimeInitFSandSecurityProvidersWithOtherFutureDefaults(String param) {
        List<String> futureDefaultsNone = List.of("--future-defaults=" + param);
        TestNativeConfig testNativeConfig = new TestNativeConfig(futureDefaultsNone, null);
        assertThat(RUN_TIME_INITIALIZE_SECURITY_PROVIDERS.isEnabled(testNativeConfig)).isFalse();
        assertThat(RUN_TIME_INITIALIZE_FILE_SYSTEM_PROVIDERS.isEnabled(testNativeConfig)).isFalse();
        testNativeConfig = new TestNativeConfig(null, futureDefaultsNone);
        assertThat(RUN_TIME_INITIALIZE_SECURITY_PROVIDERS.isEnabled(testNativeConfig)).isFalse();
        assertThat(RUN_TIME_INITIALIZE_FILE_SYSTEM_PROVIDERS.isEnabled(testNativeConfig)).isFalse();
        testNativeConfig = new TestNativeConfig(futureDefaultsNone, null);
        assertThat(RUN_TIME_INITIALIZE_SECURITY_PROVIDERS.isEnabled(testNativeConfig)).isFalse();
        assertThat(RUN_TIME_INITIALIZE_FILE_SYSTEM_PROVIDERS.isEnabled(testNativeConfig)).isFalse();
    }
}
