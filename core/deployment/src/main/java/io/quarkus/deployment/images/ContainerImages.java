 ...
 * <p>
 * - {@code x_IMAGE_NAME} - the name of the image without the version (e.g.
 * {@code registry.access.redhat.com/ubi9/ubi-minimal}) - {@code x_VERSION} - the version of the image (e.g.
 * {@code 9.5}) - {@code x} - the full image name (e.g. {@code registry.access.redhat.com/ubi9/ubi-minimal:9.5})
 */
public class ContainerImages {
    ...
    public static final String UBI8_QUARKUS_MICRO_IMAGE = UBI8_QUARKUS_MICRO_IMAGE_NAME + ":"
            + UBI8_QUARKUS_MICRO_VERSION;
    ...
    public static final String UBI9_QUARKUS_MICRO_IMAGE = UBI9_QUARKUS_MICRO_IMAGE_NAME + ":"
    ...
    // https://catalog.redhat.com/software/containers/ubi8/openjdk-21-runtime/653fd184292263c0a2f14d69
    ...
    // default Quarkus Binary Source To Image -
    // https://quay.io/repository/quarkus/ubi9-quarkus-native-binary-s2i?tab=tags
    ...
    public static final String UBI8_MANDREL_BUILDER = UBI8_MANDREL_BUILDER_IMAGE_NAME + ":"
            + UBI8_MANDREL_BUILDER_VERSION;
    ...
    public static final String UBI9_MANDREL_BUILDER = UBI9_MANDREL_BUILDER_IMAGE_NAME + ":"
            + UBI9_MANDREL_BUILDER_VERSION;
    ...
    public static final String UBI8_GRAALVM_BUILDER = UBI8_GRAALVM_BUILDER_IMAGE_NAME + ":"
    ...
    public static final String UBI9_GRAALVM_BUILDER = UBI9_GRAALVM_BUILDER_IMAGE_NAME + ":"
