...
mvn io.quarkus:quarkus-maven-plugin:{quarkus-version}:create \
    ...
    -DclassName="org.acme.spring.web.GreeterController" \
    -Dpath="/greeting" \
...
The Quarkus maven plugin automatically generated a `src/main/java/org/acme/spring/web/GreeterController.java` file.
...
public class GreeterController {
    ...
    public Greeting hello(@PathVariable(name = "name") String name) {
        return new Greeting(greeterBean.greet(name));
    }
}
----
...
Now create a class named `org.acme.spring.GreeterBean` that looks like this
