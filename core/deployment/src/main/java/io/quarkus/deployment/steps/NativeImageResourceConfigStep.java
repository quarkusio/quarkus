...
public class NativeImageResourceConfigStep {
    ...
    /**
     * GraalVM only escapes asterisks in filenames
     * before matching so we only need to escape asterisks in our glob patterns not backslashes.
     * <a href=
     * "https://github.com/graalvm/graalvm-community-jdk25u/blob/master/substratevm/src/com.oracle.svm.core/src/com/oracle/svm/core/jdk/resources/CompressedGlobTrie/CompressedGlobTrie.java#L383">CompressedGlobTrie</a>
     */
