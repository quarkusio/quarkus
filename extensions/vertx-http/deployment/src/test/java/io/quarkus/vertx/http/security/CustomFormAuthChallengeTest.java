...
public class CustomFormAuthChallengeTest {
    ...
    public void testCustomGetChallengeIsCalled() {
        RestAssured.given().when().formParam("j_username", ADMIN).formParam("j_password", "wrong_password")
                .post("/j_security_check").then().assertThat().statusCode(EXPECTED_STATUS)
    ...
    public static class CustomFormAuthenticator implements HttpAuthenticationMechanism {
        ...
        public Uni<ChallengeData> getChallenge(RoutingContext context) {
            return Uni.createFrom()
                    .item(new ChallengeData(EXPECTED_STATUS, EXPECTED_HEADER_NAME, EXPECTED_HEADER_VALUE));
        }
