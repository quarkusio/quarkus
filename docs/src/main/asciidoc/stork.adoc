...
Create a Quarkus project importing the quarkus-smallrye-stork, quarkus-rest-client-reactive and quarkus-resteasy-reactive extensions using your favorite approach:

:create-app-artifact-id: stork-quickstart
:create-app-extensions: quarkus-smallrye-stork,quarkus-rest-client-reactive,quarkus-resteasy-reactive
