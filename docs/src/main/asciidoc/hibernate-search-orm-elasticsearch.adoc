...
Hibernate ORM executes it automatically when it creates the database schema
...
The initial data (see <<automatic-import-script>>) is loaded on startup without any additional configuration,
since the schema is created by Hibernate ORM.
