...
@Path("/oidc-client")
public class ExtendedOidcClientRequestReactiveFilterResource {
    ...
    @Inject
    @RestClient
    ProtectedResourceServiceExtendedOidcClientRequestReactiveFilter protectedResourceServiceExtendedOidcClientRequestReactiveFilter;
    ...
    public String customProviderConfigPropertyUserName() {
        return protectedResourceServiceExtendedOidcClientRequestReactiveFilter.getUserName();
    }

    @GET
    @Path("/custom-provider-config-property/anonymous-user-name")
    public String customProviderConfigPropertyAnonymousUserName() {
        return protectedResourceServiceExtendedOidcClientRequestReactiveFilter.getAnonymousUserName();
    }
}
