...
:extensions: io.quarkus:quarkus-rest,io.quarkus:quarkus-rest-jackson,io.quarkus:quarkus-rest-jsonb,io.quarkus:quarkus-resteasy-client,io.quarkus:quarkus-resteasy-client-jackson,io.quarkus:quarkus-resteasy-client-jsonb
...
Please note that the `quarkus-resteasy-client` extension may not be used with Quarkus REST, use `quarkus-resteasy-client` instead.
