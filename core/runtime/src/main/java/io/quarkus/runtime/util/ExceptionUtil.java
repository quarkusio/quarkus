...
public class ExceptionUtil {
    ...
    /**
     * Returns an "upside down" stacktrace of the {@code exception} with the root cause showing up first in the
     * stacktrace. <em>Note:</em> This is a relatively expensive method because it creates additional exceptions and
     * manipulates their stacktrace. Care should be taken to determine whether usage of this method is necessary.
     *
     * @param exception
     *        The exception
     *
     ...
     * <ul>
     * <li>The {@code cause} of the Throwable hasn't yet been {@link Throwable#initCause(Throwable) inited} and thus can
     * be "inited" later on if needed</li>
     * <li>The stacktrace elements of the Throwable have been set to the stacktrace elements of the passed {@code t}.
     * That way, any call to {@link Throwable#printStackTrace(PrintStream)} for example will print the stacktrace of the
     * passed {@code t}</li>
     * </ul>
     *
     * @param t
    ...
    /**
     * Creates and returns a new {@link Throwable} whose {@link Throwable#toString()} has been overridden to call the
     * {@code toString()} method of the passed {@code t}.
     *
     * @param t
     *        The exception
     *
