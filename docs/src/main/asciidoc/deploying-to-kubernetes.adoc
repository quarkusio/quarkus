...
| quarkus.kubernetes.policies                        | Map<String, RolePolicyConfig>             |             |
|====
...
|====
| Property     | Type     | Description                         | Default Value
| cluster-wide | boolean  | Whether to create a ClusterRole     | false
| api-groups   | String[] | `apiGroups` of the resulting `Role` |
| resources    | String[] | `resources` of the resulting `Role` |
| verbs        | String[] | `verbs` of the resulting `Role`     |
|====
