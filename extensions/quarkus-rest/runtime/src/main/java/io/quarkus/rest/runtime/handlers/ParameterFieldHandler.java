...
/**
 * This handler injects into fields of a method parameter. For example if a parameter is a {@link javax.ws.rs.BeanParam}.
 * It must be run after the method parameter is created and stored.
 */
public class ParameterFieldHandler implements RestHandler {
    ...
    public ParameterFieldHandler(int index, BiConsumer<Object, Object> setter, String defaultValue,
            ParameterExtractor extractor, ParameterConverter converter) {
        this.index = index;
        this.setter = setter;
    ...
    private void handleResult(Object result, QuarkusRestRequestContext requestContext) {
        ...
        setter.accept(requestContext.getParameters()[index], result);
    }
}
