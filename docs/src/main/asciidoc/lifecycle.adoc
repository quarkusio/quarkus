...
User provided initialization tasks are `Runnable` annotated with the `@Initialization` annotation that indicates that
...
----
<1> The task is annotated with `@Initialization`
...
----
<1> The method is annotated with `@Initialization`
