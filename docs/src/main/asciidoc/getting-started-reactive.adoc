...
The code is a bit more involved. To write to a database, we need a transaction.
...
If you have https://httpie.io/[httpie] on your machine, you can try the endpoint using `http POST :8080/fruits name=peach`.
