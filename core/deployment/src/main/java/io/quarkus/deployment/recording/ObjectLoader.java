...
/**
 * A segment of code generation which produces the necessary instructions to load the given object. The result handle is
 * cached for reuse.
 */
public interface ObjectLoader {
     ...
     *
     * @param body
     *        the body to use for bytecode generation (not {@code null})
     * @param obj
     *        the object to substitute (not {@code null})
     * @param staticInit
     *        {@code true} if this loader is for a static init method, {@code false} otherwise
     *
