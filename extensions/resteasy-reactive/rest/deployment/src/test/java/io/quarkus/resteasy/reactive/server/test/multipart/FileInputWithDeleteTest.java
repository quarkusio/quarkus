...
public class FileInputWithDeleteTest extends AbstractMultipartTest {
    ...
    static QuarkusUnitTest test = new QuarkusUnitTest().setArchiveProducer(new Supplier<>() {
        ...
        public JavaArchive get() {
            return ShrinkWrap.create(JavaArchive.class).addClasses(Resource.class).addAsResource(
                    new StringAsset("quarkus.http.body.uploads-directory=" + uploadDir.toString() + "\n"),
