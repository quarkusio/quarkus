...
include::{generated-dir}/config/quarkus-vertx-http_quarkus.http.header.-header-.adoc[leveloffset=+1, opts=optional]
...
include::{generated-dir}/config/quarkus-vertx-http_quarkus.http.filter.-filter-.adoc[leveloffset=+1, opts=optional]
