            ...
            if (t1 != null) {
                ...
                if (!isEmpty) {
                    ...
                    evaluatedParams.put(NESTED_CONTENT,
                            context.execute(
                                    context.resolutionContext().createChild(new HashMap<>(evaluatedParams), null, null)));
                }
                try {
                    ...
                    tagTemplate.root.resolve(context.resolutionContext().createChild(evaluatedParams, null, null))
