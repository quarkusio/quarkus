...
public interface TraceListener {
     ...
     *        instance and timing
     */
    void onStartTemplate(TemplateEvent event);
     ...
     */
    void onBeforeResolve(ResolveEvent event);
     ...
     *        error encountered
     */
    void onAfterResolve(ResolveEvent event);
     ...
     *        instance and timing
     */
    void onEndTemplate(TemplateEvent event);
}
