package io.quarkus.mongodb.mutiny;
...
public interface ReactiveMongoDatabase {
     ...
     * @return an {@link Uni} emitting the command result once completed
     */
     ...
     * Drops this database.
     *
     * @return an {@link Uni} emitting {@code null} when the database has been dropped
     */
    Uni<Void> drop();
     ...
     * @return an {@link Uni} emitting {@code null} when the operation has completed
     */
