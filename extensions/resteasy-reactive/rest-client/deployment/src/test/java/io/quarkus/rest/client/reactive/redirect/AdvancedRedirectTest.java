...
public class AdvancedRedirectTest {
    ...
    static final QuarkusUnitTest TEST = new QuarkusUnitTest()
            .withApplicationRoot((jar) -> jar.addClasses(RedirectingResourceClient302.class,
                    RedirectingResourceWithRegisterProviderAdvancedRedirectHandlerClient.class,
                    EnablePostAdvancedRedirectHandler.class, RedirectingResource.class));
    ...
    void shouldRedirectWhenUsingCustomRedirectHandlerOnPostMethods() {
        RedirectingResourceClient302 client302 = RestClientBuilder.newBuilder().baseUri(uri)
                ...
                .register(EnablePostAdvancedRedirectHandler.class).build(RedirectingResourceClient302.class);
