...
TIP: You can switch from one way to the other for ad hoc use cases, e.g. have one business method that manipulates a `ManagedEntity` as if it was a `RecordEntity`. See <<SOME LINK TO DOCS HERE>> for more details.
