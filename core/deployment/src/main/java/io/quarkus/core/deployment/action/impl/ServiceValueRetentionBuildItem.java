 ...
 * <ul>
 * <li>{@link ActionBuilderImpl} — for static-init service keys handed out as recorder
 * proxies via {@code getRecorderProxy()}, whose downstream consumer (a later-phase
 * recorder or service) is undetectable at hand-out time</li>
