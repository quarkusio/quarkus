...
include::{generated-config-doc-dir}/quarkus-vertx-http_quarkus.http.static-resources.adoc[leveloffset=+1, opts=optional]
...
include::{generated-config-doc-dir}/quarkus-vertx-http_quarkus.http.header.-header-.adoc[leveloffset=+1, opts=optional]
...
include::{generated-config-doc-dir}/quarkus-vertx-http_quarkus.http.filter.-filter-.adoc[leveloffset=+1, opts=optional]
...
include::{generated-config-doc-dir}/quarkus-vertx-http_quarkus.http.limits.adoc[leveloffset=+1, opts=optional]
...
include::{generated-config-doc-dir}/quarkus-vertx-http_quarkus.http.access-log.adoc[opts=optional, leveloffset=+1]
