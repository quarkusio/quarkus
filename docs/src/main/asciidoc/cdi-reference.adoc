...
There is only one bean archive with https://docs.jboss.org/cdi/spec/2.0/cdi-spec.html#default_bean_discovery[`annotated` bean discovery mode, window="_blank"] and no visibility boundaries.
