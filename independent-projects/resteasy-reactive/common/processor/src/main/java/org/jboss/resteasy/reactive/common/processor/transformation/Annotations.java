...
final class Annotations {
     ...
     * @param name
     *
     * @return {@code true} if the given collection contains an annotation instance with the given name, {@code false}
     *         otherwise
     */
     ...
     * @param names
     *
     * @return {@code true} if the given collection contains an annotation instance with any of the given names,
