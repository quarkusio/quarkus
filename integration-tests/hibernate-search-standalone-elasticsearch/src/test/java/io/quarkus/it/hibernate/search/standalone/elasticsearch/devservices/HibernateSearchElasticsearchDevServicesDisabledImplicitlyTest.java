...
public class HibernateSearchElasticsearchDevServicesDisabledImplicitlyTest {
    ...
    public static class Profile implements QuarkusTestProfile {
        ...
        public Map<String, String> getConfigOverrides() {
            return Map.of(
                    // Make sure quarkus.hibernate-search-standalone.elasticsearch.hosts is set,
                    // so that Quarkus detects disables Elasticsearch dev-services implicitly.
                    "quarkus.hibernate-search-standalone.elasticsearch.hosts", EXPLICIT_HOSTS,
        ...
        public String getConfigProfile() {
            ...
            // In this test, we DO set quarkus.hibernate-search-standalone.elasticsearch.hosts (see above).
