...
public interface OpenApiDocumentConfig {
     ...
     * <p>
     * For the default document, the default value is simply {@code openapi}. For any
     * named OpenAPI documents, the {@code -<document-name>} part will be replaced by the document name.
     * <p>
     * If you set a non-default value, then your custom value is used without resolving {@code -<document-name>}.
     */
