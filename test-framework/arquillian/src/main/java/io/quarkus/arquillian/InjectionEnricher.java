...
public class InjectionEnricher implements TestEnricher {
    ...
    public Object[] resolve(Method method) {
        ...
        if (method.getParameterTypes().length > 0) {
            ...
            try {
                ...
                BiFunction<Method, Object, Object[]> function = (BiFunction<Method, Object, Object[]>) c.getConstructor()
                        .newInstance();
    ...
    private CreationContextHolder getCreationalContext() {
        try {
            ...
            Supplier<Map.Entry<Closeable, Object>> supplier = (Supplier<Map.Entry<Closeable, Object>>) c.getConstructor()
                    .newInstance();
