 ...
 * strategy, you should not extend this class directly but extend [ReactivePanacheMongoEntity]
 * instead.
 *
...
abstract class ReactivePanacheMongoEntityBase {
     ...
     * @see [persist]
     */
    fun <T : ReactivePanacheMongoEntityBase> persist(): Uni<T> =
        INSTANCE.persist(this).map { this as T }
     ...
     * @see [update]
     */
    fun <T : ReactivePanacheMongoEntityBase> update(): Uni<T> =
        INSTANCE.update(this).map { this as T }
     ...
     * @see [persistOrUpdate]
     */
    fun <T : ReactivePanacheMongoEntityBase> persistOrUpdate(): Uni<T> =
        INSTANCE.persistOrUpdate(this).map { this as T }
