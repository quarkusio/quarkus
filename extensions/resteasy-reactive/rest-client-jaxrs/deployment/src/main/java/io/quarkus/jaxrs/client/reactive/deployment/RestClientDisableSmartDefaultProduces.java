 ...
 * else. MicroProfile Rest Client spec requires the implementations to always default to application/json. This build
 * item disables the "smart" behavior of RESTEasy Reactive to comply to the spec
 */
