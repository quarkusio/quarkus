...
include::{generated-config-doc-dir}/quarkus-oidc_quarkus.oidc.adoc[opts=optional, leveloffset=+1]

== Keycloak Dev Services configuration

include::{generated-config-doc-dir}/quarkus-oidc_quarkus.keycloak.adoc[opts=optional, leveloffset=+1]
