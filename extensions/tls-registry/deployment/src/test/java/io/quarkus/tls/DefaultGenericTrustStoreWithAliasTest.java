...
public class DefaultGenericTrustStoreWithAliasTest {

    private static final String configuration = """
            quarkus.tls.trust-store.pkcs12.path=target/certs/test-alias-p12-truststore.p12
            quarkus.tls.trust-store.pkcs12.password=password
            quarkus.tls.trust-store.pkcs12.alias=alias1
            """;
