...
public class NamedGenericKeyStoreTest {

    private static final String configuration = """
            quarkus.tls.http.key-store.pkcs12.path=target/certs/test-formats-keystore.p12
            quarkus.tls.http.key-store.pkcs12.password=password
            """;
    ...
    void test() throws KeyStoreException, CertificateParsingException {
        ...
        X509Certificate certificate = (X509Certificate) named.getKeyStore().getCertificate("test-formats");
