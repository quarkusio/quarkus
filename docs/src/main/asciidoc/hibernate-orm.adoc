...
<persistence xmlns="http://xmlns.jcp.org/xml/ns/persistence"
    ...
    <persistence-unit name="CustomerPU" transaction-type="JTA">
        ...
        <properties>
            <property name="hibernate.archive.autodetection" value="class" /> <1>
...
----
<1> Enable automatic scanning of the entity classes.
...
[NOTE]
====
If you configure your persistence unit in a `persistence.xml` file and want to enable entity scanning,
set the `hibernate.archive.autodetection` property to `class` in the `persistence.xml`.
====
