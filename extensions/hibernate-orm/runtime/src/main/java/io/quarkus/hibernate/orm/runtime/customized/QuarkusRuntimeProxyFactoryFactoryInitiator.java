...
/**
 * Responsible for initializing the QuarkusRuntimeProxyFactoryFactory. N.B. : this is a stateful Service Initiator, it
 * carries the proxy definitions which have been generated during the Hibernate ORM metadata analysis.
 */
