...
public class ProductEndpoint {
    ...
    public Product findByIdForUpdate(Long id){
        Product product = Product.findById(id, LockModeType.PESSIMISTIC_WRITE);
        product.stock--;
...
public class ProductEndpoint {
    ...
    @GET
    @Transactional
    public Product findBySkuForUpdate(String sku){
        Product product = Product.find("sku", sku).withLock(LockModeType.PESSIMISTIC_WRITE).firstResult();
        product.stock--;
        // the lock will be released when the transaction ends
        return product;
    }
