...
{product-name-first} provides first class support for using Liquibase MongoDB Extension as will be explained in this guide.
...
Liquibase MongoDB extension support relies on the {product-name} MongoDB client config.
