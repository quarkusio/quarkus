...
/**
 * An extension that registers a custom CDI context via {@link ContextRegistrationPhaseBuildItem} should produce this
 * build item in order to contribute the custom scope annotation name to the set of bean defining annotations.
 *
