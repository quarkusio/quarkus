...
/**
 * A set of compiler flags for javac. Can combine system-provided default flags with user-supplied flags and
 * <code>--release</code> and <code>-source</code> and <code>-target</code> settings.
 */
public class CompilerFlags {
    ...
    public CompilerFlags(Set<String> defaultFlags, Collection<String> userFlags, String releaseJavaVersion,
            String sourceJavaVersion, String targetJavaVersion, List<String> annotationProcessors) {
