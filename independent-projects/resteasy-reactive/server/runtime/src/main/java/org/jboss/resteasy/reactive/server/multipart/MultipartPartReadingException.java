 ...
 * {@link jakarta.ws.rs.ext.MessageBodyReader}. This exception is useful to application because it can be by an
 * {@link jakarta.ws.rs.ext.ExceptionMapper} in order to customize the input error handling.
 */
