...
public class OpenApiMPDirectOpenApiFilterAnnotationTest {
    ...
    static QuarkusExtensionTest runner = new QuarkusExtensionTest()
            .withApplicationRoot(jar -> jar
                    .addClass(OpenApiMPDirectOpenApiFilterAnnotationTest.class)
                    .addAsResource(
                            new StringAsset(
                                    """
                                            mp.openapi.filter=io.quarkus.smallrye.openapi.test.jaxrs.OpenApiMPDirectOpenApiFilterAnnotationTest$MyOASFilter
