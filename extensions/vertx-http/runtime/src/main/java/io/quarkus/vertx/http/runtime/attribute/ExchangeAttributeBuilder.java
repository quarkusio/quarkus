...
public interface ExchangeAttributeBuilder {
    ...
    /**
     * Build the attribute from a text based representation. If the attribute does not understand this representation
    ...
    /**
     * The priority of the builder. Builders will be tried in priority builder. Built in builders use the priority range
     * 0-100,
     *
     * @return The priority
     */
