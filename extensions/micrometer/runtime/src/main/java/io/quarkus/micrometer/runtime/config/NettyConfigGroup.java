...
public interface NettyConfigGroup extends MicrometerConfig.CapabilityEnabled {
     ...
     * <p>
     * Support for Netty metrics will be enabled if Micrometer support is enabled, the Netty allocator classes are on
     * the classpath and either this value is true, or this value is unset and
