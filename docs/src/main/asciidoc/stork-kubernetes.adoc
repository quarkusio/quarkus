...
Create a Quarkus project importing the `quarkus-resteasy-client` and `quarkus-rest` extensions using your favorite approach:

:create-app-artifact-id: stork-kubernetes-quickstart
:create-app-extensions: quarkus-resteasy-client,quarkus-rest
