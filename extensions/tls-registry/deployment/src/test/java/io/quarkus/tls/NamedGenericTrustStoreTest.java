...
public class NamedGenericTrustStoreTest {

    private static final String configuration = """
            quarkus.tls.http.trust-store.pkcs12.path=target/certs/test-formats-truststore.p12
            quarkus.tls.http.trust-store.pkcs12.password=password
            """;
