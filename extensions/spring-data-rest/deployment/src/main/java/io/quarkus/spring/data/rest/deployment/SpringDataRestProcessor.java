...
class SpringDataRestProcessor {
    ...
    private static final DotName LIST_CRUD_REPOSITORY_INTERFACE = DotName
    ...
    private static final List<DotName> EXCLUDED_INTERFACES = Arrays.asList(CRUD_REPOSITORY_INTERFACE,
            LIST_CRUD_REPOSITORY_INTERFACE, PAGING_AND_SORTING_REPOSITORY_INTERFACE,
    ...
    void registerRepositories(CombinedIndexBuildItem indexBuildItem, Capabilities capabilities,
        ...
        implementResources(capabilities, implementationsProducer, restDataResourceProducer, resourcePropertiesProducer,
                unremovableBeansProducer, new RepositoryMethodsImplementor(index, entityClassHelper), index,
    ...
    private void implementResources(Capabilities capabilities,
            ...
            BuildProducer<ResourcePropertiesBuildItem> resourcePropertiesProducer,
            BuildProducer<UnremovableBeanBuildItem> unremovableBeansProducer,
            ResourceMethodsImplementor methodsImplementor, IndexView index, List<ClassInfo> repositoriesToImplement) {
        ...
        for (ClassInfo classInfo : repositoriesToImplement) {
            ...
            restDataResourceProducer.produce(new RestDataResourceBuildItem(new ResourceMetadata(resourceClass,
                    repositoryName, null, entityType, idType, Collections.emptyMap())));
