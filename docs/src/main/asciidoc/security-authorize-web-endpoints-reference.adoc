...
// link:{url-quarkusio-guides}config-reference#property-expressions[Property Expressions] - Current Downstream synegry link. Needs to be added to upstream attributes.
