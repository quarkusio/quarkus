...
`@SessionScoped` beans cannot be injected into Rest endpoints. If you need this, you will need to use the extension `quarkus-resteasy` instead of `quarkus-resteasy-reactive`.
