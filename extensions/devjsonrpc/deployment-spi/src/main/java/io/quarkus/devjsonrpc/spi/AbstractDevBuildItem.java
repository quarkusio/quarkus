 ...
 */
public abstract class AbstractDevBuildItem extends MultiBuildItem {
    ...
    public AbstractDevBuildItem() {
        this(null);
    }

    public AbstractDevBuildItem(String customIdentifier) {
        ...
        if (customIdentifier == null) {
            ...
            Optional<StackWalker.StackFrame> stackFrame = stackWalker.walk(frames -> frames
                    .filter(frame -> (!frame.getDeclaringClass().getPackageName().startsWith("io.quarkus.devjsonrpc.spi")
