...
public class JPAFunctionalityInGraalITCase extends JPAFunctionalityTest {
    ...
    private static final int EXPECTED_NUMBER_OF_USED_CLASSES = 13000;
    private static final int EXPECTED_NUMBER_OF_USED_METHODS = 85400;
    private static final int EXPECTED_NUMBER_OF_USED_PACKAGES = 860;
    ...
    public void verifyJDKXMLParsersAreIncluded() {
        ...
        usedClassesReport.assertContains("com.sun.org.apache.xalan.internal.xsltc.trax.TransformerFactoryImpl");
