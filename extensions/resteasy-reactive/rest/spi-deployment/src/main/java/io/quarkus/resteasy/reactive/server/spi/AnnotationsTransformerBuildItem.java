 ...
 * immutable) but instead in an abstraction layer. Users/extensions can access {@link AnnotationStore} to view the
 * updated annotation model. NOTE: Extensions that operate purely on Jandex index analysis won't be able to see any
 * changes made via {@link AnnotationsTransformer}!
 */
