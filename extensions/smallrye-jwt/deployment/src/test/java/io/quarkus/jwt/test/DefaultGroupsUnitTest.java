...
public class DefaultGroupsUnitTest {
    private static Class<?>[] testClasses = { DefaultGroupsEndpoint.class, CustomSecurityIdentityAugmentor.class,
            TokenUtils.class };
    /**
    ...
    public void checkRoutingContext() {
        RestAssured.given().auth().oauth2(token).get("/endp/routingContext").then().assertThat().statusCode(200)
