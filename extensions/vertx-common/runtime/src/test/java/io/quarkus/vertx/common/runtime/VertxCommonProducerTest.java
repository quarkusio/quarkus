...
public class VertxCommonProducerTest {
    ...
    private VertxCommonRecorder recorder;
    private VertxCommonProducer producer;

    @Before
    public void setUp() throws Exception {
        producer = new VertxCommonProducer();
        recorder = new VertxCommonRecorder();
    }
    ...
    public void shouldNotFailWithoutConfig() {
        ...
        producer.initialize(VertxCommonRecorder.vertx);
        verifyProducer();
    }
    ...
    public void shouldNotFailWithDefaultConfig() {
        ...
        VertxCommonRecorder.initialize(configuration);
        producer.initialize(VertxCommonRecorder.vertx);
        verifyProducer();
    }
