...
public class AsyncHandlerNonPublicClassTest {
    @RegisterExtension
    ...
    public void trigger() {
        ...
        assertTrue(error.getMessage().contains("is not public"));
    }

    static class AsyncHandlerNonPublicCtor<T> implements AsyncHandler.ReturnType<MyAsyncType<T>> {
        public AsyncHandlerNonPublicCtor() {
        }
