...
public class TooManyTrustStoreConfiguredP12AndOtherTest {
    ...
    private static final String configuration = """
            ...
            quarkus.tls.trust-store.other.path=target/certs/test-formats-truststore.p12
            quarkus.tls.trust-store.other.password=password
            """;
    ...
    static final QuarkusExtensionTest config = new QuarkusExtensionTest().setArchiveProducer(
            ...
            .assertException(t -> {
                assertThat(t).hasMessageContaining("Only one truststore type");
            });
