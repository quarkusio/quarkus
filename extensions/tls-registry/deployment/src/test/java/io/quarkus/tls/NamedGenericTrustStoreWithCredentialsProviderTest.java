...
public class NamedGenericTrustStoreWithCredentialsProviderTest {

    private static final String configuration = """
            quarkus.tls.foo.trust-store.pkcs12.path=target/certs/test-credentials-provider-truststore.p12
