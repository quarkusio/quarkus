...
public interface ResteasyReactiveAsyncExceptionMapper<E extends Throwable> extends ExceptionMapper<E> {
    ...
    /**
     * If the handling of the exception involves async handling async results, the implementation can use
     * {@link AsyncExceptionMapperContext#suspend()} and {@link AsyncExceptionMapperContext#resume()}. In all cases, tt
     * is the responsibility of the implementation to call {@link AsyncExceptionMapperContext#setResponse(Response)}
