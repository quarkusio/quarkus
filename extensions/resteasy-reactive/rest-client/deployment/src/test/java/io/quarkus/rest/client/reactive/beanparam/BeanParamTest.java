...
public class BeanParamTest {
    ...
    void shouldPassPathParamFromBeanParam() {
        ...
        assertThat(client.beanParamWithFields(new MyBeanParamWithFields())).isEqualTo(
                "restPathDefault/restPathOverridden/pathParam" + "/restHeaderDefault/restHeaderOverridden/headerParam"
        ...
        assertThat(client.regularParameters("restPathDefault", "restPathOverridden", "pathParam", "restHeaderDefault",
                "restHeaderOverridden", "headerParam", "restCookieDefault", "restCookieOverridden", "cookieParam",
                "restFormDefault", SomeEnum.TEST, "restFormOverridden", "formParam", "restQueryDefault",
                "restQueryOverridden", "queryParam"))
                .isEqualTo("restPathDefault/restPathOverridden/pathParam"
                        + "/restHeaderDefault/restHeaderOverridden/headerParam"
                        + "/restFormDefault/test/restFormOverridden/formParam"
                        + "/restCookieDefault/restCookieOverridden/cookieParam"
                        + "/restQueryDefault/restQueryOverridden/queryParam");
        assertThat(client.beanParamWithProperties(new MyBeanParamWithProperties()))
                .isEqualTo("null/null/pathParam" + "/null/null/headerParam" + "/null/null/null/formParam"
                        + "/null/null/cookieParam" + "/null/null/queryParam");
    }
    ...
    public interface Client {
        ...
        String regularParameters(@RestPath String restPathDefault,
                @RestPath("restPath_Overridden") String restPathOverridden, @PathParam("pathParam") String pathParam,

                @RestHeader String restHeaderDefault, @RestHeader("restHeader_Overridden") String restHeaderOverridden,
                @HeaderParam("headerParam") String headerParam,

                @RestCookie String restCookieDefault, @RestCookie("restCookie_Overridden") String restCookieOverridden,
                @CookieParam("cookieParam") String cookieParam,

                @RestForm String restFormDefault, @RestForm SomeEnum someEnum,
                @RestForm("restForm_Overridden") String restFormOverridden, @FormParam("formParam") String formParam,

                @RestQuery String restQueryDefault, @RestQuery("restQuery_Overridden") String restQueryOverridden,
    ...
    public static class Resource {
        @Path("/{restPathDefault}/{restPath_Overridden}/{pathParam}")
        @POST
        public String beanParamWithFields(@RestPath String restPathDefault, @RestPath String restPath_Overridden,
                @RestPath String pathParam, @RestHeader String restHeaderDefault,
                @RestHeader("restHeader_Overridden") String restHeader_Overridden,
                @RestHeader("headerParam") String headerParam, @RestForm String restFormDefault,
                @RestForm String someEnum, @RestForm String restForm_Overridden, @RestForm String formParam,
                @RestCookie String restCookieDefault, @RestCookie String restCookie_Overridden,
                @RestCookie String cookieParam, @RestQuery String restQueryDefault,
                @RestQuery String restQuery_Overridden, @RestQuery String queryParam) {
            return restPathDefault + "/" + restPath_Overridden + "/" + pathParam + "/" + restHeaderDefault + "/"
                    + restHeader_Overridden + "/" + headerParam + "/" + restFormDefault + "/" + someEnum + "/"
                    + restForm_Overridden + "/" + formParam + "/" + restCookieDefault + "/" + restCookie_Overridden
                    + "/" + cookieParam + "/" + restQueryDefault + "/" + restQuery_Overridden + "/" + queryParam;
        }

        @Path("/{pathParam}")
        @POST
        public String beanParamWithProperties(@RestPath String restPathDefault, @RestPath String restPath_Overridden,
                @RestPath String pathParam, @RestHeader String restHeaderDefault,
                @RestHeader("restHeader_Overridden") String restHeader_Overridden,
                @RestHeader("headerParam") String headerParam, @RestForm String restFormDefault,
                @RestForm String someEnum, @RestForm String restForm_Overridden, @RestForm String formParam,
