...
With this guide, you'll learn how to synchronize your entities to an Elasticsearch cluster in a heartbeat with Hibernate Search.
We will also explore how you can query your Elasticsearch cluster using the Hibernate Search API.
