...
public class AetherArtifactResolver extends AppArtifactResolverBase {
    ...
    private AetherArtifactResolver(RepositorySystem repoSystem, RepositorySystemSession repoSession, List<RemoteRepository> remoteRepos, BootstrapLocalRepositoryManager localRepoManager) {
    ...
    private AetherArtifactResolver(Builder builder) throws AppArtifactResolverException {
        ...
        newSession.setDependencyGraphTransformer(new BootstrapDependencyGraphTransformer(repoSystem, newSession.getDependencyGraphTransformer()));
        if(builder.wsr != null) {
    ...
    protected void doResolve(AppArtifact artifact) throws AppArtifactResolverException {
        ...
        try {
            ...
            throw new AppArtifactResolverException("Failed to resolve artifact " + artifact, e);
        }
        setPath(artifact, artifactResult.getArtifact().getFile().toPath());
    }

    @Override
    public List<AppDependency> collectDependencies(AppArtifact coords) throws AppArtifactResolverException {
    ...
    @Override
    public List<AppDependency> collectRuntimeDependencies(AppArtifact coords) throws AppArtifactResolverException {
        final Artifact artifact = toAetherArtifact(coords);
        final ArtifactDescriptorRequest descrReq = new ArtifactDescriptorRequest();
        descrReq.setArtifact(artifact);
        final ArtifactDescriptorResult artDescr;
    ...
    @Override
    public List<AppDependency> collectDependencies(AppArtifact root, List<AppDependency> coords) throws AppArtifactResolverException {
        final CollectRequest collectRequest = new CollectRequest();
...
/*
    @Override
    public List<AppDependency> collectDependencies(AppArtifact coords) throws AppArtifactResolutionException {
        final CollectRequest collectRequest = new CollectRequest();
        ...
        try {
            ...
            throw new AppArtifactResolutionException("Failed to collect dependencies for " + coords, e);
        }
