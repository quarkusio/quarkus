...
public class ResteasyJsonbProcessor {
    ...
    private static final List<String> VERTX_SERIALIZERS = Arrays.asList(VertxJson.JsonObjectSerializer.class.getName(),
            VertxJson.JsonArraySerializer.class.getName());

    private static final List<String> VERTX_DESERIALIZERS = Arrays
            .asList(VertxJson.JsonObjectDeserializer.class.getName(), VertxJson.JsonArrayDeserializer.class.getName());
