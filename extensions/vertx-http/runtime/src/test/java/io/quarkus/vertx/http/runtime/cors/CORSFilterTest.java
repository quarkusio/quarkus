...
public class CORSFilterTest {
    ...
    void testCorsConfig() {
        ...
        var configWithOriginsOnly = (CORSConfig) new CORS.Builder(config)
                .origin("origin-1")
                .origins("origin-2", "origin-3")
                .origins(List.of("origin-4", "origin-5"))
                .build();
        ...
        var configWithMethodsOnly = (CORSConfig) new CORS.Builder(config)
                .method("method-1")
                .methods("method-2", "method-3")
                .methods(List.of("method-4", "method-5"))
                .build();
        ...
        var configWithHeadersOnly = (CORSConfig) new CORS.Builder(config)
                ...
                .headers(List.of("header-4", "header-5"))
                .build();
        ...
        var configWithExposedHeadersOnly = (CORSConfig) new CORS.Builder(config)
                ...
                .exposedHeaders("header-2", "header-3")
                .exposedHeaders(List.of("header-4", "header-5"))
                .build();
