...
/**
 * Attaches Stork observation context while {@link StorkGrpcChannel#newCall} captures
 * the selected {@link ServiceInstance}, then records selection metrics on call close.
 */
@ApplicationScoped
