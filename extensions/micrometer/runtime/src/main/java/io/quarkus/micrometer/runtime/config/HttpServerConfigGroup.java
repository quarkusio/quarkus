...
public interface HttpServerConfigGroup extends MicrometerConfig.CapabilityEnabled {
     ...
     * <p>
     * Support for HTTP server metrics will be enabled if Micrometer support is enabled, an extension serving HTTP
     * traffic is enabled, and either this value is true, or this value is unset and
