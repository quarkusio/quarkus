...
public abstract class CompatibilityUnitTestBase {
    ...
    public static final String POSTGRES_REACTIVE_URL = "vertx-reactive:postgresql://localhost:5431/hibernate_orm_test";
    public static final String POSTGRES_BLOCKING_URL = "jdbc:postgresql://localhost:5431/hibernate_orm_test";
