 ...
 * <p>
 * It represents the logic that is used to test if a scheduled job should be executed at a specific time, i.e. the
 * trigger is "fired".
 *
 * @see Scheduled
 */
public interface Trigger {
    ...
    /**
     * If the trigger represents a cron-based job with a timezone, then the returned {@code Instant} takes the timezone
     * into account.
     * <p>
     ...
     *
     * @return {@code false} if the last execution took place between the expected execution time and the end of the
     *         grace period, {@code true} otherwise
     *
