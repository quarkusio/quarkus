...
public class AxleReactiveMongoClientImpl implements ReactiveMongoClient {
    ...
    public AxleReactiveMongoClientImpl(io.quarkus.mongodb.mutiny.ReactiveMongoClient client) {
        this(client.unwrap());
    }

    @Override
    public ReactiveMongoDatabase getDatabase(String name) {
        return new AxleReactiveMongoDatabaseImpl(client.getDatabase(name));
    }
