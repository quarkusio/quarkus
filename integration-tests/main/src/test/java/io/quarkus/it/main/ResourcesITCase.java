...
public class ResourcesITCase extends ResourcesTestCase {
    ...
    public void excludedNative() {
        ...
        RestAssured.when()
                .get("/resources/META-INF/quarkus-native-reflection.json")
                .then()
                .statusCode(404);

        RestAssured.when()
                .get("/resources/META-INF/quarkus-native-serialization.json")
                .then()
                .statusCode(404);

        RestAssured.when()
                .get("/resources/META-INF/quarkus-native-weak-reflection.json")
                .then()
                .statusCode(404);
    }
