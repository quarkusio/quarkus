...
public class NamedP12KeyStoreTest {

    private static final String configuration = """
            quarkus.tls.http.key-store.p12.path=target/certs/test-formats-keystore.p12
            quarkus.tls.http.key-store.p12.password=password
            """;
