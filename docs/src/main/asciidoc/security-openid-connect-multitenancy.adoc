...
It can also be restricted to either a bearer access token or authorization code flow with the `io.quarkus.oidc.BearerTokenAuthentication` and `io.quarkus.oidc.AuthorizationCodeFlow` annotation respectively.
