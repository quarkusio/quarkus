...
public class ApplicationManifestsBuildStep {
    ...
    /**
     * Aggregates application manifest configurations and creates application manifests from which SBOMs could be
     * generated by SBOM generating build steps.
     *
     * @param artifactResultBuildItems
     *        artifact results
     *
