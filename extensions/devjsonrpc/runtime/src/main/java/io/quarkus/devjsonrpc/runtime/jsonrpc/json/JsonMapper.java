package io.quarkus.devjsonrpc.runtime.jsonrpc.json;
                    ...
                    return Map.of(
                            ...
                            (Function<Map<String, ?>, Map<String, ?>>) args -> {
                                var created = object.create(
                                        args.containsKey("jsonObjectAdapter")
                                                ? typeAdapterFromLinkData(args.get("jsonObjectAdapter"))
                                                : null,
                                        args.containsKey("jsonArrayAdapter")
                                                ? typeAdapterFromLinkData(args.get("jsonArrayAdapter"))
                                                : null,
                                        args.containsKey("bufferAdapter")
                    ...
                    return new Factory() {
                        ...
                        public JsonMapper create(JsonTypeAdapter<?, Map<String, Object>> jsonObjectAdapter,
                            ...
                            if (jsonObjectAdapter != null) {
                                args.put("jsonObjectAdapter", typeAdapterToLinkData(jsonObjectAdapter));
                            }
                            if (jsonArrayAdapter != null) {
                                args.put("jsonArrayAdapter", typeAdapterToLinkData(jsonArrayAdapter));
                            }
                            if (bufferAdapter != null) {
                                args.put("bufferAdapter", typeAdapterToLinkData(bufferAdapter));
                            }
                            var linkData = create.apply(args);
