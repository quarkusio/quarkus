...
public interface TrustStoreConfig {
    ...
    /**
     * Sets the location of the trust store files. If you use JKS or PCK#12, only one path is allowed. If you use PEM
     * files, you can specify multiple paths.
     * <p>
     ...
     * {@code truststore.pem} will be seen as a PEM file, while {@code truststore.jks} will be seen as a JKS file.
     * {@code truststore.p12} and {@code truststore.pfx} will both be seen as PKCS#12 files. Accepted values are:
     * {@code JKS}, {@code PEM}, {@code PKCS}.
     */
