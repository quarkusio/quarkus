...
Please check the link:https://smallrye.io/docs/smallrye-fault-tolerance/6.9.4/index.html[SmallRye Fault Tolerance documentation] to learn about them.
...
The link:https://smallrye.io/docs/smallrye-fault-tolerance/6.9.4/reference/programmatic-api.html[programmatic API] is present and integrated with the declarative, annotation-based API.
