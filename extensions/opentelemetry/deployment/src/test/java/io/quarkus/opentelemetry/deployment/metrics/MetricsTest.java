...
public class MetricsTest {
    ...
    void asyncDoubleCounter() {
        ...
        assertNotNull(meter.counterBuilder(counterName).ofDoubles().setDescription(counterDescription)
                .setUnit(counterUnit).buildWithCallback(measurement -> {
        ...
        assertEquals(metric.getDoubleSumData().getPoints().stream().findFirst().get().getValue(), 1);
    }
    ...
    void asyncLongCounter() {
        ...
        final String counterUnit = "Metric Tonnes";
        assertNotNull(meter.counterBuilder(counterName).setDescription(counterDescription).setUnit(counterUnit)
        ...
        assertEquals(metric.getLongSumData().getPoints().stream().findFirst().get().getValue(), 1);
    }
    ...
    void doubleCounter() {
        ...
        DoubleCounter doubleCounter = meter.counterBuilder(counterName).ofDoubles().setDescription(counterDescription)
                .setUnit(counterUnit).build();
        ...
        metric.getDoubleSumData().getPoints().stream().forEach(point -> {
            ...
            assertTrue(point.getAttributes().equals(expectedResults.get(point.getValue())),
                    "Attributes were not equal." + System.lineSeparator() + "Actual values: "
                            + mapToString(point.getAttributes().asMap()) + System.lineSeparator() + "Expected values: "
    ...
    void doubleGauge() {
        ...
        assertNotNull(meter.gaugeBuilder(gaugeName).setDescription(gaugeDescription).setUnit("ms")
                .buildWithCallback(measurement -> {
                    measurement.record(1, Attributes.empty());
                }));
        ...
        assertEquals(metric.getDoubleGaugeData().getPoints().stream().findFirst().get().getValue(), 1);
    }
    ...
    void doubleHistogram() {
        ...
        DoubleHistogram doubleHistogram = meter.histogramBuilder(histogramName).setDescription(histogramDescription)
                .setUnit(histogramUnit).build();
        ...
        metric.getHistogramData().getPoints().stream().forEach(point -> {
    ...
    void longCounter() {
        ...
        LongCounter longCounter = meter.counterBuilder(counterName).setDescription(counterDescription)
                .setUnit(counterUnit).build();
        ...
        metric.getLongSumData().getPoints().stream().forEach(point -> {
            assertTrue(expectedResults.containsKey(point.getValue()),
    ...
    void longGauge() {
        ...
        final String gaugeUnit = "ms";
        assertNotNull(meter.gaugeBuilder(gaugeName).ofLongs().setDescription(gaugeDescription).setUnit("ms")
                .buildWithCallback(measurement -> {
                    measurement.record(1, Attributes.empty());
                }));
        ...
        assertEquals(metric.getLongGaugeData().getPoints().stream().findFirst().get().getValue(), 1);
    }
    ...
    void longHistogram() {
        ...
        LongHistogram longHistogram = meter.histogramBuilder(histogramName).ofLongs()
                .setDescription(histogramDescription).setUnit(histogramUnit).build();
    ...
    void longUpDownCounter() {
        ...
        final long longWithAttributes = -20;
        final long longWithoutAttributes = -10;
        LongUpDownCounter longUpDownCounter = meter.upDownCounterBuilder(counterName).setDescription(counterDescription)
                .setUnit(counterUnit).build();
