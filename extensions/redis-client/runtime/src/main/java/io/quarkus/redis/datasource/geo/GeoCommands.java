 ...
 * <p>
 * Geo-localized items are tuples composed of longitude, latitude and the member. The member is of type
 * {@code &lt;V&gt}. Each key can store multiple items.
 *
 * @param <K>
 *        the type of the key
 * @param <V>
...
public interface GeoCommands<K, V> extends RedisCommands {
     ...
     **/
    @Deprecated
    List<GeoValue<V>> georadius(K key, double longitude, double latitude, double radius, GeoUnit unit,
     ...
     **/
    @Deprecated
    long georadius(K key, double longitude, double latitude, double radius, GeoUnit unit,
