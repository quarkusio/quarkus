...
public interface ReactivePanacheMongoRepositoryBase<Entity, Id> {
     ...
     */
    @GenerateBridge
    default ReactivePanacheQuery<Entity> list(Document query) {
        throw ReactiveMongoOperations.implementationInjectionMissing();
    }
     ...
     */
    @GenerateBridge
    default ReactivePanacheQuery<Entity> list(Document query, Document sort) {
        throw ReactiveMongoOperations.implementationInjectionMissing();
    }
     ...
     * @see #update(Iterable)
     */
    default Uni<Void> update(Entity firstEntity, @SuppressWarnings("unchecked") Entity... entities) {
     ...
     * @see #update(Iterable)
     */
    default Uni<Void> persistOrUpdate(Entity firstEntity,
