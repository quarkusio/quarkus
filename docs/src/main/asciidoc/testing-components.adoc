...
TIP: This JUnit extension is available in the `quarkus-junit-jupiter-component` dependency.
...
JUnit Jupiter https://docs.junit.org/current/user-guide/#writing-tests-nested[@Nested tests] may help to structure more complex test scenarios.
