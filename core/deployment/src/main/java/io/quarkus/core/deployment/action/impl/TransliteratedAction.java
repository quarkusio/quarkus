...
public sealed interface TransliteratedAction {
     ...
     * @param optional {@code true} if this service may produce no value (declared via {@code optional()});
     *        its action returns {@code Optional<T>} and an empty result marks the service as valueless
     ...
     * wraps it in a {@link RuntimeValue}, and stores the wrapper under a separate key.
     * <p>
