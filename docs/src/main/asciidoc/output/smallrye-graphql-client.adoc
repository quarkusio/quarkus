...
This guide demonstrates how your {product-name-first} application can use the GraphQL client library.
...
If you already have your {product-name} project configured, you can add the `smallrye-graphql-client` extension
...
NOTE: During *tests only*, the URL is an optional property, and if it's not specified, {product-name} will assume
