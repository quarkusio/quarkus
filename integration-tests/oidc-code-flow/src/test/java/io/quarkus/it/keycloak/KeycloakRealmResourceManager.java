...
public class KeycloakRealmResourceManager implements QuarkusTestResourceLifecycleManager, DevServicesContext.ContextAware {
    ...
    private static RealmRepresentation createRealm(String name, String defaultClientSecret) {
        ...
        realm.addIdentityProvider(
                createAttestationTrustIdp("abca-attester-dynamic",
                        "http://host.testcontainers.internal:8081/.well-known/attestation-jwks/tenant-attestation-dynamic"));
        realm.getClients().add(createClientAttestation("quarkus-app-attestation-dynamic", "abca-attester-dynamic"));
