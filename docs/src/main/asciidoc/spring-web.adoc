...
:create-app-extensions: spring-web
...
:add-extension-extensions: spring-web
...
NOTE: `quarkus-spring-web` requires a JSON serialization extension such as `quarkus-rest-jackson` or `quarkus-resteasy-jackson`. If none is present in your project dependencies, `quarkus-rest-jackson` will be added automatically as the default provider.
