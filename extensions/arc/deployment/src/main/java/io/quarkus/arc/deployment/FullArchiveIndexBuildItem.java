...
public final class FullArchiveIndexBuildItem extends SimpleBuildItem {

    private final IndexView index;
    private final Set<DotName> generatedClassNames;
    private final List<String> additionalBeans;

    public FullArchiveIndexBuildItem(final IndexView index, final Set<DotName> generatedClassNames,
            final List<String> additionalBeans) {
        this.index = index;
