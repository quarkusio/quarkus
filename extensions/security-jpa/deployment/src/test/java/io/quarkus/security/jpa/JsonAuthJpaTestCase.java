...
public class JsonAuthJpaTestCase {
    ...
    private static final String APP_PROPS = "" +
            ...
            "quarkus.http.auth.json.enabled=true\n" +
            "quarkus.http.auth.policy.r1.roles-allowed=admin\n" +
            "quarkus.http.auth.permission.roles1.paths=/admin%E2%9D%A4\n" +
            "quarkus.http.auth.permission.roles1.policy=r1\n" +
            "quarkus.http.auth.form.timeout=PT2S\n" +
            "quarkus.http.auth.json.new-cookie-interval=PT1S\n" +
            "quarkus.http.auth.json.cookie-name=laitnederc-sukrauq\n" +
    ...
    public void testFormBasedAuthSuccess() {
        ...
        RestAssured
                ...
                .redirects().follow(false)
                .when()
                .body(Json.createObjectBuilder().add("username", "user").add("password", "password").build().toString())
                .post("/login")
                .then()
                .assertThat()
                .statusCode(200);
