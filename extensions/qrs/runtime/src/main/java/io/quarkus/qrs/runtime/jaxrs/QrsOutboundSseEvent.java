...
public class QrsOutboundSseEvent implements OutboundSseEvent {
    ...
    QrsOutboundSseEvent(final String name, final String id, final long reconnectDelay, final Class<?> type,
    ...
    public static class BuilderImpl implements Builder {
        ...
        public OutboundSseEvent build() {
            ...
            return new QrsOutboundSseEvent(name, id, reconnectDelay, type, genericType, mediaType, data, comment);
        }
    }
}