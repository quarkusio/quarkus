...
/**
 * REST data Panache resource that uses {@link PanacheEntityBase} instance for data access and exposes it as a JAX-RS
 * resource.
 * <p>
 ...
 *
 * @param <Entity>
 *        {@link PanacheEntityBase} that is handled by this resource.
 * @param <ID>
 *        ID type of the entity.
 */
public interface PanacheEntityResource<Entity extends PanacheEntityBase, ID>
