...
public final class StaticBytecodeRecorderBuildItem extends MultiBuildItem {
    ...
    public StaticBytecodeRecorderBuildItem(BytecodeRecorderImpl bytecodeRecorder) {
        ...
        this.stepId = bytecodeRecorder.getStepId();
    }
     ...
     * @deprecated Use {@link #StaticBytecodeRecorderBuildItem(BytecodeRecorderImpl)} instead.
     *             The step ID is now stored in the bytecode recorder itself.
     */
    @Deprecated
