...
:summary: This page explains how to enable xDS gRPC usage in your {product-name-first} application.

This page explains how to enable xDS gRPC usage in your {product-name} application.

IMPORTANT: This {product-name} xDS gRPC integration currently doesn't support building native executables due to the issues
with shaded grpc-netty library while running native IT tests.

== Configuring your project

Add the {product-name} gRPC xDS extension to your build file:
