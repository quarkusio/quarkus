...
Dev Services for Elasticsearch implements a _service discovery_ mechanism for your multiple {product-name-first} applications running in _dev_ mode to share a single server.
