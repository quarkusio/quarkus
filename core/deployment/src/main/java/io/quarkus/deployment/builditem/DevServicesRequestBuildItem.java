...
/**
 * A build item that is used to request the start of a dev service.
 */
public final class DevServicesRequestBuildItem extends MultiBuildItem {

    public final String featureName;
    public final String serviceName;
    public final Object serviceConfig;
    public final Supplier<Startable> startableSupplier;
    public final Map<String, Function<Startable, String>> applicationConfigProvider;

    public DevServicesRequestBuildItem(String featureName, String serviceName, Object serviceConfig,
    ...
    public static class SupplierMap<K, V> implements Map<K, V> {
        private final Map<K, Supplier<V>> suppliers = new HashMap<>();
        private final Map<K, V> cache = new HashMap<>();

        public SupplierMap() {
        }

        public SupplierMap(Map<K, Supplier<V>> initialSuppliers) {
            this.suppliers.putAll(initialSuppliers);
        }
