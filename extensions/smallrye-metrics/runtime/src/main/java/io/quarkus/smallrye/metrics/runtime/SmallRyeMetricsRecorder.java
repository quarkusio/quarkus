...
public class SmallRyeMetricsRecorder {
    ...
    public void registerMetrics(BeanInfo beanInfo, MemberInfo memberInfo) {
        ...
        MetricsMetadata.registerMetrics(registry, new MetricResolver(), beanInfo, memberInfo);
    }

    public void registerMetric(MetricRegistry.Type scope, MetadataHolder metadataHolder, TagHolder[] tagHolders,
            Object implementor) {
    ...
    private void garbageCollectionMetrics(MetricRegistry registry) {
        ...
        Metadata countMetadata = Metadata.builder().withName("gc.total").withType(MetricType.COUNTER)
                .withDisplayName("Garbage Collection Count").withUnit("none")
                .withDescription(
                ...
                .build();
        Metadata timeMetadata = Metadata.builder().withName("gc.time").withType(MetricType.COUNTER)
                .withDisplayName("Garbage Collection Time").withUnit("milliseconds")
                .withDescription(
    ...
    private void classLoadingMetrics(MetricRegistry registry) {
        ...
        Metadata meta = Metadata.builder().withName(TOTAL_LOADED_CLASS_COUNT).withType(MetricType.COUNTER)
        ...
        meta = Metadata.builder().withName(TOTAL_UNLOADED_CLASS_COUNT).withType(MetricType.COUNTER)
        ...
        meta = Metadata.builder().withName(CURRENT_LOADED_CLASS_COUNT).withType(MetricType.GAUGE)
    ...
    private void baseOperatingSystemMetrics(MetricRegistry registry) {
        ...
        Metadata meta = Metadata.builder().withName(SYSTEM_LOAD_AVERAGE).withType(MetricType.GAUGE)
        ...
        meta = Metadata.builder().withName(CPU_AVAILABLE_PROCESSORS).withType(MetricType.GAUGE)
        ...
        // the cast will fail for some JVM not derived from HotSpot (J9 for example) so we check if it is assignable to
        // it
        if (ImageMode.current() == ImageMode.JVM
            ...
            try {
                ...
                meta = Metadata.builder().withName(PROCESS_CPU_LOAD).withType(MetricType.GAUGE)
                        .withUnit(MetricUnits.PERCENT).withDisplayName("Process CPU load")
    ...
    private void vendorOperatingSystemMetrics(MetricRegistry registry) {
        ...
        if (ImageMode.current() == ImageMode.JVM
            ...
            try {
                com.sun.management.OperatingSystemMXBean internalOperatingSystemMXBean = (com.sun.management.OperatingSystemMXBean) operatingSystemMXBean;
                Metadata meta = Metadata.builder().withName(SYSTEM_CPU_LOAD).withType(MetricType.GAUGE)
                        .withUnit(MetricUnits.PERCENT).withDisplayName("System CPU load")
                        .withDescription(
                                "Displays the \"recent cpu usage\" for the whole system. This value is a double "
                ...
                meta = Metadata.builder().withName(PROCESS_CPU_TIME).withType(MetricType.GAUGE)
                        .withUnit(MetricUnits.NANOSECONDS).withDisplayName("Process CPU time")
                        .withDescription(
                ...
                meta = Metadata.builder().withName(FREE_PHYSICAL_MEM_SIZE).withType(MetricType.GAUGE)
                        .withUnit(MetricUnits.BYTES).withDisplayName("Free physical memory size")
                        .withDescription("Displays the amount of free physical memory in bytes.").build();
                registry.register(meta, new Gauge() {
                    @Override
                    public Number getValue() {
                ...
                meta = Metadata.builder().withName(FREE_SWAP_SIZE).withType(MetricType.GAUGE)
                        .withUnit(MetricUnits.BYTES).withDisplayName("Free swap size")
                        .withDescription("Displays the amount of free swap space in bytes.").build();
                registry.register(meta, new Gauge() {
                    @Override
                    public Number getValue() {
    ...
    private void threadingMetrics(MetricRegistry registry) {
        ...
        Metadata meta = Metadata.builder().withName(THREAD_COUNT).withType(MetricType.GAUGE)
        ...
        meta = Metadata.builder().withName(THREAD_DAEMON_COUNT).withType(MetricType.GAUGE)
        ...
        meta = Metadata.builder().withName(THREAD_MAX_COUNT).withType(MetricType.GAUGE)
    ...
    private void runtimeMetrics(MetricRegistry registry) {
        ...
        Metadata meta = Metadata.builder().withName(JVM_UPTIME).withType(MetricType.GAUGE)
                .withUnit(MetricUnits.MILLISECONDS).withDisplayName("JVM Uptime")
    ...
    private void baseMemoryMetrics(MetricRegistry registry) {
        ...
        Metadata meta = Metadata.builder().withName(MEMORY_COMMITTED_HEAP).withType(MetricType.GAUGE)
                .withUnit(MetricUnits.BYTES).withDisplayName("Committed Heap Memory")
                .withDescription(
        ...
        meta = Metadata.builder().withName(MEMORY_MAX_HEAP).withType(MetricType.GAUGE).withUnit(MetricUnits.BYTES)
        ...
        meta = Metadata.builder().withName(MEMORY_USED_HEAP).withType(MetricType.GAUGE).withUnit(MetricUnits.BYTES)
    ...
    private void vendorSpecificMemoryMetrics(MetricRegistry registry) {
        ...
        Metadata meta = Metadata.builder().withName(MEMORY_COMMITTED_NON_HEAP).withType(MetricType.GAUGE)
                .withUnit(MetricUnits.BYTES).withDisplayName("Committed Non Heap Memory")
                .withDescription(
        ...
        meta = Metadata.builder().withName(MEMORY_MAX_NON_HEAP).withType(MetricType.GAUGE).withUnit(MetricUnits.BYTES)
        ...
        meta = Metadata.builder().withName(MEMORY_USED_NON_HEAP).withType(MetricType.GAUGE).withUnit(MetricUnits.BYTES)
    ...
    private void memoryPoolMetrics(MetricRegistry registry) {
        ...
        if (ImageMode.current() == ImageMode.JVM) {
            ...
            Metadata usageMetadata = Metadata.builder().withName("memoryPool.usage").withType(MetricType.GAUGE)
            ...
            Metadata maxMetadata = Metadata.builder().withName("memoryPool.usage.max").withType(MetricType.GAUGE)
    ...
    private void micrometerJvmGcMetrics(MetricRegistry registry, ShutdownContext shutdownContext) {
        if (ImageMode.current() == ImageMode.JVM) {
            ...
            registry.register(new ExtendedMetadataBuilder().withName("jvm.gc.max.data.size").withType(MetricType.GAUGE)
                    ...
                    .skipsScopeInOpenMetricsExportCompletely(true).build(), new Gauge() {
                        @Override
                        public Number getValue() {
            ...
            registry.register(new ExtendedMetadataBuilder().withName("jvm.gc.memory.promoted")
                    .withType(MetricType.COUNTER).withUnit(MetricUnits.BYTES)
                    .withDescription(
                            "Count of positive increases in the size of the old generation memory pool before GC to after GC")
                    .skipsScopeInOpenMetricsExportCompletely(true)
                    .withOpenMetricsKeyOverride("jvm_gc_memory_promoted_bytes_total").build(),
            ...
            registry.register(new ExtendedMetadataBuilder().withName("jvm.gc.memory.allocated")
                    .withType(MetricType.COUNTER).withUnit(MetricUnits.BYTES)
                    .withDescription(
    ...
    /**
     * Mimics Uptime metrics from Micrometer. Most of the logic here is basically copied from {@link <a href=
    ...
    private void micrometerRuntimeMetrics(MetricRegistry registry) {
        ...
        registry.register(new ExtendedMetadataBuilder().withName("process.runtime").withType(MetricType.GAUGE)
        ...
        registry.register(new ExtendedMetadataBuilder().withName("process.start.time").withType(MetricType.GAUGE)
                .withUnit(MetricUnits.MILLISECONDS).withDescription("Start time of the process since unix epoch.")
                .skipsScopeInOpenMetricsExportCompletely(true).build(), new Gauge() {
                    @Override
                    public Number getValue() {
    ...
    private void micrometerJvmThreadMetrics(MetricRegistry registry) {
        ...
        registry.register(new ExtendedMetadataBuilder().withName("jvm.threads.peak").withType(MetricType.GAUGE)
                .withUnit("threads")
        ...
        registry.register(new ExtendedMetadataBuilder().withName("jvm.threads.daemon").withType(MetricType.GAUGE)
                .withUnit("threads").withDescription("The current number of live daemon threads")
                .skipsScopeInOpenMetricsExportCompletely(true).build(), new Gauge() {
                    @Override
                    public Number getValue() {
        ...
        registry.register(new ExtendedMetadataBuilder().withName("jvm.threads.live").withType(MetricType.GAUGE)
                .withUnit("threads")
        ...
        if (ImageMode.current() == ImageMode.JVM) {
            ExtendedMetadata threadStatesMetadata = new ExtendedMetadataBuilder().withName("jvm.threads.states")
                    .withType(MetricType.GAUGE).withUnit("threads")
            ...
            for (Thread.State state : Thread.State.values()) {
                registry.register(threadStatesMetadata, new Gauge() {
                    @Override
                    public Number getValue() {
    ...
    private void micrometerJvmMemoryMetrics(MetricRegistry registry) {
        if (ImageMode.current() == ImageMode.JVM) {
            for (MemoryPoolMXBean memoryPoolMXBean : ManagementFactory.getMemoryPoolMXBeans()) {
                ...
                registry.register(new ExtendedMetadataBuilder().withName("jvm.memory.used").withType(MetricType.GAUGE)
                        .withUnit("bytes").withDescription("The amount of used memory")
                        .skipsScopeInOpenMetricsExportCompletely(true).build(), new Gauge() {
                            @Override
                            public Number getValue() {
                ...
                registry.register(new ExtendedMetadataBuilder().withName("jvm.memory.committed")
                        .withType(MetricType.GAUGE).withUnit("bytes")
                        .withDescription(
                ...
                registry.register(new ExtendedMetadataBuilder().withName("jvm.memory.max").withType(MetricType.GAUGE)
                        .withUnit("bytes")
            ...
            for (BufferPoolMXBean bufferPoolBean : ManagementFactory.getPlatformMXBeans(BufferPoolMXBean.class)) {
                ...
                registry.register(new ExtendedMetadataBuilder().withName("jvm.buffer.count").withType(MetricType.GAUGE)
                        .withUnit("buffers").withDescription("An estimate of the number of buffers in the pool")
                        .skipsScopeInOpenMetricsExportCompletely(true).build(), new Gauge() {
                            @Override
                            public Number getValue() {
                ...
                registry.register(new ExtendedMetadataBuilder().withName("jvm.buffer.memory.used")
                        .withType(MetricType.GAUGE).withUnit("bytes")
                        .withDescription(
                ...
                registry.register(new ExtendedMetadataBuilder().withName("jvm.buffer.total.capacity")
                        .withType(MetricType.GAUGE).withUnit("bytes")
    ...
    private void micrometerJvmClassLoaderMetrics(MetricRegistry registry) {
        // The ClassLoadingMXBean can be used in native mode, but it only returns zeroes, so there's no point in
        // including such metrics.
        if (ImageMode.current() == ImageMode.JVM) {
            ClassLoadingMXBean classLoadingBean = ManagementFactory.getClassLoadingMXBean();

            registry.register(new ExtendedMetadataBuilder().withName("jvm.classes.loaded").withType(MetricType.GAUGE)
                    .withUnit("classes")
                    .withDescription("The number of classes that are currently loaded in the Java virtual machine")
                    .withOpenMetricsKeyOverride("jvm_classes_loaded_classes").build(), new Gauge() {
                        @Override
                        public Number getValue() {
            ...
            registry.register(new ExtendedMetadataBuilder().withName("jvm.classes.unloaded")
                    .withType(MetricType.COUNTER).withUnit("classes")
                    .withDescription(
                            "The total number of classes unloaded since the Java virtual machine has started execution")
                    .withOpenMetricsKeyOverride("jvm_classes_unloaded_classes_total").build(),
                    new GetCountOnlyCounter() {
                        @Override
                        public long getCount() {
