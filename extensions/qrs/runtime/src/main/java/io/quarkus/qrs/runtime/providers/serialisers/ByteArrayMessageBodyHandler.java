...
@Provider
public class ByteArrayMessageBodyHandler implements QrsMessageBodyWriter<byte[]>, MessageBodyReader<byte[]> {
    ...
    @Override
    public void writeResponse(byte[] o, QrsRequestContext context) throws WebApplicationException {
