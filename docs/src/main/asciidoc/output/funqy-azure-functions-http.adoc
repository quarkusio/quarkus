...
:categories: cloud
:summary: Use Funqy HTTP binding with Microsoft Azure Functions to deploy your serverless {product-name-first} applications.
...
Jakarta REST, Spring MVC, or Vert.x Web Reactive Route xref:azure-functions-http.adoc[support] instead.  They also work with {product-name} and Azure Functions.
