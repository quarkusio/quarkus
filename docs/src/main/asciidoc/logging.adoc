...
If you want to send your logs to a central management tool like Graylog, Logstash or Fluentd; you can follow the link:central-logging.html[Central log management guide].