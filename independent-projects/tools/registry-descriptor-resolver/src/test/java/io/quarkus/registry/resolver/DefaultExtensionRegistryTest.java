...
class DefaultExtensionRegistryTest {
    ...
    static void setUp() throws IOException {
        Repository repository = Repository.parse(Paths.get("src/test/resources/repository"), OBJECT_MAPPER);
    ...
    void shouldLookupPlatformForDependentExtensionInQuarkusFinal() {
        ExtensionInstallPlan result = extensionRegistry.planInstallation("1.3.2.Final",
                Arrays.asList("quarkus-resteasy-qute", "quarkus-jgit"));
    ...
    void shouldLookupSinglePlatform() {
        ExtensionInstallPlan result = extensionRegistry.planInstallation("1.3.2.Final",
                Collections.singletonList("camel-quarkus-xstream"));
