...
include::{generated-config-doc-dir}/quarkus-grpc_quarkus.grpc-client.adoc[opts=optional, leveloffset=+1]
...
include::{generated-config-doc-dir}/quarkus-grpc_quarkus.grpc.dev-mode.adoc[opts=optional, leveloffset=+1]
