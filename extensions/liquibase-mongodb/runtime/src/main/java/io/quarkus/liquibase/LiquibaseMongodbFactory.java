...
public class LiquibaseMongodbFactory {
    ...
    public LiquibaseMongodbFactory(LiquibaseMongodbConfig config, MongoClientConfig mongoClientConfig) {
    ...
    public Liquibase createLiquibase() {
        try {
            ...
            Liquibase liquibase = new Liquibase(liquibaseMongodbConfig.changeLog, resourceAccessor, database);
