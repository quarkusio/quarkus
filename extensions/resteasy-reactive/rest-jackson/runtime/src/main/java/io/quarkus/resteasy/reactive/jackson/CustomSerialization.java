...
public @interface CustomSerialization {
     ...
     * {@code ObjectWriter} is needed (this type will be a generic type if the method returns such a generic type) and
     * returns the instance of the custom {@code ObjectWriter}.
     * <p>
     * Quarkus will construct one instance of this {@code BiFunction} for each JAX-RS resource method that is annotated
     * with {@code CustomSerialization} and once an instance is created it will be cached for subsequent usage by that
     * resource method.
     * <p>
