...
public class GenericKeyStoreWithAliasCredentialsProviderTest {

    private static final String configuration = """
            quarkus.tls.key-store.pkcs12.path=target/certs/test-credentials-provider-alias-keystore.p12
            quarkus.tls.key-store.pkcs12.alias=my-alias
