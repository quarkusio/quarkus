...
public class KafkaDevServicesDevModeTestCase {
    ...
    public void sseStream() {
        ...
        try (SseEventSource source = SseEventSource.target(target).build()) {
            ...
            Awaitility.await().untilAsserted(() -> assertThat(received).hasSizeGreaterThanOrEqualTo(2));
        }

        assertThat(received).hasSizeGreaterThanOrEqualTo(2).allMatch(value -> (value >= 0) && (value < 100));
