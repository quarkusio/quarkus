...
public interface OpenTelemetryContextUnwrapper {
    /**
     * Called when an HTTP server response has ended. Makes sure exemplars are produced because they have an OTel
     * context.
     *
     * @param methodReference
     *        Ex: Sample stop method reference
     * @param parameter
     ...
     * @param <R>
     *        The return type of the method pointed by the methodReference
     *
