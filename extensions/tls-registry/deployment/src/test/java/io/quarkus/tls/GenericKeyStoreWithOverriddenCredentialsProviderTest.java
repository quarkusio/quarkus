...
public class GenericKeyStoreWithOverriddenCredentialsProviderTest {

    private static final String configuration = """
            quarkus.tls.key-store.pkcs12.path=target/certs/test-credentials-provider-keystore.p12
            quarkus.tls.key-store.pkcs12.password=secret123!
