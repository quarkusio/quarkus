...
import io.quarkus.mongodb.panache.transaction.interceptor.ReactiveMongoTransactionalInterceptor;
    ...
    static ClientSession getSession() {
        ...
        if (instance.isAvailable()) {
            ...
            if (registry.getTransactionStatus() == Status.STATUS_ACTIVE) {
                return (ClientSession) registry
                        .getResource(ReactiveMongoTransactionalInterceptor.SESSION_KEY);
            }
        }
        return null;
    }
