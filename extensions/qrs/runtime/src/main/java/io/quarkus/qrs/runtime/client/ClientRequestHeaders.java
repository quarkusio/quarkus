...
import io.quarkus.qrs.runtime.util.HeaderHelper;
import io.quarkus.qrs.runtime.util.MediaTypeHelper;
import io.quarkus.qrs.runtime.util.WeightedLanguage;
...
public class ClientRequestHeaders {
    ...
    protected QrsConfiguration configuration;

    public ClientRequestHeaders(final QrsConfiguration configuration) {
