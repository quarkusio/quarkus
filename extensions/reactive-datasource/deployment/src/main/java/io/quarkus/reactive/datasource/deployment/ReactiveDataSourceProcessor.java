...
class ReactiveDataSourceProcessor {
    ...
    @BuildStep
    void generateDataSourceBeans(List<AggregatedDataSourceBuildTimeConfigBuildItem> aggregatedBuildTimeConfigBuildItems,
            BuildProducer<ReactiveDataSourceBuildItem> jdbcDataSource) {
        ...
        for (AggregatedDataSourceBuildTimeConfigBuildItem aggregatedBuildTimeConfigBuildItem : aggregatedBuildTimeConfigBuildItems) {
            jdbcDataSource.produce(new ReactiveDataSourceBuildItem(aggregatedBuildTimeConfigBuildItem.getName(),
