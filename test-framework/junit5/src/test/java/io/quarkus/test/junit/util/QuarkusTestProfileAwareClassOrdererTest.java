...
class QuarkusTestProfileAwareClassOrdererTest {
    ...
    @Test
    void singleClass() {
        doReturn(Collections.singletonList(descriptorMock(Test01.class))).when(contextMock).getClassDescriptors();
    ...
    void multipleClassloaders() throws IOException {
        ...
        List<ClassDescriptor> input = Arrays.asList(quarkusTestb2Desc, quarkusTesta1Desc, quarkusTestb1Desc,
                quarkusTesta2Desc);
        ...
        assertThat(input).containsExactly(quarkusTesta1Desc, quarkusTesta2Desc, quarkusTestb1Desc, quarkusTestb2Desc);
    }
    ...
    void multipleClassloadersAndSecondaryOrderer() throws IOException {
        ...
        List<ClassDescriptor> input = Arrays.asList(quarkusTesta3Desc, quarkusTesta1Desc, quarkusTesta2Desc,
                quarkusTestb1Desc);
        ...
        assertThat(input).containsExactly(quarkusTesta3Desc, quarkusTesta1Desc, quarkusTesta2Desc, quarkusTestb1Desc);
    }
    ...
    void allVariants() {
        ...
        ClassDescriptor quarkusTest2a = quarkusDescriptorMock(Test02a.class, Manager3.class, false,
                QuarkusTestResource.class);
        ClassDescriptor quarkusTest2Desc = quarkusDescriptorMock(Test02.class, Manager3.class, false,
                WithTestResource.class);
        ClassDescriptor quarkusTest3Desc = quarkusDescriptorMock(Test03.class, Manager3.class, false,
                QuarkusTestResource.class);
        ClassDescriptor quarkusTest3aDesc = quarkusDescriptorMock(Test03a.class, Manager4.class, false,
                WithTestResource.class);
        ...
        ClassDescriptor quarkusTestWithRestrictedResourceDesc = quarkusDescriptorMock(Test07.class, Manager2.class,
                true, WithTestResource.class);
        ClassDescriptor quarkusTestWithRestrictedResourceDesc2 = quarkusDescriptorMock(Test07.class, Manager2.class,
                true, QuarkusTestResource.class);
        ...
        List<ClassDescriptor> input = Arrays.asList(quarkusTestWithRestrictedResourceDesc, nonQuarkusTest2Desc,
                quarkusTest2Desc, quarkusTestWithRestrictedResourceDesc2, quarkusTestWithProfile2Test5Desc,
                quarkusTest1aDesc, nonQuarkusTest1Desc, quarkusTestWithMetaResourceDesc, quarkusTest1Desc,
                quarkusTestWithProfile2Test4Desc, quarkusTestWithMetaResourceDesc2, quarkusTest3Desc, quarkusTest2b,
                quarkusTestWithProfile1Desc, quarkusTest2a, quarkusTest3bDesc, quarkusTest3aDesc);
        doReturn(input).when(contextMock).getClassDescriptors();

        new QuarkusTestProfileAwareClassOrderer().orderClasses(contextMock);

        assertThat(input).containsExactly(quarkusTest1Desc, quarkusTest1aDesc, quarkusTest2Desc, quarkusTest2a,
                quarkusTest2b, quarkusTest3Desc, quarkusTest3aDesc, quarkusTest3bDesc, quarkusTestWithProfile1Desc,
                quarkusTestWithProfile2Test4Desc, quarkusTestWithProfile2Test5Desc,
                quarkusTestWithRestrictedResourceDesc, quarkusTestWithRestrictedResourceDesc2,
                quarkusTestWithMetaResourceDesc, quarkusTestWithMetaResourceDesc2, nonQuarkusTest1Desc,
                nonQuarkusTest2Desc);
    }
    ...
    void configuredPrefix() {
        ...
        new QuarkusTestProfileAwareClassOrderer("20_", "30_", "40_", "45_", "01_", Optional.empty())
    ...
    void secondaryOrderer() {
        ...
        List<ClassDescriptor> input = Arrays.asList(nonQuarkusTest1Desc, nonQuarkusTest2Desc, quarkusTest1Desc);
        doReturn(input).when(contextMock).getClassDescriptors();

        new QuarkusTestProfileAwareClassOrderer("20_", "30_", "40_", "45_", "60_",
                Optional.of(ClassOrderer.OrderAnnotation.class.getName())).orderClasses(contextMock);

        assertThat(input).containsExactly(quarkusTest1Desc, nonQuarkusTest2Desc, nonQuarkusTest1Desc);
    }
    ...
    private void quarkusWithTestResourceMock(ClassDescriptor mock,
            Class<? extends QuarkusTestResourceLifecycleManager> managerClass, boolean restrictToAnnotatedClass) {
        WithTestResource withResourceMock = Mockito.mock(WithTestResource.class,
                withSettings().strictness(Strictness.LENIENT));
        doReturn(managerClass).when(withResourceMock).value();
        when(withResourceMock.scope()).thenReturn(restrictToAnnotatedClass ? TestResourceScope.RESTRICTED_TO_CLASS
    ...
    // this single made-up test class needs an actual annotation since the orderer will have to do the meta-check
    // directly
    ...
    public static class ByteClassLoader extends ClassLoader {
        ...
        protected Class<?> cloneClass(final Class clazz) {
            ...
            try {
                ...
                byte[] bytes = clazz.getClassLoader().getResourceAsStream(resourceName).readAllBytes();
