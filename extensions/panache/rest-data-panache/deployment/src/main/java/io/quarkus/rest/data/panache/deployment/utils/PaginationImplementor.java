...
public final class PaginationImplementor {
    ...
    public ResultHandle getPage(BytecodeCreator creator, ResultHandle index, ResultHandle size) {
        ...
        return creator.invokeStaticMethod(ofMethod(Page.class, "of", Page.class, int.class, int.class), validIndex,
                validSize);
    }

    private ResultHandle getValidOrDefault(BytecodeCreator creator, ResultHandle value, int minValue,
            int defaultValue) {
    ...
    public ResultHandle getLinks(BytecodeCreator creator, ResultHandle uriInfo, ResultHandle page,
        ...
        ResultHandle previousPage = previousPageCreator
                .invokeVirtualMethod(ofMethod(Page.class, "previous", Page.class), page);
        ResultHandle previousPageLink = getLink(previousPageCreator, uriInfo, previousPage, "previous", fieldValues,
                namedQuery);
        previousPageCreator.invokeInterfaceMethod(ofMethod(List.class, "add", boolean.class, Object.class), links,
                previousPageLink);
        ...
        nextPageCreator.invokeInterfaceMethod(ofMethod(List.class, "add", boolean.class, Object.class), links,
                nextPageLink);
        ...
        return creator.invokeInterfaceMethod(ofMethod(List.class, "toArray", Object[].class, Object[].class), links,
                linksArray);
    }
    ...
    private ResultHandle getLink(BytecodeCreator creator, ResultHandle uriInfo, ResultHandle page, String rel,
        ...
        creator.invokeInterfaceMethod(ofMethod(Link.Builder.class, "rel", Link.Builder.class, String.class), builder,
                creator.load(rel));
        return creator.invokeInterfaceMethod(ofMethod(Link.Builder.class, "build", Link.class, Object[].class), builder,
                creator.newArray(Object.class, 0));
    }

    /**
     * Build a {@link URI} for the given page. Takes the absolute path from the given {@link UriInfo} and appends page
     * and size query parameters from the given {@link Page}.
     *
     * @param creator
     *        a bytecode creator to be used for code generation
     * @param uriInfo
     *        a {@link UriInfo} to be used for the absolute path extraction
     * @param page
     *        a {@link Page} to be used for getting page number and size
     * @param namedQuery
     *        a custom query
     *
    ...
    private ResultHandle getPageUri(BytecodeCreator creator, ResultHandle uriInfo, ResultHandle page,
            Map<String, ResultHandle> fieldValues, ResultHandle namedQuery) {
        ResultHandle uriBuilder = creator
                .invokeInterfaceMethod(ofMethod(UriInfo.class, "getAbsolutePathBuilder", UriBuilder.class), uriInfo);
        ...
        creator.invokeVirtualMethod(
                ofMethod(UriBuilder.class, "queryParam", UriBuilder.class, String.class, Object[].class), uriBuilder,
                creator.load("page"), creator.marshalAsArray(Object.class, index));

        // Add size query parameter
        ResultHandle size = creator.readInstanceField(FieldDescriptor.of(Page.class, "size", int.class), page);
        creator.invokeVirtualMethod(
                ofMethod(UriBuilder.class, "queryParam", UriBuilder.class, String.class, Object[].class), uriBuilder,
                creator.load("size"), creator.marshalAsArray(Object.class, size));

        BytecodeCreator existNamedQuery = creator.ifNotNull(namedQuery).trueBranch();
        existNamedQuery.invokeVirtualMethod(
                ofMethod(UriBuilder.class, "queryParam", UriBuilder.class, String.class, Object[].class), uriBuilder,
                existNamedQuery.load("namedQuery"), existNamedQuery.marshalAsArray(Object.class, namedQuery));
        ...
        return creator.invokeVirtualMethod(ofMethod(UriBuilder.class, "build", URI.class, Object[].class), uriBuilder,
                creator.newArray(Object.class, 0));
    }
    ...
    private ResultHandle getLastPage(BytecodeCreator creator, ResultHandle page, ResultHandle pageCount) {
        ResultHandle pageNumber = creator.invokeStaticMethod(
                ...
                creator.invokeStaticMethod(ofMethod(Integer.class, "sum", int.class, int.class, int.class), pageCount,
                        creator.load(-1)),
                creator.load(0));
        return creator.invokeVirtualMethod(ofMethod(Page.class, "index", Page.class, int.class), page, pageNumber);
    }
    ...
    private BranchResult isTheSamePage(BytecodeCreator creator, ResultHandle page, ResultHandle anotherPage) {
        ResultHandle index = creator.readInstanceField(FieldDescriptor.of(Page.class, "index", int.class), page);
        ResultHandle anotherIndex = creator.readInstanceField(FieldDescriptor.of(Page.class, "index", int.class),
                anotherPage);
