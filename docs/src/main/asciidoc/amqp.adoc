...
IMPORTANT: If you want to use RabbitMQ, you need to enable AMQP 1.0 in the RabbitMQ broker.
Check the https://smallrye.io/smallrye-reactive-messaging/smallrye-reactive-messaging/3.5/amqp/amqp.html#amqp-rabbitmq[connecting to RabbitMQ] documentation.
