...
You can have this provider registered as described in the link:security-customization#bouncy-castle[BouncyCastle] or link:security-customization#bouncy-castle-fips[BouncyCastle FIPS] sections.
