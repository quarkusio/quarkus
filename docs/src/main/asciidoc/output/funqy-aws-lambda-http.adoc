...
If you want to allow HTTP clients to invoke on your Funqy functions on AWS Lambda, {product-name-first} allows you to expose multiple
...
Jakarta REST, Spring MVC, or Vert.x Web Reactive Route xref:aws-lambda-http.adoc[support] instead.  They also work with {product-name} and AWS Lambda.
