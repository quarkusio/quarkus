...
public class QuarkusMultipartResponseDecoder {
    ...
    public void removeHttpDataFromClean(InterfaceHttpData data) {
        ...
        factory.removeHttpDataFromClean(response, data);
    }
    ...
    private static boolean loadDataMultipartOptimized(ByteBuf undecodedChunk, String delimiter, HttpData httpData) {
        ...
        int posDelimiter = QuarkusHttpPostBodyUtil.findDelimiter(undecodedChunk, startReaderIndex, bdelimiter, true);
        if (posDelimiter < 0) {
    ...
    private static String[] splitMultipartHeader(String sb) {
        ...
        int valueStart;
        int valueEnd;
        nameStart = QuarkusHttpPostBodyUtil.findNonWhitespace(sb, 0);
        ...
        valueStart = QuarkusHttpPostBodyUtil.findNonWhitespace(sb, colonEnd);
        valueEnd = QuarkusHttpPostBodyUtil.findEndOfString(sb);
