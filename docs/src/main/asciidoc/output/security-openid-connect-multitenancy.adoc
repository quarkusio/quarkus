...
If you already have your {product-name-first} project configured, you can add the `oidc` extension
...
In fact, this is how {product-name} OIDC resolves static custom tenants itself if no custom `TenantResolver` is registered.
