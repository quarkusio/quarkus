...
public class TlsServerWithNamedConfigTest {
    ...
    static final QuarkusUnitTest config = new QuarkusUnitTest()
            ...
            .overrideConfigKey("quarkus.tls.http.key-store.p12.path", "server-keystore.pkcs12")
            .overrideConfigKey("quarkus.tls.http.key-store.p12.password", "secret")
