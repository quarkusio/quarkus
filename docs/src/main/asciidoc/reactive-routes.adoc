...
[source,java]
----
@Route(methods = Route.HttpMethod.POST, path = "/post", type = Route.HandlerType.BLOCKING)
...
[source, java]
----
@Route(path = "/accounts/:id", methods = Route.HttpMethod.GET)
void getAccount(RoutingContext ctx) {
  ...
}

@Route(path = "/accounts/me", methods = Route.HttpMethod.GET)
...
[source, java]
----
@Route(path = "/accounts/:id", methods = Route.HttpMethod.GET, order = 2)
void getAccount(RoutingContext ctx) {
  ...
}

@Route(path = "/accounts/me", methods = Route.HttpMethod.GET, order = 1)
void getCurrentUserAccount(RoutingContext ctx) {
  ...
}
----
