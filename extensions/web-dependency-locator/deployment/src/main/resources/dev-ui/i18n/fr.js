...
export const templates = {
    ...
    'quarkus-web-dependency-locator-generated-importmap': 'Voici la carte d\'importation générée :',
    'quarkus-web-dependency-locator-open-link': str`Ouvrir le lien vers ${0} dans un nouvel onglet`,
    'quarkus-web-dependency-locator-copy-link-aria': str`Copier le lien vers ${0} dans le presse-papier`,
    'quarkus-web-dependency-locator-copy-link-title': str`Copier le lien vers ${0} dans le presse-papiers`,
    'quarkus-web-dependency-locator-url-copied': str`URL pour ${0} copié dans le presse-papiers`
};
