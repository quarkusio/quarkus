...
/**
 * This build item aims to be used by extensions to generate static resources. <br>
 * Those resources will be served on the given {@link GeneratedStaticResourceBuildItem#endpoint}. It is NOT necessary to
 * create the file on disk. <br>
 * Behind the scenes the build step will take care of add those resources to the final build, through
 * {@link AdditionalStaticResourceBuildItem}, {@link NativeImageResourceBuildItem} and
 * {@link io.quarkus.deployment.builditem.GeneratedResourceBuildItem} build items. <br>
...
public final class GeneratedStaticResourceBuildItem extends MultiBuildItem {
     ...
     *
     * @param endpoint
     *        the endpoint from the {@code '{quarkus.http.root-path}'} for this generated static resource. It should
     *        be prefixed with {@code '/'}
     * @param content
     *        the content of this generated static resource
     */
