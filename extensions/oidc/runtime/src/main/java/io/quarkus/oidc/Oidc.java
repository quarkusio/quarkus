...
/**
 * A CDI event that facilitates programmatic OIDC tenant setup. OIDC tenants must be created from an observer method
...
public interface Oidc {
     ...
     *
     * @param authServerUrl
     *        {@link OidcTenantConfig#authServerUrl()}
     */
     ...
     *        {@link OidcTenantConfig#authServerUrl()}
     * @param clientId
     *        {@link OidcTenantConfig#clientId()}
     * @param clientSecret
     *        {@link OidcClientCommonConfig.Credentials#secret()}
     */
