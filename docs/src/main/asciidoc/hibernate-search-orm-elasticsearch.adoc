...
include::{generated-config-doc-dir}/quarkus-hibernate-search-orm-elasticsearch.adoc[leveloffset=+1, opts=optional]
...
include::{generated-config-doc-dir}/quarkus-hibernate-search-orm-outbox-polling.adoc[leveloffset=+1, opts=optional]
