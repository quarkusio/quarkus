...
public class ClientProxyGeneratorTest {
    ...
    public void testGenerator() throws IOException {
        ...
        deployment.getBeans().stream().filter(bean -> bean.getScope().isNormal()).forEach(bean -> {
            for (Resource resource : beanGenerator.generate(bean, new AnnotationLiteralProcessor(BeanProcessor.DEFAULT_NAME, true))) {
                proxyGenerator.generate(bean, resource.getFullyQualifiedName());
            }
        });
