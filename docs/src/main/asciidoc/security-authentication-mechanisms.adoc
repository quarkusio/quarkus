...
include::{generated-dir}/quarkus-vertx-http-config-group-form-auth-config.adoc[opts=optional, leveloffset=+1]
include::{generated-dir}/quarkus-vertx-http-config-group-auth-runtime-config.adoc[opts=optional, leveloffset=+1]
