...
Please follow a link:https://foivos.zakkak.net/tutorials/working-with-randoms-native-images/[Working with Random/SplittableRandom instances in GraalVM and Mandrel native images] tutorial for more information.
