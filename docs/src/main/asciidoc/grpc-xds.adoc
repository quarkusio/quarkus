...
include::{generated-config-doc-dir}/quarkus-grpc_quarkus.grpc.server.xds.adoc[opts=optional, leveloffset=+1]
...
include::{generated-config-doc-dir}/quarkus-grpc_quarkus.grpc.clients.-client-name-.xds.adoc[opts=optional, leveloffset=+1]
