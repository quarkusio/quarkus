...
This guide demonstrates how your {product-name-first} application can utilize SmallRye Reactive Messaging to interact with RabbitMQ.
...
{product-name} has built-in capabilities to deal with JSON RabbitMQ messages.
...
{product-name} starts a RabbitMQ broker automatically, configures the application and shares the broker instance between different applications.
...
This guide has shown how you can interact with RabbitMQ using {product-name}.
