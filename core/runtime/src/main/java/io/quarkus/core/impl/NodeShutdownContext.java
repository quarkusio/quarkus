...
public final class NodeShutdownContext implements ShutdownContext, Runnable {
    ...
    /**
     * Whether this context was registered during the static-init phase.
     */
    ...
    /**
     * Construct a new instance, defaulting to static-init phase.
     */
    public NodeShutdownContext() {
        this(true);
    }
     ...
     *
     * @param staticInit whether this context operates during the static-init phase
     */
    public NodeShutdownContext(boolean staticInit) {
    ...
    public void addLastShutdownTask(Runnable runnable) {
        ...
        // delegate to the global collector using the phase of this context
        if (staticInit) {
            LastShutdownTasks.addStatic(runnable);
        } else {
            LastShutdownTasks.addRuntime(runnable);
        }
    }
