...
////
= Quarkus - Reactive Database Clients

include::./attributes.adoc[]
:config-file: application.properties

The Reactive Database Clients have a straightforward API focusing on scalability and low-overhead.
Currently, the following database servers are supported:

* Postgres
* MySQL

In this guide, you will learn how to implement a simple CRUD application exposing data stored in *Postgres* over a RESTful API.
