...
public abstract class QuarkusAugmentTask extends QuarkusTask {
    ...
    protected List<String> ignoredEntries = new ArrayList<>();
    protected Manifest manifest = new Manifest();

    private Properties applicationProperties = new Properties();

    public QuarkusAugmentTask(String description) {
        super(description);
    }
    ...
    public void withAugmentAction(Consumer<AugmentAction> consumer) {
        ...
        try (CuratedApplication appCreationContext = QuarkusBootstrap.builder()
            ...
            AugmentAction action = appCreationContext.createAugmentor(
                    "io.quarkus.deployment.pkg.builditem.ProcessInheritIODisabled$Factory",
    ...
    protected void exportCustomManifestProperties(Properties buildSystemProperties) {
    ...
    protected String expandConfigurationKey(String shortKey) {
