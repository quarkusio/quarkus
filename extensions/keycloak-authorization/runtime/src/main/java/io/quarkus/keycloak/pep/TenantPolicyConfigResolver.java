...
/**
 * A tenant resolver is responsible for resolving the {@link KeycloakPolicyEnforcerTenantConfig} for tenants,
 * dynamically.
 */
public interface TenantPolicyConfigResolver {
     ...
     *        routing context; nullable
     * @param tenantConfig
     *        tenant config; never null
     * @param requestContext
     *        request context; never null
     *
