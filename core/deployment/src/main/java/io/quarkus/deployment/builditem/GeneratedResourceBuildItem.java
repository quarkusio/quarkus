...
public final class GeneratedResourceBuildItem extends MultiBuildItem {
    ...
    /**
     * This option is only meant to be set by extensions that also generated the resource on the file system and must
     * rely on Quarkus not getting in the way of loading that resource. It is currently used by Kogito to get serving of
     * static resources in Dev Mode by Vert.x <br>
     *
