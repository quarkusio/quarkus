 ...
 * added by creating an extension that produces a SecurityRealmBuildItem for the realm. Additional authentication
 ...
 * {@linkplain io.undertow.security.api.AuthenticationMechanismFactory}. TODO: The handling of the configuration to
 * SecurityRealm instance creation/loading is clumsy to not being able to have a config object annotated
...
class ElytronDeploymentProcessor {
     ...
     *
     * @param recorder
     *        - the runtime recorder class used to access runtime behaviors
     * @param realms
     *        - the previously created SecurityRealm runtime values
     *
