 ...
 * directly but extend {@link PanacheMongoEntity} instead.
 *
...
public abstract class PanacheMongoEntityBase {
     ...
     */
    @GenerateBridge
    public static <T extends PanacheMongoEntityBase> PanacheQuery<T> find(String query, Sort sort,
     ...
     */
    @GenerateBridge
    public static <T extends PanacheMongoEntityBase> Stream<T> stream(String query, Sort sort,
            Map<String, Object> params) {
        throw INSTANCE.implementationInjectionMissing();
    }
     ...
     *
     * @param update
     *        the update document, as a {@link Bson}.
     *
     * @return a new {@link io.quarkus.mongodb.panache.common.PanacheUpdate} instance for the given update document
     *
     * @see #update(String, Object...)
