...
public interface OpenApiDocumentConfig {
    ...
    /**
     * The path at which to register the OpenAPI Servlet. For the default document, the default value is simply openapi. For any
     * named OpenAPI documents, the default is to add the name of the document as suffix in the pattern:
     * openapi-<document-name>. If you set a non default value, then your custom value is used without any appending any
     * suffixes.
     */
    @WithDefault(SmallRyeOpenApiConfig.DEFAULT_PATH)
    String path();
    ...
    /**
     * The name of the file in case it is being stored. For the default document, the default value is simply openapi. For any
     * named OpenAPI documents, the default is to add the name of the document as suffix in the pattern:
     * openapi-<document-name>. If you set a non default value, then your custom value is used without any appending any
     * suffixes.
     */
    @WithDefault(SmallRyeOpenApiConfig.DEFAULT_STORE_SCHEMA_FILE_NAME)
     ...
     */
    Optional<SmallRyeOpenApiConfig.SecurityScheme> securityScheme();
    ...
    /**
     * Profiles which explicitly exclude operations. If set, any operation without a matching profile is included. Excludes
     * are considered before inclusions.
     */
