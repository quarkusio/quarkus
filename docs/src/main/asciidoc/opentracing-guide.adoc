...
2 and 3) Setup a sampler, that uses a constant sampling strategy and samples all requests. Set sampler-param to somewhere between 0 and 1, if you do not wish to sample all requests.
