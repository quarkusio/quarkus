...
public interface BuildProvider {
     ...
     *
     * @param builder
     *        the deployer chain builder (not {@code null})
     *
    ...
    /**
     * Run any preparatory steps required for a given deployment execution. This may include providing initial resource
     * values.
     *
     * @param builder
     *        the deployment execution builder (not {@code null})
     */
