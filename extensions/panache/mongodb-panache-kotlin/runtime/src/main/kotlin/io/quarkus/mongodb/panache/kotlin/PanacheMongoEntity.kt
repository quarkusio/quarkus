 ...
 * as well as all the useful methods from [PanacheMongoEntityBase].
 *
 * If you want a custom ID type or strategy, you can directly extend [PanacheMongoEntityBase]
 * instead, and write your own ID field. You will still get auto-generated accessors and all the
 * useful methods.
 *
