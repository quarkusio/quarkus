...
image::dev-console-overview.png[alt=Dev UI overview,role="center"]
...
image:dev-console-embedded.png[alt=Dev UI embedded,role="center"]
...
image::dev-console-embedded-file.png[alt=Dev UI embedded.html]
...
image::dev-console-page.png[alt=Dev UI custom page]
...
image::dev-console-interactive.png[alt=Dev UI interactive page]
...
image::dev-console-message.png[alt=Dev UI message]
