...
interface Service {
 ...
 class Client {
    ...
    void printServiceName() {
       // This will print "bar" if the property "service.foo.enabled" is set to "false"
       // If "service.foo.enabled" is set to "true" then service.get() would result in AmbiguousResolutionException
