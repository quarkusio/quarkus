...
/**
 * REST data Panache resource that uses {@link PanacheRepositoryBase} instance for data access and exposes it as a
 * JAX-RS resource.
 * <p>
 ...
 *
 * @param <Repository>
 *        {@link PanacheRepositoryBase} instance that should be used for data access.
 * @param <Entity>
 *        Entity type that is handled by this resource and the linked {@link PanacheRepositoryBase} instance.
 * @param <ID>
