...
////
= Quarkus - Central log management (Graylog, Logstash, Fluentd)

include::./attributes.adoc[]
:es-version: 6.8.2

This guide explains how you can send your logs to a central logging system like Graylog, Logstash (inside the Elastic Stack or ELK - Elasticsearch, Logstash, Kibana) or
...
- For demonstration purpose, we create an endpoint that does nothing but log a sentence. You don't need to do this inside your application.
