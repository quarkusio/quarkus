...
public class ValidationQueryTest {
    ...
    static final QuarkusUnitTest config = new QuarkusUnitTest()
            ...
            .overrideRuntimeConfigKey("quarkus.datasource.jdbc.url",
                    "jdbc:h2:tcp://localhost/mem:default?queryLog=%s;DATABASE_EVENT_LISTENER=io.quarkus.agroal.test.QueryLoggingH2DBEventListener" // Register
                            // QueryLoggingH2DBEventListener
