...
Open a xref:dev-ui.adoc[Dev UI] available at http://localhost:8080/q/devui-v1[/q/devui-v1] and click on a `Provider: Keycloak` link in an `OpenID Connect` `Dev UI` card.
