...
@QuarkusTest
@TestProfile(HttpWithTLSWithTrustAllWithCompressionTest.Profile.class)
public class HttpWithTLSWithTrustAllWithCompressionTest extends AbstractExporterTest {
