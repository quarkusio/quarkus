...
public class AutoAddOpenApiEndpointFilterTest {
    ...
    public void testOpenApiFilterResource() {
        ...
        RestAssured.given().header("Accept", "application/json").when().get(OPEN_API_PATH).then()
                .header("Content-Type", "application/json;charset=UTF-8").body("paths", Matchers.hasKey(OPEN_API_PATH))
    ...
    public void testSpecificYamlEndpointFilterResource() {
        ...
        RestAssured.given().header("Accept", "application/json").when().get(OPEN_API_PATH).then()
                .header("Content-Type", "application/json;charset=UTF-8").body("paths", Matchers.hasKey(yamlPath))
    ...
    public void testSpecificYmlEndpointFilterResource() {
        ...
        RestAssured.given().header("Accept", "application/json").when().get(OPEN_API_PATH).then()
                .header("Content-Type", "application/json;charset=UTF-8").body("paths", Matchers.hasKey(ymlPath))
    ...
    public void testSpecificJsonEndpointFilterResource() {
        ...
        RestAssured.given().header("Accept", "application/json").when().get(OPEN_API_PATH).then()
                .header("Content-Type", "application/json;charset=UTF-8").body("paths", Matchers.hasKey(jsonPath))
