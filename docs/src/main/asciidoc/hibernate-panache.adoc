...
WARNING: This extension is currently in preview. It is experimental, so its API may change, in particular names of
...
----
// Import the Hibernate with Panache extension
implementation("io.quarkus:quarkus-hibernate-panache")
