...
Dev Services for Kubernetes implements a _service discovery_ mechanism for your multiple {product-name-first} applications running in dev mode to share a single cluster.
