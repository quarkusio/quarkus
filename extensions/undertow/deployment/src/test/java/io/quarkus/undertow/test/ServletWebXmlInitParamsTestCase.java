...
public class ServletWebXmlInitParamsTestCase {
    ...
    static final String WEB_XML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" + "\n" + "<web-app version=\"3.0\"\n"
            ...
            + WebXmlInitParamsFilter.class.getName() + "</filter-class>\n" + "  <init-param>\n"
    ...
    static QuarkusUnitTest runner = new QuarkusUnitTest()
            .withApplicationRoot((jar) -> jar.addClasses(WebXmlInitParamsServlet.class, WebXmlInitParamsFilter.class)
                    .addAsManifestResource(new StringAsset(WEB_XML), "web.xml"));

    @Test
    public void testWebXmlServlet() {
        RestAssured.when().get("/mapped").then().statusCode(200)
