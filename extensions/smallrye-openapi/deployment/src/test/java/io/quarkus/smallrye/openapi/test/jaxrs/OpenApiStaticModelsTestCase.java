...
public class OpenApiStaticModelsTestCase {
    ...
    static QuarkusUnitTest runner = new QuarkusUnitTest()
            .withApplicationRoot((jar) -> jar.addClasses(OpenApiResource.class, ResourceBean.class)
                    ...
                    .addAsResource(new StringAsset("quarkus.smallrye-openapi.additional-docs-directory=" + directory),
    ...
    public void testMultipleStaticFiles() throws IOException {
        ...
        RestAssured.given().header("Accept", "application/json").when().get("/q/openapi").then()
                .body("paths.'/openapi'.get.operationId", Matchers.equalTo("someOperation")).and()
                .body("paths.'/openapi2'.get.operationId", Matchers.equalTo("someOperation2")).and()
                .body("paths.'/openapi3'.get.operationId", Matchers.equalTo("someOperation3"));
    }
}
