...
public class GaugeCdiTest {
    ...
    static final QuarkusUnitTest TEST = new QuarkusUnitTest().setArchiveProducer(() -> ShrinkWrap
            .create(JavaArchive.class).addPackage(InMemoryMetricExporter.class.getPackage())
    ...
    void gauge() throws InterruptedException {
        meterBean.getMeter().gaugeBuilder("jvm.memory.total").setDescription("Reports JVM memory usage.")
                .setUnit("byte")
