...
include::{generated-dir}/config/quarkus-core-log-config.adoc[opts=optional, leveloffset=+1]
...
NOTE: This snippet assumes that your application POM is configured in the manner described in the
