...
MongoDB with Panache provides active record style entities (and repositories) like you have in xref:hibernate-orm-panache.adoc[] and focuses on making your entities trivial and fun to write in Quarkus.
