...
Once you have your {product-name-first} Maven project configured you can add the `narayana-lra` extension
...
dependencies. A {product-name} quickstart will be provided to show how to do this, or you can
