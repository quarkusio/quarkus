...
/**
 * Event that is fired before shutdown and can be inspected for shutdown cause. See
 * {@link ShutdownEvent#isStandardShutdown()} This event is observed as follows: <code><pre>
...
public class ShutdownEvent extends jakarta.enterprise.event.Shutdown {
     ...
     * <p>
     * All other cases are non-standard - {@code SIGINT}, {@code SIGTERM}, {@code System.exit(n} and so on. Sending
     * {@code CTRL + C} to running app in terminal is also non-standard shutdown.
     *
    ...
    enum ShutdownReason {
        /**
         * When {@code main()} method exits or when either {@link Quarkus#asyncExit()} or {@link Quarkus#blockingExit()}
         * was executed
         */
        STANDARD,
        /**
         * All other cases - {@code SIGINT}, {@code SIGTERM}, {@code System.exit(n} and so on. This includes sending
         * {@code CTRL + C} to running app in terminal.
         */
        NON_STANDARD;
    }
}
