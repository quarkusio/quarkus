 ...
 * this repository will gain you the exact same useful methods that are on {@link ReactivePanacheMongoEntityBase}.
 * Unless you have a custom ID strategy, you should not implement this interface directly but implement
 * {@link ReactivePanacheMongoRepository} instead.
 *
 * @param <Entity>
...
public interface ReactivePanacheMongoRepositoryBase<Entity, Id> {
     ...
     */
    @GenerateBridge
    default ReactivePanacheQuery<Entity> find(Bson query) {
        throw INSTANCE.implementationInjectionMissing();
    }
     ...
     */
    @GenerateBridge
    default ReactivePanacheQuery<Entity> find(Bson query, Bson sort) {
        throw INSTANCE.implementationInjectionMissing();
    }
     ...
     */
    @GenerateBridge
    default Uni<List<Entity>> list(Bson query) {
        throw INSTANCE.implementationInjectionMissing();
    }
     ...
     */
    @GenerateBridge
    default Uni<List<Entity>> list(Bson query, Bson sort) {
        throw INSTANCE.implementationInjectionMissing();
    }
     ...
     */
    @GenerateBridge
    default Multi<Entity> stream(Bson query) {
        throw INSTANCE.implementationInjectionMissing();
    }
     ...
     */
    @GenerateBridge
    default Multi<Entity> stream(Bson query, Bson sort) {
        throw INSTANCE.implementationInjectionMissing();
    }
     ...
     */
    @GenerateBridge
    default Uni<Long> count(Bson query) {
        throw INSTANCE.implementationInjectionMissing();
    }
     ...
     */
    @GenerateBridge
    default Uni<Long> delete(Bson query) {
        throw INSTANCE.implementationInjectionMissing();
    }
     ...
     */
    @GenerateBridge
    default io.quarkus.mongodb.panache.common.reactive.ReactivePanacheUpdate update(String update,
