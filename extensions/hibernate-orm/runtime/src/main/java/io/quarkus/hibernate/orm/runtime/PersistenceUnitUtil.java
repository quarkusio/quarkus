...
public class PersistenceUnitUtil {
    ...
    public static String persistenceUnitInactiveReasonDeactivated(String puName, Optional<String> datasourceName) {
        return persistenceUnitInactiveReasonDeactivated(puName, puName, datasourceName);
    }

    public static String persistenceUnitInactiveReasonDeactivated(String puName, String puConfigName,
                ...
                "Persistence unit '%s' was deactivated through configuration properties."
                        ...
                        + (datasourceName.isPresent()
                                ? String.format(Locale.ROOT, " and configure datasource '%s'."
                                        ...
                                        datasourceName.get())
                                : "."),
                puName, puPropertyKey(puConfigName, "active"));
    }
}
