...
/**
 * REST data Panache resource that uses {@link PanacheMongoEntityBase} instance for data access and exposes it as a
 * JAX-RS resource.
 * <p>
 ...
 *
 * @param <Entity>
 *        {@link PanacheMongoEntityBase} that is handled by this resource.
 * @param <ID>
 *        ID type of the entity.
 */
public interface PanacheMongoEntityResource<Entity extends PanacheMongoEntityBase, ID>
