...
import io.quarkus.spiffe.client.WorkloadKeystoreOptions;
import io.quarkus.spiffe.client.WorkloadTruststoreOptions;
...
final class SpiffeClientImpl implements SpiffeClient {
    ...
    private static WorkloadCertificateDocument toWorkloadCertificate(X509SVIDResponse response)
        ...
        var keyMaterial = new WorkloadKeystoreOptionsImpl(unmodifiableList(certChain), privateKey);
        var trustMaterial = new WorkloadTruststoreOptionsImpl(unmodifiableList(trustBundle));
    ...
    private record WorkloadCertificateDocumentImpl(String subject, WorkloadKeystoreOptionsImpl keystoreOptions,
            WorkloadTruststoreOptionsImpl truststoreOptions) implements WorkloadCertificateDocument {
    }

    private record WorkloadKeystoreOptionsImpl(List<X509Certificate> certificateChain,
            PrivateKey privateKey) implements WorkloadKeystoreOptions {
    ...
    private record WorkloadTruststoreOptionsImpl(List<X509Certificate> trustBundle) implements WorkloadTruststoreOptions {
