...
include::{generated-dir}/quarkus-management-management-management-interface-build-time-config.adoc[leveloffset=+1, opts=optional]

include::{generated-dir}/quarkus-management-management-management-interface-configuration.adoc[leveloffset=+1, opts=optional]
