...
Please refer to the native-and-ssl.html[Using SSL With Native Executables] guide for more information.
...
Check the link:vertx.html[Using Vert.x guide] for further details about these different APIs and how to select the most suitable for you.
