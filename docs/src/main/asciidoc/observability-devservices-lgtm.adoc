...
By default Quarkus lets Testcontainers expose random ports for Grafana and OTel, but you can force the usage of fixed ports via setting the ports yourself - but then be aware of port conflicts.
