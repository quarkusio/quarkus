...
class RestClientReactiveProcessor {
    ...
    // Gizmo2 method descriptors for registerProvidersFromAnnotations
    private static final MethodDesc THREAD_CURRENT_THREAD = MethodDesc.of(Thread.class, "currentThread", Thread.class);
    private static final MethodDesc GET_CONTEXT_CLASS_LOADER = MethodDesc.of(Thread.class, "getContextClassLoader",
            ClassLoader.class);
    private static final MethodDesc CLASS_FOR_NAME = MethodDesc.of(Class.class, "forName", Class.class, String.class,
            boolean.class, ClassLoader.class);
    private static final MethodDesc MAP_PUT_METHOD = MethodDesc.of(Map.class, "put", Object.class, Object.class, Object.class);
    ...
    private Expr loadClassFromTCCL(BlockCreator bc, String className) {
        Expr currentThread = bc.invokeStatic(THREAD_CURRENT_THREAD);
        Expr tccl = bc.invokeVirtual(GET_CONTEXT_CLASS_LOADER, currentThread);
        return bc.invokeStatic(CLASS_FOR_NAME, Const.of(className), Const.of(false), tccl);
    }
