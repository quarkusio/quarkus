...
public class MultipleResourceImplementInterfaceTest {
    ...
    public void hello() {
        ...
        when().get("/hello/shared/1").then().statusCode(200).body(is("1"));
    }

    @Test
    public void hello2() {
        when().get("/hello2").then().statusCode(200).body(is("hello2"));

        when().get("/hello2/shared/h2").then().statusCode(200).body(is("h2"));
    }
