...
public final class ReactivePersistenceProviderSetup {
    ...
    public static void registerRuntimePersistenceProvider(HibernateOrmRuntimeConfig hibernateOrmRuntimeConfig,
        ...
        // GraalVM native image compilation runs through FastBootHibernatePersistenceProvider even though
        // com.arjuna.ats.jta.TransactionManager is not on the classpath.
        // Better check for availability to avoid that
        Class<?> transactionManager;
        try {
            transactionManager = Class.forName("com.arjuna.ats.jta.TransactionManager");
