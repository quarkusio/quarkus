...
public final class HibernateLogFilterBuildStep {
    ...
    void setupLogFilters(BuildProducer<LogCleanupFilterBuildItem> filters) {
        ...
        // 1. We don't implement the retrieval of information in
        // QuarkusConnectionProvider
        // 2. It's currently being logged even at static init when there is no
        // connection
        ...
        // This "deprecation" warning isn't practical for the specific Quarkus needs, as
        // it reminds users they don't need
        // to set the 'hibernate.dialect' property, however it's being set by Quarkus
        // buildsteps so they can't avoid it.
        // Ignore for now, perhaps remove it upstream however this may make sense for
        // other Hibernate users.
        // Wondering if we should have the Quarkus build differentiate between an
        // explicitly set vs an inferred Dialect
        // property (we have a custom DialectFactory already so this could be trivial),
        // however even in this case ORM
        // can't guess things since there is no connection, so even if we did so, this
        // message wouldn't be applicable.
