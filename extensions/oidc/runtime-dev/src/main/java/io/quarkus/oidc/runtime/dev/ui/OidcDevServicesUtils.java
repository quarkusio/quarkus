...
public final class OidcDevServicesUtils {
    ...
    public static WebClient createWebClient(Vertx vertx) {
        ...
        //We can use quarkus.oidc.proxy.* properties, or maybe can we use Java proxy System properties (http.proxyHost , ...)?
        //Don't know if there's a better way to get config valuees here ....
