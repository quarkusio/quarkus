...
import org.jboss.quarkus.arc.processor.DotNamesTest.Nested.NestedNested;
...
public class DotNamesTest {
    ...
    public void testSimpleName() throws IOException {
        ...
        assertEquals("DotNamesTest$Nested", DotNames.simpleName("org.jboss.quarkus.arc.processor.DotNamesTest$Nested"));
    }
