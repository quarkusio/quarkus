...
import io.quarkus.jfr.runtime.rest.AbstractHttpReactiveStartEvent;
import jdk.jfr.Category;
import jdk.jfr.Label;
import jdk.jfr.StackTrace;

@Label("Tracing HTTP Reactive Start")
@Category({ "Quarkus", "REST" })
@StackTrace(false)
public class TracingHttpReactiveStartEvent extends AbstractHttpReactiveStartEvent<TracingRequestId> {
