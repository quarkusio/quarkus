...
You can also https://infinispan.org/downloads/releases[download] {infinispan-version} Server bare metal distribution and run the following command
...
the https://infinispan.org/tutorials/remote-cross-site-replication/[Cross Site Replication]
