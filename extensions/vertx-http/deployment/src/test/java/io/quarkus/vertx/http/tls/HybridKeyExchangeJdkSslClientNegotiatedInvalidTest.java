...
public class HybridKeyExchangeJdkSslClientNegotiatedInvalidTest extends AbstractHybridKeyExchangeTest {
    ...
    /*
     * On jdk < 27, no pq-compliant groups are available. As such, vertx doesn't accept to start a server with a
     * client-negotiated policy when jdkssl is forced on jdk < 27.
