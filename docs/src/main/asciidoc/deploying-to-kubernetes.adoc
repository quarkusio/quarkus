...
include::{generated-config-doc-dir}/quarkus-kubernetes_quarkus.kubernetes.adoc[opts=optional, leveloffset=+1]
...
:no-duration-note: true
include::{generated-config-doc-dir}/quarkus-kubernetes-client.adoc[opts=optional, leveloffset=+1]
...
.OpenShift
:no-duration-note: true
include::{generated-config-doc-dir}/quarkus-kubernetes_quarkus.openshift.adoc[opts=optional, leveloffset=+1]
...
.Knative
:no-duration-note: true
include::{generated-config-doc-dir}/quarkus-kubernetes_quarkus.knative.adoc[opts=optional, leveloffset=+1]
