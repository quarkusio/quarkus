...
# To change the path type of the generated Ingress rule. By default, it's "Prefix".
# Use "ImplementationSpecific" for paths that the Ingress controller interprets, such as regular expressions.
quarkus.kubernetes.ingress.path-type=Prefix
----
