...
* how to use xref:gradle-tooling.adoc[Gradle with the `io.quarkus` plugin] or the preview xref:gradle-application-plugin.adoc[`io.quarkus.application` plugin] as a build tool
...
* xref:gradle-tooling.adoc[Gradle with the `io.quarkus` plugin]
* xref:gradle-application-plugin.adoc[Gradle with the `io.quarkus.application` plugin (preview)]
