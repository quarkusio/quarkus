...
public final class SmokeTestUtils {
    ...
    public static <T> void testSimplePersistRetrieveUpdateDelete(EntityManager entityManager, Class<T> entityType,
            Function<String, T> constructor, Function<T, Long> idGetter, BiConsumer<T, String> setter,
        ...
        assertThat(retrievedEntity).extracting(getter).isEqualTo(initialName);
        ...
        assertThat(retrievedEntity).extracting(getter).isEqualTo(updatedName);
