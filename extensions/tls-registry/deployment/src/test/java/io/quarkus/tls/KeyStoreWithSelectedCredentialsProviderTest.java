...
public class KeyStoreWithSelectedCredentialsProviderTest {

    private static final String configuration = """
            quarkus.tls.foo.key-store.p12.path=target/certs/test-credentials-provider-keystore.p12
            quarkus.tls.foo.key-store.credentials-provider.name=tls
            quarkus.tls.foo.key-store.credentials-provider.bean-name=my-provider
            """;
