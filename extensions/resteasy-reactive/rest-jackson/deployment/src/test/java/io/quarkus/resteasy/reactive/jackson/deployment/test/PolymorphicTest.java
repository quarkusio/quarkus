...
public class PolymorphicTest {
    ...
    public void testSingle() {
        RestAssured.get("/poly/single").then().statusCode(200).contentType("application/json")
                .body(Matchers.is("{\"type\":\"sub\"}"));
    }

    @Test
    public void testMany() {
        RestAssured.get("/poly/many").then().statusCode(200).contentType("application/json")
