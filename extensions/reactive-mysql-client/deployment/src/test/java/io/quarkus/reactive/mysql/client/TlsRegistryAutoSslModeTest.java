 ...
 * MySQL auto-defaults to {@code SslMode.REQUIRED}. The startup fails because the named TLS config
 * doesn't exist, but reaching that error proves the TLS code path was entered.
 */
public class TlsRegistryAutoSslModeTest {
    ...
    static final QuarkusExtensionTest config = new QuarkusExtensionTest()
            ...
            .overrideConfigKey("quarkus.datasource.reactive.url", "mysql://localhost:3306/hibernate_orm_test")
