...
@QuarkusTestResource(value = FactoryKubernetesFixturesTestResource.class, restrictToAnnotatedClass = true)
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.TYPE)
public @interface WithKubernetesResourcesFromFactory {
    Class<? extends KubernetesResourcesFactory> factory();
