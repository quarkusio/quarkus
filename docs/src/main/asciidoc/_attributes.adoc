...
:db2-default-version: ${db2.default.version}
:db2-image: ${db2.image}
:mariadb-default-version: ${mariadb.default.version}
:mariadb-image: ${mariadb.image}
:mssql-default-version: ${mssql.default.version}
:mssql-image: ${mssql.image}
:mssql-image-aarch64: ${mssql.image.aarch64}
:mysql-default-version: ${mysql.default.version}
:mysql-image: ${mysql.image}
:oracle-default-version: ${oracle.default.version}
:oracle-image: ${oracle.image}
:postgres-default-version: ${postgres.default.version}
...
:jakarta-data-version-major-minor: ${jakarta-data.majorVersion}.${jakarta-data.minorVersion}
// .
