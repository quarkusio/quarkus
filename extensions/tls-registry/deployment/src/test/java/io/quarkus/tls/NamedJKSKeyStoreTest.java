...
public class NamedJKSKeyStoreTest {

    private static final String configuration = """
            quarkus.tls.http.key-store.jks.path=target/certs/test-formats-keystore.jks
            quarkus.tls.http.key-store.jks.password=password
            """;
