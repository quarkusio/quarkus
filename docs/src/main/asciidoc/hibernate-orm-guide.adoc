...
or if you want to reproduce a bug that is based on a specific database entries.
...
Don't forget that you can define different https://quarkus.io/guides/application-configuration-guide#configuration-profiles[configuration profiles]
