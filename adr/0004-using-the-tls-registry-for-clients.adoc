...
WARNING: Using the default configuration is going to create conflict with the server configuration, and it is generally not a good idea to use the same configuration for the client and the server.
