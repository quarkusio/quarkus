...
class EncryptTest {
    ...
    void encrypt() throws Exception {
        ...
        SmallRyeConfig config = new SmallRyeConfigBuilder().addDefaultInterceptors().addDiscoveredSecretKeysHandlers()
    ...
    void keyPlain() throws Exception {
        ...
        config = new SmallRyeConfigBuilder().addDefaultInterceptors().addDiscoveredSecretKeysHandlers()
                .withDefaultValue("my.secret", "${aes-gcm-nopadding::" + secret + "}")
