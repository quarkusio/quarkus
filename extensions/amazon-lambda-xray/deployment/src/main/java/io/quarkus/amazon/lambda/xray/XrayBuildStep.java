...
public class XrayBuildStep {
    ...
    public void process(BuildProducer<ReflectiveClassBuildItem> reflectiveClass,
        ...
        runtimeInitialized
                .produce(new RuntimeInitializedClassBuildItem("com.amazonaws.xray.interceptors.TracingInterceptor"));
        ...
        reflectiveClass.produce(ReflectiveClassBuildItem.builder(
                "com.amazonaws.xray.handlers.config.AWSServiceHandlerManifest", "com.amazonaws.xray.AWSXRay",
                ...
                "com.amazonaws.xray.strategy.sampling.reservoir.Reservoir$AtLeast10", "com.amazonaws.auth.AWS4Signer",
                ...
                "com.amazonaws.xray.entities.ThrowableDescription", "com.amazonaws.xray.entities.SubsegmentImpl",
                "com.amazonaws.xray.entities.EntityImpl", "com.amazonaws.xray.entities.TraceID",
                "com.amazonaws.xray.entities.Cause", "com.amazonaws.xray.entities.SegmentImpl",
                "com.fasterxml.jackson.databind.ser.std.ToStringSerializer").methods().fields().build());

        resource.produce(new NativeImageResourceBuildItem(
                "com/amazonaws/xray/interceptors/DefaultOperationParameterWhitelist.json",
                "com/amazonaws/xray/strategy/sampling/DefaultSamplingRules.json", "com/amazonaws/xray/sdk.properties"));
