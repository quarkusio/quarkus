...
In order to support 100-continue (https://datatracker.ietf.org/doc/html/rfc7231#section-5.1.1) this option needs to be set.
For additional information see https://vertx.io/docs/apidocs/io/vertx/core/http/HttpServerOptions.html#DEFAULT_HANDLE_100_CONTINE_AUTOMATICALLY
