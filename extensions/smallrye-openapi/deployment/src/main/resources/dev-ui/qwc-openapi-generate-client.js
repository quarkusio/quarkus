...
export class QwcOpenapiGenerateClient extends observeState(LitElement) {
  ...
  constructor() {
    ...
    this.languages = [
      { label: 'Quarkus (Java)', value: 'Quarkus', mode: 'java', context: 'This should use the rest-client-jackson extension and the Jakarta namespace (not javax)' },
  ...
  render() {
    return html`
        <div class="into">
            <p class="blurb">
                This tool uses AI to generate client code based on the OpenAPI schema document produced by your Quarkus application at build time. Select or type a technology to begin.
            </p>
  ...
  _renderWarning() {
    return html`<qui-alert level="warning" size="small" permanent showIcon><span>AI can make mistakes. Check responses.</span></qui-alert>`;
  }
