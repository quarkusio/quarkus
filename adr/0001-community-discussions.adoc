...
Contributor/committer are trying to follow new questions and issues - what does he need to track to do that ? today it is a lot and it is all different notification systems and mainly its a big "firehose" with no good ability to filter out what you don't need.
