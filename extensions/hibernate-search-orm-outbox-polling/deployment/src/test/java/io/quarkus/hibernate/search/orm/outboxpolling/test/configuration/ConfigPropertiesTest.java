...
public class ConfigPropertiesTest {
    ...
    static final QuarkusUnitTest config = new QuarkusUnitTest()
            .setArchiveProducer(() -> ShrinkWrap.create(JavaArchive.class).addPackage(IndexedEntity.class.getPackage())
            ...
            .overrideConfigKey("quarkus.hibernate-search-orm.coordination.entity-mapping.agent.catalog",
                    "myagentcatalog")
            ...
            .overrideConfigKey("quarkus.hibernate-search-orm.coordination.entity-mapping.agent.uuid-gen-strategy",
                    "random")
            ...
            .overrideConfigKey("quarkus.hibernate-search-orm.coordination.entity-mapping.outbox-event.table",
                    "myoutboxeventtable")
            .overrideConfigKey(
                    "quarkus.hibernate-search-orm.coordination.entity-mapping.outbox-event.uuid-gen-strategy", "time")
            .overrideConfigKey("quarkus.hibernate-search-orm.coordination.entity-mapping.outbox-event.uuid-type",
                    "binary")
            ...
            .overrideConfigKey("quarkus.hibernate-search-orm.\"pu1\".coordination.entity-mapping.agent.table",
                    "myagenttablepu1")
            .overrideConfigKey(
                    "quarkus.hibernate-search-orm.\"pu1\".coordination.entity-mapping.agent.uuid-gen-strategy", "time")
            ...
            .overrideConfigKey(
                    "quarkus.hibernate-search-orm.\"pu1\".coordination.entity-mapping.outbox-event.uuid-gen-strategy",
                    "random")
            .overrideConfigKey(
                    "quarkus.hibernate-search-orm.\"pu1\".coordination.entity-mapping.outbox-event.uuid-type", "char")
            .overrideConfigKey("quarkus.hibernate-search-orm.\"pu1\".coordination.event-processor.enabled", "false")
            .overrideConfigKey("quarkus.hibernate-search-orm.\"pu1\".coordination.event-processor.shards.total-count",
                    "110")
            .overrideConfigKey("quarkus.hibernate-search-orm.\"pu1\".coordination.event-processor.shards.assigned",
                    "11,12")
            .overrideConfigKey("quarkus.hibernate-search-orm.\"pu1\".coordination.event-processor.polling-interval",
                    "0.142S")
            .overrideConfigKey("quarkus.hibernate-search-orm.\"pu1\".coordination.event-processor.pulse-interval",
                    "0.143S")
            .overrideConfigKey("quarkus.hibernate-search-orm.\"pu1\".coordination.event-processor.pulse-expiration",
                    "144S")
            .overrideConfigKey("quarkus.hibernate-search-orm.\"pu1\".coordination.event-processor.batch-size", "145")
            .overrideConfigKey("quarkus.hibernate-search-orm.\"pu1\".coordination.event-processor.transaction-timeout",
                    "146S")
            .overrideConfigKey("quarkus.hibernate-search-orm.\"pu1\".coordination.event-processor.retry-delay", "147S")
            .overrideConfigKey("quarkus.hibernate-search-orm.\"pu1\".coordination.mass-indexer.polling-interval",
                    "0.148S")
            .overrideConfigKey("quarkus.hibernate-search-orm.\"pu1\".coordination.mass-indexer.pulse-interval",
                    "0.149S")
            .overrideConfigKey("quarkus.hibernate-search-orm.\"pu1\".coordination.mass-indexer.pulse-expiration",
                    "150S")
            .overrideConfigKey(
                    "quarkus.hibernate-search-orm.coordination.tenants.\"" + TENANT_ID + "\".event-processor.enabled",
                    "false")
            .overrideConfigKey("quarkus.hibernate-search-orm.coordination.tenants.\"" + TENANT_ID
                    + "\".event-processor.shards.total-count", "210")
            .overrideConfigKey("quarkus.hibernate-search-orm.coordination.tenants.\"" + TENANT_ID
                    + "\".event-processor.shards.assigned", "21,22")
            .overrideConfigKey("quarkus.hibernate-search-orm.coordination.tenants.\"" + TENANT_ID
                    + "\".event-processor.polling-interval", "0.242S")
            .overrideConfigKey("quarkus.hibernate-search-orm.coordination.tenants.\"" + TENANT_ID
                    + "\".event-processor.pulse-interval", "0.243S")
            .overrideConfigKey("quarkus.hibernate-search-orm.coordination.tenants.\"" + TENANT_ID
                    + "\".event-processor.pulse-expiration", "244S")
            .overrideConfigKey("quarkus.hibernate-search-orm.coordination.tenants.\"" + TENANT_ID
                    + "\".event-processor.batch-size", "245")
            .overrideConfigKey("quarkus.hibernate-search-orm.coordination.tenants.\"" + TENANT_ID
                    + "\".event-processor.transaction-timeout", "246S")
            .overrideConfigKey("quarkus.hibernate-search-orm.coordination.tenants.\"" + TENANT_ID
                    + "\".event-processor.retry-delay", "247S")
            .overrideConfigKey("quarkus.hibernate-search-orm.coordination.tenants.\"" + TENANT_ID
                    + "\".mass-indexer.polling-interval", "0.248S")
            .overrideConfigKey("quarkus.hibernate-search-orm.coordination.tenants.\"" + TENANT_ID
                    + "\".mass-indexer.pulse-interval", "0.249S")
            .overrideConfigKey("quarkus.hibernate-search-orm.coordination.tenants.\"" + TENANT_ID
                    + "\".mass-indexer.pulse-expiration", "250S");
    ...
    @Test
    public void root() {
        assertThat(sessionFactory.getProperties()).contains(
    ...
    public void perNamedPersistenceUnit() {
        assertThat(sessionFactoryForNamedPU1.getProperties()).contains(
                entry(HibernateOrmMapperOutboxPollingSettings.COORDINATION_ENTITY_MAPPING_AGENT_CATALOG,
                        "myagentcatalogpu1"),
                entry(HibernateOrmMapperOutboxPollingSettings.COORDINATION_ENTITY_MAPPING_AGENT_SCHEMA,
                        "myagentschemapu1"),
                ...
                entry(HibernateOrmMapperOutboxPollingSettings.COORDINATION_ENTITY_MAPPING_AGENT_UUID_GEN_STRATEGY,
                        UuidGenerationStrategy.TIME),
                entry(HibernateOrmMapperOutboxPollingSettings.COORDINATION_ENTITY_MAPPING_AGENT_UUID_TYPE, "binary"),
                entry(HibernateOrmMapperOutboxPollingSettings.COORDINATION_ENTITY_MAPPING_OUTBOXEVENT_CATALOG,
                        "myoutboxeventcatalogpu1"),
                entry(HibernateOrmMapperOutboxPollingSettings.COORDINATION_ENTITY_MAPPING_OUTBOXEVENT_SCHEMA,
                        "myoutboxeventschemapu1"),
