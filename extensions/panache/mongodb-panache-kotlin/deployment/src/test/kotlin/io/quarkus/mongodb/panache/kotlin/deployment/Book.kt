...
/**
 * This class is used by TestEnhancers to validate the bytecode generation. Each method on
 * PanacheMongoCompanion is manually implemented to give us a compiler generated metric against
 * which to validate the quarkus generated bytecode. TestEnhancers further validates that
 * all @GenerateBridge annotated methods are represented by a 'target_' method here.
 */
@Suppress("UNCHECKED_CAST", "unused")
class Book : PanacheMongoEntity() {
    companion object : PanacheMongoCompanion<Book> {
        fun target_count(): Long = INSTANCE.count(Book::class.java)

        fun target_count(query: Document): Long = INSTANCE.count(Book::class.java, query)
        ...
        fun target_delete(query: Document): Long = INSTANCE.delete(Book::class.java, query)
        ...
        fun target_deleteAll(): Long = INSTANCE.deleteAll(Book::class.java)

        fun target_deleteById(id: ObjectId): Boolean = INSTANCE.deleteById(Book::class.java, id)
        ...
        fun target_findById(id: ObjectId): Book? = INSTANCE.findById(Book::class.java, id) as Book?
        ...
        fun target_listAll(): List<Book> = INSTANCE.listAll(Book::class.java) as List<Book>
        ...
        fun target_mongoDatabase(): MongoDatabase = INSTANCE.mongoDatabase(Book::class.java)
        ...
        fun target_streamAll(): Stream<Book> = INSTANCE.streamAll(Book::class.java) as Stream<Book>
