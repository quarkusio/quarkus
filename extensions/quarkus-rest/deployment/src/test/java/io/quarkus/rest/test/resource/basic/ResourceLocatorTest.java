...
import io.quarkus.rest.test.resource.basic.resource.ResourceLocatorCollectionResource;
import io.quarkus.rest.test.resource.basic.resource.ResourceLocatorDirectory;
import io.quarkus.rest.test.resource.basic.resource.ResourceLocatorQueueReceiver;
import io.quarkus.rest.test.resource.basic.resource.ResourceLocatorReceiver;
import io.quarkus.rest.test.resource.basic.resource.ResourceLocatorRootInterface;
import io.quarkus.rest.test.resource.basic.resource.ResourceLocatorSubInterface;
import io.quarkus.rest.test.resource.basic.resource.ResourceLocatorSubresource;
import io.quarkus.rest.test.resource.basic.resource.ResourceLocatorSubresource2;
import io.quarkus.rest.test.resource.basic.resource.ResourceLocatorSubresource3;
import io.quarkus.rest.test.resource.basic.resource.ResourceLocatorSubresource3Interface;
