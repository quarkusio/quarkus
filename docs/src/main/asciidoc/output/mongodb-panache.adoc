...
MongoDB with Panache provides active record style entities (and repositories) like you have in xref:hibernate-orm-panache.adoc[Hibernate ORM with Panache] and focuses on making your entities trivial and fun to write in {product-name-first}.
...
First, you can create a BSON Codec which will be automatically registered by {product-name} and will be used instead of the `PojoCodecProvider`.
