...
It is possible to run continous testing without starting dev mode. This can be useful if dev mode will interfere with
...
include::{generated-dir}/config/quarkus-test.adoc[opts=optional, leveloffset=+2]
