...
include::{generated-dir}/quarkus-kubernetes-kubernetes-config.adoc[opts=optional, leveloffset=+1]
...
:no-duration-note: true
include::{generated-dir}/quarkus-kubernetes-client.adoc[opts=optional, leveloffset=+1]
...
.OpenShift
:no-duration-note: true
include::{generated-dir}/quarkus-openshift-openshift-config.adoc[opts=optional, leveloffset=+1]
...
.Knative
:no-duration-note: true
include::{generated-dir}/quarkus-knative-knative-config.adoc[opts=optional, leveloffset=+1]
