...
include::{generated-dir}/quarkus-logging-json.adoc[opts=optional, leveloffset=+1]
...
include::{generated-dir}/quarkus-log-logging-log-build-time-config.adoc[opts=optional, leveloffset=+1]
include::{generated-dir}/quarkus-log-logging-log-config.adoc[opts=optional, leveloffset=+1]
