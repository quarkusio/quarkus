...
include::{generated-dir}/quarkus-live-reload-live-reload-config.adoc[opts=optional, leveloffset=+1]
...
include::{generated-dir}/quarkus-package-pkg-package-config.adoc[opts=optional]
