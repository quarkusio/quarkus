...
public class Substitutions {
    ...
    public static final class PrometheusMeterRegistryIsPresent implements BooleanSupplier {
        @Override
    ...
    @TargetClass(className = "io.prometheus.metrics.core.exemplars.ExemplarSampler", onlyWith = PrometheusMeterRegistryIsPresent.class)
