...
public class DefaultGenericTrustStoreWithCredentialsProviderWithAliasTest {

    private static final String configuration = """
            quarkus.tls.trust-store.pkcs12.path=target/certs/test-credentials-provider-alias-truststore.p12
            quarkus.tls.trust-store.pkcs12.alias=my-alias
