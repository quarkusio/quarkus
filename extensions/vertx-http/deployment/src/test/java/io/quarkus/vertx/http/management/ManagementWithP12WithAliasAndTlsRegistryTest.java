...
public class ManagementWithP12WithAliasAndTlsRegistryTest {
    private static final String configuration = """
            ...
            quarkus.tls.mgt.key-store.p12.path=server-keystore.p12
            quarkus.tls.mgt.key-store.p12.password=secret
            quarkus.tls.mgt.key-store.p12.alias=alias
            quarkus.tls.mgt.key-store.p12.alias-password=alias-password
            """;
