...
/**
 * Tests that once a file has a compile error restart will not happen until it is fixed, even if other files are
 * subsequently modified that do compile.
 */
public class CompileProblemTest {

    @RegisterExtension
    static final QuarkusDevModeTest test = new QuarkusDevModeTest()
            .withApplicationRoot((jar) -> jar.addClasses(CompileErrorEndpoint.class, CompileCorrectlyEndpoint.class));
