...
As an application developer, you build and deploy your {project-name} applications to {openshift} in a single step, by running either of the folllowing commands:
