...
/**
 * gRPC security mechanism based on gRPC call metadata To secure your gRPC endpoints, create a CDI bean implementing
 * this interface. Make sure that an {@link io.quarkus.security.identity.IdentityProvider} for the
 * {@link AuthenticationRequest} returned by {@code createAuthenticationRequest} is available by adding a suitable
