 ...
 */
public class QuarkusRestLinkBuilder implements Link.Builder {
    /**
    ...
    public Link.Builder link(String link) {
        Link l = QuarkusRestLink.valueOf(link);
        return link(l);
    }
    ...
    public Link build(Object... values) throws UriBuilderException {
        ...
        return new QuarkusRestLink(built, this.map);
    }
    ...
    public Link buildRelativized(URI uri, Object... values) {
        ...
        return new QuarkusRestLink(uri.relativize(with), this.map);
    }
