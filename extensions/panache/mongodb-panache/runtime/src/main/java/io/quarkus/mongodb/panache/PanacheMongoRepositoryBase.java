...
/**
 * Represents a Repository for a specific type of entity {@code Entity}, with an ID type of {@code Id}. Implementing
 * this repository will gain you the exact same useful methods that are on {@link PanacheMongoEntityBase}. Unless you
 * have a custom ID strategy, you should not implement this interface directly but implement
 * {@link PanacheMongoRepository} instead.
 *
 * @param <Entity>
...
public interface PanacheMongoRepositoryBase<Entity, Id> {
     ...
     */
    @GenerateBridge
    default PanacheQuery<Entity> find(Bson query) {
        throw INSTANCE.implementationInjectionMissing();
    }
     ...
     *        a {@link org.bson.conversions.Bson} query
     * @param sort
     *        the {@link org.bson.conversions.Bson} sort
     *
     * @return a new {@link PanacheQuery} instance for the given query
     *
     * @see #find(Bson)
     ...
     */
    @GenerateBridge
    default PanacheQuery<Entity> find(Bson query, Bson sort) {
        throw INSTANCE.implementationInjectionMissing();
    }
     ...
     */
    @GenerateBridge
    default List<Entity> list(Bson query) {
        throw INSTANCE.implementationInjectionMissing();
    }
     ...
     */
    @GenerateBridge
    default List<Entity> list(Bson query, Bson sort) {
        throw INSTANCE.implementationInjectionMissing();
    }
     ...
     */
    @GenerateBridge
    default Stream<Entity> stream(Bson query) {
        throw INSTANCE.implementationInjectionMissing();
    }
     ...
     */
    @GenerateBridge
    default Stream<Entity> stream(Bson query, Bson sort) {
        throw INSTANCE.implementationInjectionMissing();
    }
     ...
     */
    @GenerateBridge
    default long delete(Bson query) {
        throw INSTANCE.implementationInjectionMissing();
    }
     ...
     * {@link io.quarkus.mongodb.panache.common.PanacheUpdate} object will allow to restrict on which documents the
     ...
     * see <a href="https://www.mongodb.com/docs/manual/tutorial/update-documents">update documents</a>. The returned
     * {@link io.quarkus.mongodb.panache.common.PanacheUpdate} object will allow to restrict on which document the
     * update should be applied.
     *
     * @param update
     ...
     */
    @GenerateBridge
    default io.quarkus.mongodb.panache.common.PanacheUpdate update(Bson update) {
        throw INSTANCE.implementationInjectionMissing();
    }
