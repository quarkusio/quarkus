...
public class LogStreamJsonRPCService {
    ...
    public JsonObject getLogger(
            @JsonRpcDescription("The logger name as described in the getLoggers method") String loggerName) {
        LogContext logContext = LogContext.getLogContext();
    ...
    public JsonObject updateLogLevel(
            @JsonRpcDescription("The logger name as described in the getLoggers method") String loggerName,
            @JsonRpcDescription("The new level to set") String levelValue) {
        LogContext logContext = LogContext.getLogContext();
        Logger logger = logContext.getLogger(loggerName);
