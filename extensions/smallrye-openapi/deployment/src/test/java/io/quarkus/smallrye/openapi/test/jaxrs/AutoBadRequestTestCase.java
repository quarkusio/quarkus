...
class AutoBadRequestTestCase {
    ...
    static QuarkusUnitTest runner = new QuarkusUnitTest()
            .withApplicationRoot((jar) -> jar.addClasses(AutoBadRequestResource.class));

    @Test
    void testInOpenApi() {
        RestAssured.given().header("Accept", "application/json").when().get("/q/openapi").then().log()
                .ifValidationFails().assertThat().statusCode(200)
                .body("paths.'/auto'.post.responses.400.description", Matchers.is("Bad Request")).and()
    ...
    void testNobodyInOpenApi() {
        RestAssured.given().header("Accept", "application/json").when().get("/q/openapi").then().log()
                .ifValidationFails().assertThat().statusCode(200)
                .body("paths.'/auto/nobody'.post.responses.400", Matchers.is(Matchers.emptyOrNullString())).and()
    ...
    void testStringInOpenApi() {
        RestAssured.given().header("Accept", "application/json").when().get("/q/openapi").then().log()
                .ifValidationFails().assertThat().statusCode(200)
                .body("paths.'/auto/string'.post.responses.400", Matchers.is(Matchers.emptyOrNullString())).and()
    ...
    void testFileInOpenApi() {
        RestAssured.given().header("Accept", "application/json").when().get("/q/openapi").then().log()
                .ifValidationFails().assertThat().statusCode(200)
                .body("paths.'/auto/file'.post.responses.400", Matchers.is(Matchers.emptyOrNullString())).and()
    ...
    void testMultipartInOpenApi() {
        RestAssured.given().header("Accept", "application/json").when().get("/q/openapi").then().log()
                .ifValidationFails().assertThat().statusCode(200)
                .body("paths.'/auto/multipart'.post.responses.400", Matchers.is(Matchers.emptyOrNullString())).and()
