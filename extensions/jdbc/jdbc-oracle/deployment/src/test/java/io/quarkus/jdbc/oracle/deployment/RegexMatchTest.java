...
/**
 * The metadata override facility of GraalVM's native-image works with regular expressions. We're testing our
 * expressions here to match against the constants the compiler is expecting (inferred by debugging the compiler) as
 * it's otherwise a bit tricky to assert if they have been applied.
 */
