...
import io.quarkus.oidc.common.runtime.config.OidcClientCommonConfig.Credentials.Attestation.AttestationSignatureAlgorithm;
...
public abstract class OidcClientCommonConfig extends OidcCommonConfig
    ...
    public static class Credentials implements io.quarkus.oidc.common.runtime.config.OidcClientCommonConfig.Credentials {
        ...
        public static class Attestation
            ...
            public AttestationSignatureAlgorithm signatureAlgorithm = AttestationSignatureAlgorithm.ES256;
            ...
            @Override
            public AttestationSignatureAlgorithm signatureAlgorithm() {
                return signatureAlgorithm;
            }
