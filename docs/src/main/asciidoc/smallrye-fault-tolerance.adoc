...
Please check the link:https://smallrye.io/docs/smallrye-fault-tolerance/5.3.1/index.html[SmallRye Fault Tolerance documentation] to learn about them.
...
The link:https://smallrye.io/docs/smallrye-fault-tolerance/5.3.1/usage/programmatic-api.html[programmatic API] is present, including Mutiny support, and integrated with the declarative, annotation-based API.
