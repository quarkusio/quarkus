...
public abstract class BuildAotEnhancedImageWorker extends QuarkusWorker<BuildAotEnhancedImageWorkerParams> {
    ...
    public void execute() {
        ...
        LOGGER.info("Building AOT enhanced container image");
        LOGGER.info("  original-container-image: {}", originalContainerImage);
        LOGGER.info("  container-working-directory: {}", containerWorkingDirectory);
        LOGGER.info("  aot-file: {}", aotFile);
