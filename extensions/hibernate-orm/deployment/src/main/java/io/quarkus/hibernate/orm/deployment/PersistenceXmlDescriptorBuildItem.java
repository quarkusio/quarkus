...
/**
 * Provides instances of {@see ParsedPersistenceXmlDescriptor}, the raw representation of a persistence.xml file as it
 * is after being located and parsed. Exposed as a possible integration API: other extensions can produce additional
