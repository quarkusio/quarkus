...
public class DataHibernateProcessorAutoDevModeTest extends QuarkusDevGradleTestBase {

    @Override
    protected String projectDirectoryName() {
        return "data-hibernate-processor-auto";
    }
    ...
    protected void testDevMode() throws Exception {
        ...
        // quarkus-data-processor wasn't auto-configured
