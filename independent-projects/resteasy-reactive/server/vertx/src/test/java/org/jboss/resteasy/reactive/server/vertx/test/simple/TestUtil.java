...
public class TestUtil {
    ...
    /**
     * Finish preparing war deployment and deploy it. Add classes in @resources to deployment. Also all sub-classes of
     * classes in @resources are added to deployment. But only classes in @resources (not sub-classes of classes
