...
class DevServicesConfigBuildStep {
    ...
    record PreviousDevServicesConfig(Map<String, String> config) {
    }
    ...
    DevServicesLauncherConfigResultBuildItem setup(BuildProducer<RunTimeConfigurationDefaultBuildItem> runtimeConfig,
            ...
            CuratedApplicationContextBuildItem curatedApplicationContextBuildItem) {
        ...
        PreviousDevServicesConfig previousConfig = curatedApplicationContextBuildItem
                .getContextObject(PreviousDevServicesConfig.class);
        if (previousConfig != null) {
            for (Map.Entry<String, String> entry : previousConfig.config().entrySet()) {
        ...
        curatedApplicationContextBuildItem.setContextObject(PreviousDevServicesConfig.class,
                new PreviousDevServicesConfig(newProperties));
