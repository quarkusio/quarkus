...
import io.quarkus.jfr.runtime.rest.AbstractHttpReactiveEndEvent;
import jdk.jfr.Category;
import jdk.jfr.Label;
import jdk.jfr.StackTrace;

@Label("Tracing HTTP Reactive End")
@Category({ "Quarkus", "REST" })
@StackTrace(false)
public class TracingHttpReactiveEndEvent extends AbstractHttpReactiveEndEvent<TracingRequestId> {
