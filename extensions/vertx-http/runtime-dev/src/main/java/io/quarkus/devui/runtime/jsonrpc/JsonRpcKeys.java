...
public interface JsonRpcKeys {
    ...
    public static final int PARSE_ERROR = -32700; // Parse error. Invalid JSON was received by the server. An error
    ...
    public static final int METHOD_NOT_FOUND = -32601; // Method not found. The method does not exist / is not
                                                       // available.
