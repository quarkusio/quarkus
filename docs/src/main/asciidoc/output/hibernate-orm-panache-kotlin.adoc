...
needed to use Hibernate ORM with Panache in your Kotlin-based {product-name-first} applications.
...
change to configuring your project is the {product-name} artifact to include.  You can, of course, keep the Java version if you
