...
/**
 * Exception which indicates that an error has occurred during the {@link OidcClientRegistration} initialization,
 * default client registration or subsequent operations with the client registration endpoint.
 */
