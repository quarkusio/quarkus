...
public class FluentApiCombinedFormBasicAuthTestCase {
    ...
    public static class HttpSecurityConfigurator {
        ...
        void configureBasicAuth(@Observes Basic basic) {
            basic.enable().realm("TestRealm");
        }

        void configureFormAuth(@Observes Form form) {
            form.enable().loginPage("login").errorPage("error").landingPage("landing");
        }
