...
public class PackageConfig {
    ...
    /**
     * ProGuard optimizer configuration
     */
    @ConfigItem
    public ProGuardConfig proguard;
    ...
    public static class ProGuardConfig {
        /**
         * An advanced option that instructs Quarkus to run ProGuard on the Quarkus generated bytecode.
         * This is only taken into account when fast-jar is used.
         */
        @ConfigItem(defaultValue = "true")
        public boolean enabled;
        ...
        /**
         * The version of ProGuard to use
         */
        @ConfigItem(defaultValue = "7.3.2")
        public String version;

        /**
         * The directory into which to save the ProGuard tool if it doesn't exist
         */
        @ConfigItem(defaultValue = "${user.home}/.quarkus")
        public String jarDirectory;
    }
