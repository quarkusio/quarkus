...
You can of course create a native executable following the instructions of the link:building-native-image-guide.html[this] guide.
...
* link:spring-di-guide.adoc[Quarkus - Extension for Spring DI]
