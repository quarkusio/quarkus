...
public class CustomMappingAndSettingsTest {
    ...
    static final QuarkusUnitTest config = new QuarkusUnitTest()
            .setArchiveProducer(() -> ShrinkWrap.create(JavaArchive.class).addClass(TransactionUtils.class)
    ...
    public void test() {
        ...
        TransactionUtils.inTransaction(transaction, () -> {
            ...
            assertThat(searchSession.search(IndexedEntity.class).extension(ElasticsearchExtension.get())
                    .where(f -> f.fromJson("{'match': { 'name.ngram': { 'query': 'fubar' } } }")).fetchHits(20))
                    .hasSize(1);
        });
    }
}
