...
[WARNING]
====
To enable Dependency Injection to work across submodules we need to add an empty `beans.xml` file in every submodules in the `src/main/resources/META-INF` directory.
====
