...
/**
 * Used to easily define an exception mapper for the specific REST Client on which it's used. This method is called when
 * the HTTP response from the invoked service has a status code of 400 or higher.
 * <p>
 ...
 * <li>{@code Map<String, Object>} which gives access to the properties that are available to (and potentially changed
 * by) {@link jakarta.ws.rs.client.ClientRequestContext}</li>
