...
{product-name-first} provides a compatibility layer for Spring Data REST in the form of the `spring-data-rest` extension.
...
If you already have your {product-name} project configured, you can add the `spring-data-rest` extension
...
To make it easier to showcase some capabilities of Spring Data REST on {product-name}, some test data should be inserted into the database
...
{product-name} currently supports a subset of Spring Data REST features, namely the most useful and most commonly used features.
