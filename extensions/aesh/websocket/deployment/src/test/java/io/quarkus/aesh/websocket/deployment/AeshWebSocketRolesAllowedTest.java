...
/**
 * Tests that the WebSocket terminal enforces role-based access when
 * {@code quarkus.aesh.websocket.roles-allowed=admin} is set.
 */
public class AeshWebSocketRolesAllowedTest {
    ...
    @Test
    public void testWrongRoleRejected() throws Exception {
