...
public class DefaultDataSourceConfigTest {
    ...
    static final ShamrockUnitTest config = new ShamrockUnitTest().setArchiveProducer(
            () -> ShrinkWrap.create(JavaArchive.class)
                    .addAsManifestResource("microprofile-config-default-datasource.properties", "microprofile-config.properties"));
    ...
    private static void testDataSource(AgroalDataSource dataSource, String username, int minSize, int maxSize) throws SQLException {
