 ...
 * It must be configured with the type of function used, {@link FunctionType}.
 * If multiple functions exist in the same project, you <b>must</b> configure which function to launch via the
 * <code>functionName</code> attribute.
 *
