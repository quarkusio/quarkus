...
[TIP]
Automatically add newline with curl
====
If you terminal are printing a '%' or does not put a newline as you expected then
you can force curl to add it for you by using `curl -w "\n" http://localhost:8000/hello`
====
