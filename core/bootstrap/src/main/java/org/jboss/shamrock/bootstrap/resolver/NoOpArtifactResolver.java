...
public class NoOpArtifactResolver extends AppArtifactResolverBase {
    ...
    @Override
    public List<AppDependency> collectDependencies(AppArtifact artifact) throws AppArtifactResolverException {
        throw new UnsupportedOperationException();
    }

    @Override
    public List<AppDependency> collectRuntimeDependencies(AppArtifact artifact) throws AppArtifactResolverException {
        throw new UnsupportedOperationException();
    }

    @Override
    public List<AppDependency> collectDependencies(AppArtifact root, List<AppDependency> deps) throws AppArtifactResolverException {
        throw new UnsupportedOperationException();
    }
