...
export const templates = {
    'quarkus-smallrye-openapi-meta-description': 'Documentez vos APIs REST avec OpenAPI - livré avec Swagger UI',
    'quarkus-smallrye-openapi-swagger_ui': 'Interface Swagger',
    ...
    'quarkus-smallrye-openapi-description': 'Générez du code client basé sur le document de schéma OpenAPI produit par votre application Quarkus au moment de la construction.',
    'quarkus-smallrye-openapi-talking-to-ai': 'Parler à l\'IA...',
    ...
    'quarkus-smallrye-openapi-code-generated': str`${0} code généré à partir du schéma OpenAPI avec IA :`,
    'quarkus-smallrye-openapi-failed-generate': str`Échec de la génération de code : ${0}`,
