...
public interface ReactiveMessagingConfigGroup extends MicrometerConfig.CapabilityEnabled {
     ...
     * MessageObservationCollector interface is on the classpath and either this value is true, or this value is unset
     * and {@code quarkus.micrometer.binder-enabled-default} is true.
     */
    @Override
