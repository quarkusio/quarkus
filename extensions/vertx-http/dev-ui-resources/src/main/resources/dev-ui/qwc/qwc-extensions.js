...
export class QwcExtensions extends observeState(LitElement) {
    ...
    render() {
        if(this._installedExtensions){
            ...
            return html`<label class="text-secondary" id="pblabel">Loading extensions</label>
                    <vaadin-progress-bar aria-labelledby="pblabel" class="progress" indeterminate></vaadin-progress-bar>`;
        }
    }
