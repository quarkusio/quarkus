...
If you are going to use security in a reactive environment you will likely need Smallrye Content Propagation:
...
This will allow you to propagate the identity throughout the reactive callback. You also need to make sure you
