...
public class LiveReloadManagementTest {
    ...
    public void test() {
        ...
        String firstClassToString = RestAssured.get(managementPath + "/manage-1").then().statusCode(200).extract()
                .body().asString();
        ...
        Awaitility.await().atMost(5, TimeUnit.SECONDS).untilAsserted(() -> {
            String secondClassToString = RestAssured.get(managementPath + "/manage-2").then().statusCode(200).extract()
                    .body().asString();
        ...
        RestAssured.get(managementPath + "/manage-1").then().statusCode(404);
        ...
        Awaitility.await().atMost(5, TimeUnit.SECONDS).untilAsserted(() -> {
            String response = RestAssured.get(managementPath + "/manage-cdi").then().statusCode(200).extract().body()
                    .asString();
        ...
        Awaitility.await().atMost(5, TimeUnit.SECONDS).untilAsserted(() -> {
            String response = RestAssured.get(managementPath + "/manage-bean-handler").then().statusCode(200).extract()
                    .body().asString();
