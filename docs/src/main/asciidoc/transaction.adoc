...
====
 ...
 Highlight it as a caution that this may result in the node-name ending as an unpredictable duplicate string and this break the uniqueness that is mandatory for safe transaction usage. Perhaps the comment could also mention: #30491 which has some rationale to try to help guide on the potential for conflict.
