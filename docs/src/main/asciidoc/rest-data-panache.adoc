...
* Implement the Panache entities and/or repositories as explained in the xref:hibernate-orm-panache.adoc[] guide.
...
For more information about how named queries work, go to link:https://quarkus.io/guides/hibernate-orm-panache#named-queries[the Hibernate ORM guide] or link:https://quarkus.io/guides/hibernate-reactive-panache#named-queries[the Hibernate Reactive guide].
