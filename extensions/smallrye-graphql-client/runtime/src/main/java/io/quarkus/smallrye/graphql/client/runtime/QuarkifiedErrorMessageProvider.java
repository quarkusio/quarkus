...
/**
 * Provides Quarkus-specific versions of error messages for SmallRye GraphQL. The reason being, for example, the ability
 * to suggest a quarkus.* configuration property when it's more appropriate than suggesting the basic /mp-graphql
 * property understood directly by SmallRye.
 */
