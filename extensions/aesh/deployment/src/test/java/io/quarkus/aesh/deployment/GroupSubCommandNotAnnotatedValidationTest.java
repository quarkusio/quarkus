...
/**
 * Tests that a {@code @CommandDefinition(groupCommands=...)} referencing a sub-command class
 * that lacks both {@code @CommandDefinition} and {@code @CommandDefinition(groupCommands=...)}
...
public class GroupSubCommandNotAnnotatedValidationTest {
    ...
    @CommandDefinition(name = "mygroup", description = "A group command", groupCommands = { UnannotatedSubCommand.class })
