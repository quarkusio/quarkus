...
The OpenTelemetry Java SDK OTLP exporter is not supported in Quarkus. It is not needed because Quarkus own default exporters send data using the OTLP protocol.
