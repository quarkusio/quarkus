 ...
 * <p>
 * A static resource is a file that is not processed by the build steps, but is included in the native image as-is. The
 * resource path passed to the constructor is a {@code /}-separated path name (with the same semantics as the
 * parameters) passed to {@link java.lang.ClassLoader#getResources(String)}.
 * <p>
 * Related build items:
 * <ul>
...
public final class NativeImageResourceBuildItem extends MultiBuildItem {
     ...
     * @return
     */
    public static NativeImageResourceBuildItem ofDependencyResources(Collection<ResolvedDependency> dependencies,
            ArtifactCoords artifactCoordinates, PathFilter resourceFilter) {
