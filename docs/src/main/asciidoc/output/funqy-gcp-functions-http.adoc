...
If you want to allow HTTP clients to invoke your Funqy functions on Google Cloud Functions, {product-name-first} allows you to expose multiple
...
HTTP features like cache-control and conditional GETs.  You may want to consider using {product-name}'s
Jakarta REST, Spring MVC, or Vert.x Web Reactive Route xref:gcp-functions-http.adoc[support] instead.  They also work with {product-name} and Google Cloud Functions.
