...
Note that this version of the extension only supports JAX-RS based services (and a subsequent
revision will include support for non JAX-RS based services).
