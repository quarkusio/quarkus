...
First, you need to _push_ the Docker image (created in the link:building-native-image-guide.html[previous] guide) to the image registry of your Kubernetes cluster.
